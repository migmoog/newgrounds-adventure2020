...
HXLINE( 527)					edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            			...
            			break;
            			case (int)9: {
HXLINE( 534)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 534)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 534)				HX_VARI(  ::hscript::Expr,cond) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 527)					edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            			...
            			break;
            			case (int)10: {
HXLINE( 530)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 530)				HX_VARI(  ::hscript::Expr,cond) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 527)				edef = ::hscript::Expr_obj::EWhile(cond,this->mapCompr(tmp,e2));
            			}
            			break;
            			case (int)11: {
HXLINE( 528)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 528)				HX_VARI(  ::hscript::Expr,it) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 528)				HX_VARI( ::String,v) = e->_hx_getString(0);
HXLINE( 527)				edef = ::hscript::Expr_obj::EFor(v,it,this->mapCompr(tmp,e2));
            			}
            			break;
            			case (int)24: {
HXLINE( 532)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 532)				HX_VARI(  ::hscript::Expr,cond) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 549)		switch((int)(e->_hx_getIndex())){
            			case (int)6: {
HXLINE( 550)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 550)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 550)				HX_VARI( ::String,bop) = e->_hx_getString(0);
HXDLIN( 550)				return ::hscript::Expr_obj::EBinop(bop,this->makeUnop(op,e1),e2);
            			}
            			break;
            			case (int)22: {
HXLINE( 551)				HX_VARI(  ::hscript::Expr,e3) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 551)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 551)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 559)		switch((int)(e->_hx_getIndex())){
            			case (int)6: {
HXLINE( 560)				HX_VARI(  ::hscript::Expr,e3) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 560)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 560)				HX_VARI( ::String,op2) = e->_hx_getString(0);
...
HXLINE( 564)					return ::hscript::Expr_obj::EBinop(op,e1,e);
            			...
            			break;
            			case (int)22: {
HXLINE( 565)				HX_VARI(  ::hscript::Expr,e4) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 565)				HX_VARI(  ::hscript::Expr,e3) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 565)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 778)									HX_VARI(  ::hscript::CType,t) = e1->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 778)									HX_VARI( ::String,i) = _hx_tmp->_hx_getString(0);
...
HXLINE(1583)					HX_VARI(  ::hscript::Expr,e2) = _g;
HXDLIN(1583)					HX_VARI(  ::hscript::Expr,e1) = _g1;
...
HXLINE(1585)					HX_VARI(  ::hscript::Expr,e2) = _g;
HXDLIN(1585)					HX_VARI(  ::hscript::Expr,e1) = _g1;

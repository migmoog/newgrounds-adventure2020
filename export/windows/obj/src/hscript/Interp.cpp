...
HXLINE( 139)						l->__SetField(HX_("r",72,00,00,00),v,::hx::paccDynamic);
            			...
            			break;
            			case (int)5: {
HXLINE( 140)				HX_VARI( ::String,f) = e1->_hx_getString(1);
HXDLIN( 140)				HX_VARI(  ::hscript::Expr,e) = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 141)				v = this->set(this->expr(e),f,v);
            			}
            			break;
            			case (int)16: {
HXLINE( 142)				HX_VARI(  ::hscript::Expr,index) = e1->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 142)				HX_VARI(  ::hscript::Expr,e) = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 142)				{
...
HXLINE( 172)						l->__SetField(HX_("r",72,00,00,00),v,::hx::paccDynamic);
            			...
            			break;
            			case (int)5: {
HXLINE( 173)				HX_VARI( ::String,f) = e1->_hx_getString(1);
HXDLIN( 173)				HX_VARI(  ::hscript::Expr,e) = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 173)				{
...
HXLINE( 176)					v = this->set(obj,f,v);
            			...
            			break;
            			case (int)16: {
HXLINE( 177)				HX_VARI(  ::hscript::Expr,index) = e1->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 177)				HX_VARI(  ::hscript::Expr,e) = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 177)				{
...
HXLINE( 208)				return v;
            			...
            			break;
            			case (int)5: {
HXLINE( 209)				HX_VARI( ::String,f) = e->_hx_getString(1);
HXDLIN( 209)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 217)				return v;
            			...
            			break;
            			case (int)16: {
HXLINE( 218)				HX_VARI(  ::hscript::Expr,index) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 218)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE(   1)					HX_VARI(  ::hscript::_Interp::Stop,e) = _g1;
...
HXLINE( 344)				return v;
            			...
            			break;
            			case (int)5: {
HXLINE( 345)				HX_VARI( ::String,f) = e->_hx_getString(1);
HXDLIN( 345)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 346)				return this->get(this->expr(e1),f);
            			}
            			break;
            			case (int)6: {
HXLINE( 347)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 347)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 347)				HX_VARI( ::String,op) = e->_hx_getString(0);
...
HXLINE( 350)				return fop(e1,e2);
            			...
            			break;
            			case (int)7: {
HXLINE( 351)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 351)				HX_VARI( bool,prefix) = e->_hx_getBool(1);
HXDLIN( 351)				HX_VARI( ::String,op) = e->_hx_getString(0);
...
HXDLIN( 368)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            			...
            			break;
            			case (int)8: {
HXLINE( 370)				HX_VARI( ::Array< ::Dynamic>,params) = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 370)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 376)					HX_VARI( ::String,f) = e1->_hx_getString(1);
HXDLIN( 376)					HX_VARI(  ::hscript::Expr,e) = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 381)					return this->call(null(),this->expr(e1),args);
            			...
            			break;
            			case (int)9: {
HXLINE( 383)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 383)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 383)				HX_VARI(  ::hscript::Expr,econd) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 384)						return this->expr(e2);
            			...
            			break;
            			case (int)10: {
HXLINE( 385)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 385)				HX_VARI(  ::hscript::Expr,econd) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 386)				this->whileLoop(econd,e1);
HXLINE( 387)				return null();
            			}
            			break;
            			case (int)11: {
HXLINE( 391)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 413)							HX_VARI( ::String,str) = (((HX_("Invalid number of parameters. Got ",cb,2b,d9,b1) + args->get_length()) + HX_(", required ",ed,0c,66,93)) + minParams);
...
HXLINE( 419)						HX_VARI( int,extraParams) = (args->get_length() - minParams);
...
HXDLIN( 404)				HX_VARI( int,minParams) = 0;
HXLINE( 405)				{
...
HXLINE( 400)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::_Interp::Stop_obj::SReturn_dyn()));
            			...
            			break;
            			case (int)16: {
HXLINE( 512)				HX_VARI(  ::hscript::Expr,index) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 512)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 480)									HX_VARI(  ::hscript::Expr,eValue) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 480)									HX_VARI(  ::hscript::Expr,eKey) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 480)									{
...
HXLINE( 510)					return a;
            			...
            			break;
            			case (int)18: {
HXLINE( 521)				HX_VARI( ::Array< ::Dynamic>,params) = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 521)				HX_VARI( ::String,cl) = e->_hx_getString(0);
...
HXLINE(   1)							HX_VARI(  ::hscript::_Interp::Stop,err) = _g1;
...
HXLINE( 555)				return o;
            			...
            			break;
            			case (int)22: {
HXLINE( 556)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 556)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 556)				HX_VARI(  ::hscript::Expr,econd) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 557)					return this->expr(e2);
            			...
            			break;
            			case (int)23: {
HXLINE( 558)				HX_VARI(  ::hscript::Expr,def) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 558)				HX_VARI( ::Array< ::Dynamic>,cases) = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 558)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 574)				return val;
            			...
            			break;
            			case (int)24: {
HXLINE( 388)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 388)				HX_VARI(  ::hscript::Expr,econd) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();

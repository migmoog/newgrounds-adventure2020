...
HX_DEFINE_STACK_FRAME(_hx_pos_542ca5cf653f7ae3_34_new,"cpp.vm.Parameter","new",0xef7a672f,"cpp.vm.Parameter.new","C:\\HaxeToolkit\\haxe\\std/cpp/vm/Debugger.hx",34,0x9c8417ca)
namespace cpp{
namespace vm{

void Parameter_obj::__construct(::String name, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_542ca5cf653f7ae3_34_new)
            	HX_STACK_THIS(this)

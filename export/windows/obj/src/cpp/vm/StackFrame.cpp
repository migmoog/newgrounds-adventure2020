...
HX_DEFINE_STACK_FRAME(_hx_pos_9e15b5e9c2b9facd_50_new,"cpp.vm.StackFrame","new",0x11668ca3,"cpp.vm.StackFrame.new","C:\\HaxeToolkit\\haxe\\std/cpp/vm/Debugger.hx",50,0x9c8417ca)
namespace cpp{
namespace vm{

void StackFrame_obj::__construct(::String fileName,int lineNumber,::String className,::String functionName){
            	HX_STACKFRAME(&_hx_pos_9e15b5e9c2b9facd_50_new)
            	HX_STACK_THIS(this)

...
HXLINE(  62)
HXLINE(  63)		HX_VARI( ::Array< ::Dynamic>,eStack) = ::haxe::NativeStackTrace_obj::toHaxe(::haxe::NativeStackTrace_obj::exceptionStack(),null());
...
HXLINE(  70)
HXLINE(  71)		HX_VARI(  ::StringBuf,b) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE(  72)		{
HXLINE(  72)			int _g = 0;
HXDLIN(  72)			::Array< ::Dynamic> _g1 = stack;
HXDLIN(  72)			while((_g < _g1->length)){
HXLINE(  72)				HX_VARI(  ::haxe::StackItem,s) = _g1->__get(_g).StaticCast<  ::haxe::StackItem >();
HXDLIN(  72)				_g = (_g + 1);
HXLINE(  73)				{
...
::Array< ::Dynamic> CallStack_Impl__obj::subtract(::Array< ::Dynamic> this1,::Array< ::Dynamic> stack){
            	...
            	HX_STACK_ARG(stack,"stack")
HXLINE(  83)
HXLINE(  84)		HX_VARI( int,startIndex) = -1;
HXLINE(  85)		HX_VARI( int,i) = -1;
...
HXLINE( 122)							HX_VARI( ::String,m1) = item1->_hx_getString(0);
HXDLIN( 122)							HX_VARI( ::String,m2) = item2->_hx_getString(0);
...
HXLINE( 124)							HX_VARI(  ::haxe::StackItem,item11) = item1->_hx_getObject(0).StaticCast<  ::haxe::StackItem >();
HXDLIN( 124)							HX_VARI( ::String,file1) = item1->_hx_getString(1);
HXDLIN( 124)							HX_VARI( int,line1) = item1->_hx_getInt(2);
HXDLIN( 124)							HX_VARI(  ::Dynamic,col1) = item1->_hx_getObject(3);
HXDLIN( 124)							HX_VARI(  ::Dynamic,col2) = item2->_hx_getObject(3);
HXDLIN( 124)							HX_VARI( int,line2) = item2->_hx_getInt(2);
HXDLIN( 124)							HX_VARI( ::String,file2) = item2->_hx_getString(1);
HXDLIN( 124)							HX_VARI(  ::haxe::StackItem,item21) = item2->_hx_getObject(0).StaticCast<  ::haxe::StackItem >();
...
HXLINE( 126)							HX_VARI( ::String,class1) = item1->_hx_getString(0);
HXDLIN( 126)							HX_VARI( ::String,method1) = item1->_hx_getString(1);
HXDLIN( 126)							HX_VARI( ::String,method2) = item2->_hx_getString(1);
HXDLIN( 126)							HX_VARI( ::String,class2) = item2->_hx_getString(0);
...
HXLINE( 128)							HX_VARI(  ::Dynamic,v1) = item1->_hx_getObject(0);
HXDLIN( 128)							HX_VARI(  ::Dynamic,v2) = item2->_hx_getObject(0);
...
HXLINE( 157)					b->b->push(HX_("a C function",f4,1b,53,cb));
            			...
            			break;
            			case (int)1: {
HXLINE( 158)				HX_VARI( ::String,m) = s->_hx_getString(0);
HXDLIN( 158)				{
HXLINE( 159)					{
...
HXDLIN( 160)							b1->push(::Std_obj::string(m));
            			...
            			break;
            			case (int)2: {
HXLINE( 161)				HX_VARI(  ::Dynamic,col) = s->_hx_getObject(3);
HXDLIN( 161)				HX_VARI( int,line) = s->_hx_getInt(2);
HXDLIN( 161)				HX_VARI( ::String,file) = s->_hx_getString(1);
HXDLIN( 161)				HX_VARI(  ::haxe::StackItem,s1) = s->_hx_getObject(0).StaticCast<  ::haxe::StackItem >();
HXDLIN( 161)				{
...
HXLINE( 174)							b->b->push(HX_(")",29,00,00,00));
            			...
            			break;
            			case (int)3: {
HXLINE( 175)				HX_VARI( ::String,meth) = s->_hx_getString(1);
HXDLIN( 175)				HX_VARI( ::String,cname) = s->_hx_getString(0);
HXDLIN( 175)				{
HXLINE( 176)					{
HXLINE( 176)						::String x;
...
HXDLIN( 178)							b1->push(::Std_obj::string(meth));
            			...
            			break;
            			case (int)4: {
HXLINE( 179)				HX_VARI(  ::Dynamic,n) = s->_hx_getObject(0);
HXDLIN( 179)				{
HXLINE( 180)					{

...
HXDLIN(  36)				return 0;
            			...
            			break;
            			case (int)1: {
HXLINE(  38)				HX_VARI(  ::haxe::zip::Huffman,b) = t->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >();
HXDLIN(  38)				HX_VARI(  ::haxe::zip::Huffman,a) = t->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >();
...
HXLINE(  51)				HX_VARI(  ::haxe::zip::Huffman,b) = t->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >();
HXDLIN(  51)				HX_VARI(  ::haxe::zip::Huffman,a) = t->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >();
...
HXLINE(  64)			HX_VARI(  ::haxe::zip::Huffman,b) = t->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >();
HXDLIN(  64)			HX_VARI(  ::haxe::zip::Huffman,a) = t->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >();
HXLINE(  65)			if ((d > 0)) {

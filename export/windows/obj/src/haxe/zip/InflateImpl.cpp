...
HXDLIN( 230)				return n;
            			...
            			break;
            			case (int)1: {
HXLINE( 231)				HX_VARI(  ::haxe::zip::Huffman,b) = h->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >();
HXDLIN( 231)				HX_VARI(  ::haxe::zip::Huffman,a) = h->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >();
...
HXDLIN( 231)				return this->applyHuffman(_hx_tmp);
            			...
            			break;
            			case (int)2: {
HXLINE( 232)				HX_VARI( ::Array< ::Dynamic>,tbl) = h->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 232)				HX_VARI( int,n) = h->_hx_getInt(0);

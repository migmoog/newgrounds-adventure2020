...
HXLINE( 108)		HX_VARI(  ::Dynamic,r) = ::haxe::Unserializer_obj::DEFAULT_RESOLVER;
...
int Unserializer_obj::readDigits(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 144)
HXLINE( 145)		HX_VARI( int,k) = 0;
HXLINE( 146)		HX_VARI( bool,s) = false;
HXLINE( 147)		HX_VARI( int,fpos) = this->pos;
HXLINE( 148)		while(true){
HXLINE( 149)			HX_VARI( int,c) = this->buf.cca(this->pos);
HXLINE( 150)			if ((c == 0)) {
...
Float Unserializer_obj::readFloat(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 169)
HXLINE( 170)		HX_VARI( int,p1) = this->pos;
HXLINE( 171)		while(true){
HXLINE( 172)			HX_VARI( int,c) = this->buf.cca(this->pos);
HXLINE( 173)			if ((c == 0)) {
...
HXLINE( 190)			HX_VARI(  ::Dynamic,k) = this->unserialize();
...
HXLINE( 193)			HX_VARI(  ::Dynamic,v) = this->unserialize();
...
HXLINE( 202)		HX_VARI( int,nargs) = this->readDigits();
HXLINE( 203)		if ((nargs == 0)) {
HXLINE( 204)			return ::Type_obj::createEnum(edecl,tag,null());
            		}
HXLINE( 205)		HX_VARI( ::cpp::VirtualArray,args) = ::cpp::VirtualArray_obj::__new();
...
HXLINE( 232)		switch((int)(this->buf.cca(this->pos++))){
            			case (int)65: {
HXLINE( 440)				HX_VARI( ::String,name) = ( (::String)(this->unserialize()) );
HXLINE( 441)				HX_VARI( ::hx::Class,cl) = this->resolver->__Field(HX_("resolveClass",ac,bd,dd,80),::hx::paccDynamic)(name);
...
HXLINE( 447)				HX_VARI( ::hx::Class,e) = this->resolver->__Field(HX_("resolveEnum",0d,90,51,de),::hx::paccDynamic)(name);
...
HXLINE( 450)				return e;
            			...
            			break;
            			case (int)67: {
HXLINE( 429)				HX_VARI( ::String,name) = ( (::String)(this->unserialize()) );
HXLINE( 430)				HX_VARI( ::hx::Class,cl) = this->resolver->__Field(HX_("resolveClass",ac,bd,dd,80),::hx::paccDynamic)(name);
HXLINE( 431)				if (::hx::IsNull( cl )) {
HXLINE( 432)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Class not found ",13,56,74,ed) + name)));
            				}
HXLINE( 433)				HX_VARI(  ::Dynamic,o) = ::Type_obj::createEmptyInstance(cl);
...
HXLINE( 438)				return o;
            			...
            			break;
            			case (int)77: {
HXLINE( 364)				HX_VARI(  ::haxe::ds::ObjectMap,h) =  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX );
HXLINE( 365)				this->cache->push(h);
HXLINE( 366)				HX_VARI( ::String,buf) = this->buf;
HXLINE( 367)				while((this->buf.cca(this->pos) != 104)){
HXLINE( 368)					HX_VARI(  ::Dynamic,s) = this->unserialize();
...
HXLINE( 372)				return h;
            			...
            			break;
            			case (int)82: {
HXLINE( 296)				HX_VARI( int,n) = this->readDigits();
...
HXLINE( 299)				return this->scache->__get(n);
            			...
            			break;
            			case (int)97: {
HXLINE( 261)				HX_VARI( ::String,buf) = this->buf;
HXLINE( 262)				HX_VARI( ::cpp::VirtualArray,a) = ::cpp::VirtualArray_obj::__new();
HXLINE( 264)				HX_VARI( int,cachePos) = this->cache->get_length();
HXLINE( 266)				this->cache->push(a);
HXLINE( 267)				while(true){
HXLINE( 268)					HX_VARI( int,c) = this->buf.cca(this->pos);
HXLINE( 269)					if ((c == 104)) {
HXLINE( 270)						this->pos++;
...
HXLINE( 273)					if ((c == 117)) {
HXLINE( 274)						this->pos++;
HXLINE( 275)						HX_VARI( int,n) = this->readDigits();
...
HXLINE( 281)				return (this->cache->set(cachePos,_hx_reslove_virtual_array(a)));
            			...
            			break;
            			case (int)98: {
HXLINE( 341)				HX_VARI(  ::haxe::ds::StringMap,h) =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 342)				this->cache->push(h);
HXLINE( 343)				HX_VARI( ::String,buf) = this->buf;
HXLINE( 344)				while((this->buf.cca(this->pos) != 104)){
HXLINE( 345)					HX_VARI( ::String,s) = ( (::String)(this->unserialize()) );
...
HXLINE( 349)				return h;
            			...
            			break;
            			case (int)99: {
HXLINE( 303)				HX_VARI( ::String,name) = ( (::String)(this->unserialize()) );
HXLINE( 304)				HX_VARI( ::hx::Class,cl) = this->resolver->__Field(HX_("resolveClass",ac,bd,dd,80),::hx::paccDynamic)(name);
HXLINE( 305)				if (::hx::IsNull( cl )) {
HXLINE( 306)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Class not found ",13,56,74,ed) + name)));
            				}
HXLINE( 307)				HX_VARI(  ::Dynamic,o) = ::Type_obj::createEmptyInstance(cl);
...
HXLINE( 242)				return this->readDigits();
            			...
            			break;
            			case (int)106: {
HXLINE( 320)				HX_VARI( ::String,name) = ( (::String)(this->unserialize()) );
HXLINE( 321)				HX_VARI( ::hx::Class,edecl) = this->resolver->__Field(HX_("resolveEnum",0d,90,51,de),::hx::paccDynamic)(name);
HXLINE( 322)				if (::hx::IsNull( edecl )) {
HXLINE( 323)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Enum not found ",aa,e1,55,fd) + name)));
            				}
HXLINE( 324)				this->pos++;
HXLINE( 325)				HX_VARI( int,index) = this->readDigits();
HXLINE( 326)				HX_VARI( ::String,tag) = ::Type_obj::getEnumConstructs(edecl)->__get(index);
...
HXLINE( 329)				HX_VARI(  ::Dynamic,e) = this->unserializeEnum(edecl,tag);
...
HXLINE( 255)				return ::Math_obj::NaN;
            			...
            			break;
            			case (int)108: {
HXLINE( 333)				HX_VARI(  ::haxe::ds::List,l) =  ::haxe::ds::List_obj::__alloc( HX_CTX );
HXLINE( 334)				this->cache->push(l);
HXLINE( 335)				HX_VARI( ::String,buf) = this->buf;
...
HXLINE( 234)				return null();
            			...
            			break;
            			case (int)111: {
HXLINE( 286)				HX_VARI(  ::Dynamic,o) =  ::Dynamic(::hx::Anon_obj::Create(0));
...
HXLINE( 259)				return ::Math_obj::POSITIVE_INFINITY;
            			...
            			break;
            			case (int)113: {
HXLINE( 351)				HX_VARI(  ::haxe::ds::IntMap,h) =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 352)				this->cache->push(h);
HXLINE( 353)				HX_VARI( ::String,buf) = this->buf;
HXLINE( 354)				HX_VARI( int,c) = this->buf.cca(this->pos++);
HXLINE( 355)				while((c == 58)){
HXLINE( 356)					HX_VARI( int,i) = this->readDigits();
...
HXLINE( 294)				return this->cache->__get(n);
            			...
            			break;
            			case (int)115: {
HXLINE( 385)				HX_VARI( int,len) = this->readDigits();
HXLINE( 386)				HX_VARI( ::String,buf) = this->buf;
...
HXLINE( 395)				HX_VARI( ::Array< int >,codes) = ::haxe::Unserializer_obj::CODES;
...
HXLINE( 400)				HX_VARI( int,i) = this->pos;
HXLINE( 401)				HX_VARI( int,rest) = (len & 3);
HXLINE( 402)				int size;
...
HXDLIN( 402)				HX_VARI( int,size1) = (((len >> 2) * 3) + size);
HXLINE( 403)				HX_VARI( int,max) = (i + (len - rest));
HXLINE( 404)				HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc(size1);
HXLINE( 405)				HX_VARI( int,bpos) = 0;
HXLINE( 406)				while((i < max)){
HXLINE( 407)					i = (i + 1);
HXDLIN( 407)					HX_VARI( int,c1) = codes->__get(buf.cca((i - 1)));
HXLINE( 408)					i = (i + 1);
HXDLIN( 408)					HX_VARI( int,c2) = codes->__get(buf.cca((i - 1)));
HXLINE( 409)					{
HXLINE( 409)						bpos = (bpos + 1);
HXDLIN( 409)						bytes->b[(bpos - 1)] = ( (unsigned char)(((c1 << 2) | (c2 >> 4))) );
            					}
HXLINE( 410)					i = (i + 1);
HXDLIN( 410)					HX_VARI( int,c3) = codes->__get(buf.cca((i - 1)));
HXLINE( 411)					{
HXLINE( 411)						bpos = (bpos + 1);
HXDLIN( 411)						bytes->b[(bpos - 1)] = ( (unsigned char)(((c2 << 4) | (c3 >> 2))) );
            					}
HXLINE( 412)					i = (i + 1);
HXDLIN( 412)					HX_VARI( int,c4) = codes->__get(buf.cca((i - 1)));
HXLINE( 413)					{
...
HXLINE( 416)					i = (i + 1);
HXDLIN( 416)					HX_VARI( int,c1) = codes->__get(buf.cca((i - 1)));
HXLINE( 417)					i = (i + 1);
HXDLIN( 417)					HX_VARI( int,c2) = codes->__get(buf.cca((i - 1)));
HXLINE( 418)					{
...
HXLINE( 420)						i = (i + 1);
HXDLIN( 420)						HX_VARI( int,c3) = codes->__get(buf.cca((i - 1)));
HXLINE( 421)						{
...
HXLINE( 383)				return d;
            			...
            			break;
            			case (int)119: {
HXLINE( 312)				HX_VARI( ::String,name) = ( (::String)(this->unserialize()) );
HXLINE( 313)				HX_VARI( ::hx::Class,edecl) = this->resolver->__Field(HX_("resolveEnum",0d,90,51,de),::hx::paccDynamic)(name);
HXLINE( 314)				if (::hx::IsNull( edecl )) {
HXLINE( 315)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Enum not found ",aa,e1,55,fd) + name)));
            				}
HXLINE( 316)				HX_VARI(  ::Dynamic,e) = this->unserializeEnum(edecl,( (::String)(this->unserialize()) ));
...
HXLINE( 301)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(this->unserialize()));
            			...
            			break;
            			case (int)121: {
HXLINE( 246)				HX_VARI( int,len) = this->readDigits();
...
HXLINE( 249)				HX_VARI( ::String,s) = this->buf.substr(this->pos,len);
...
HXLINE(  72)
HXLINE(  73)		HX_VARI( ::Array< int >,codes) = ::Array_obj< int >::__new();
HXLINE(  74)		{
HXLINE(  74)			int _g = 0;

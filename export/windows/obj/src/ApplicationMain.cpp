...
HXLINE(  17)
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("ADVENT2020",94,ce,f3,f5),::ApplicationMain_obj::create_dyn());
...
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("ADVENT2020",94,ce,f3,f5));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("ADVENT2020",94,ce,f3,f5));
...
HXLINE(  46)		HX_VARI(  ::Dynamic,attributes) =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(7,HX_("height",e7,07,4c,02),540)
            			->setFixed(8,HX_("element",bc,ae,54,06),null())
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("ADVENT2020",94,ce,f3,f5))

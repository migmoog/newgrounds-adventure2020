...
HXLINE(  20)
HXDLIN(  20)		HX_VARI( Float,this1) = data;
...
HXLINE(  27)
HXLINE(  29)		HX_VARI_NAME( Float,_hx_float,"float") = ( (Float)(value) );
...
HXLINE( 153)		HX_VARI( Float,data1) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_data_pointer_offset(data,offset);

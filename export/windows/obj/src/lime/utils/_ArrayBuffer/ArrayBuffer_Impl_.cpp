...
HXLINE(  20)
HXDLIN(  20)		HX_VARI(  ::haxe::io::Bytes,this1) = ::haxe::io::Bytes_obj::alloc(byteLength);
...
HXLINE(  35)		HX_VARI( int,length) = (( (int)(end) ) - begin);
...
HXLINE(  42)			HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc(length);

...
HXLINE(  18)
HXDLIN(  18)		HX_VARI(  ::haxe::io::Bytes,this1) =  ::haxe::io::Bytes_obj::__alloc( HX_CTX ,length,bytesData);
...
HXLINE(  92)
HXLINE(  95)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::lime::utils::_Bytes::Bytes_Impl__obj::alloc(0);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_Impl__obj,loadFromBytes,return )
 ...
 ::lime::app::Future Bytes_Impl__obj::loadFromFile(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE( 112)
HXLINE( 113)		HX_VARI(  ::lime::net::_HTTPRequest_lime_utils_Bytes,request) =  ::lime::net::_HTTPRequest_lime_utils_Bytes_obj::__alloc( HX_CTX ,null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_Impl__obj,loadFromFile,return )
 ...
 ::haxe::io::Bytes Bytes_Impl__obj::ofData(::Array< unsigned char > b){
            	...
            	HX_STACK_ARG(b,"b")
HXLINE( 118)
HXLINE( 119)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::ofData(b);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_Impl__obj,ofData,return )
 ...
 ::haxe::io::Bytes Bytes_Impl__obj::ofString(::String s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE( 124)
HXLINE( 125)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::ofString(s,null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_Impl__obj,ofString,return )
 ...
 ::haxe::io::Bytes Bytes_Impl__obj::_hx___fromNativePointer( ::Dynamic data,int length){
            	...
            	HX_STACK_ARG(length,"length")
HXLINE( 131)
HXLINE( 132)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::lime::utils::_Bytes::Bytes_Impl__obj::alloc(0);

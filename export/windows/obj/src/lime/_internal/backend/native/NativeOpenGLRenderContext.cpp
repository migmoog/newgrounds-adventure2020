...
HXDLIN(1457)		HX_VARI(  ::hx::Object *,result1) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_active_uniform_block_name(result,uniformBlockIndex);
...
HXDLIN(1497)		HX_VARI(  ::hx::Object *,result1) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_attached_shaders(result);
...
HXDLIN(1903)		HX_VARI(  ::hx::Object *,result1) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_program_info_log(result);
...
HXDLIN(2041)		HX_VARI(  ::hx::Object *,result1) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_shader_info_log(result);
...
HXDLIN(2068)		HX_VARI(  ::hx::Object *,result1) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_shader_source(result);
...
HXDLIN(2218)		HX_VARI(  ::Dynamic,result1) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_transform_feedback_varying(result,index)) );

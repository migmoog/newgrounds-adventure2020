...
HXDLIN(  33)		HX_VARI(  ::hx::Object *,buffer1) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_png_decode_bytes(::hx::DynamicPtr(bytes),decodeData,::hx::DynamicPtr( ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,null(),null(),null(),null())));
...
HXDLIN(  58)		HX_VARI(  ::hx::Object *,buffer1) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_png_decode_file(path,decodeData,::hx::DynamicPtr( ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,null(),null(),null(),null())));

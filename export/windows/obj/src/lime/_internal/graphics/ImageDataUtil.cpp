...
HXLINE(  53)		HX_VAR( int,sourcePixel);
HXLINE(  54)		HX_VAR( int,mapPixel);
HXLINE(  55)		HX_VAR( int,targetPixel);
HXLINE(  57)		HX_VAR( Float,mapPixelX);
HXLINE(  58)		HX_VAR( Float,mapPixelY);
HXLINE(  59)		HX_VAR( Float,mapPixelA);
HXLINE(  62)		HX_VAR( int,s1);
HXLINE(  63)		HX_VAR( int,s2);
HXLINE(  64)		HX_VAR( int,s3);
HXLINE(  65)		HX_VAR( int,s4);
...
HXDLIN( 144)		HX_VARI( int,result) = this1;
HXLINE( 145)		{
...
HXDLIN( 241)			HX_VAR( int,srcPixel);
HXDLIN( 241)			HX_VAR( int,destPixel);
...
HXLINE( 332)				HX_VAR( int,sourcePixel);
HXDLIN( 332)				HX_VAR( int,destPixel);
HXLINE( 334)				HX_VARI( bool,sourcePremultiplied) = sourceImage->buffer->premultiplied;
HXLINE( 335)				HX_VARI( bool,destPremultiplied) = image->buffer->premultiplied;
HXLINE( 336)				HX_VARI( int,sourceBytesPerPixel) = ::Std_obj::_hx_int((( (Float)(sourceImage->buffer->bitsPerPixel) ) / ( (Float)(8) )));
HXLINE( 337)				HX_VARI( int,destBytesPerPixel) = ::Std_obj::_hx_int((( (Float)(image->buffer->bitsPerPixel) ) / ( (Float)(8) )));
HXLINE( 339)				HX_VAR( bool,useAlphaImage);
...
HXDLIN( 352)									HX_VARI( int,x) = (_g1 - 1);
HXLINE( 354)									{
...
HXDLIN( 411)										HX_VARI( int,x) = (_g1 - 1);
HXLINE( 413)										{
...
HXLINE( 424)					HX_VARI(  ::lime::utils::ArrayBufferView,alphaData) = alphaImage->buffer->data;
HXLINE( 425)					HX_VARI( int,alphaFormat) = alphaImage->buffer->format;
HXLINE( 426)					HX_VAR( int,alphaPosition);
HXDLIN( 426)					HX_VAR( int,alphaPixel);
...
HXLINE( 428)					HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,alphaView2) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,alphaImage, ::lime::math::Rectangle_obj::__alloc( HX_CTX ,(sourceView->x + alphaView),(sourceView->y + alphaView1),sourceView->width,sourceView->height));
...
HXDLIN( 442)									HX_VARI( int,x) = (_g1 - 1);
HXLINE( 444)									{
...
HXDLIN( 484)									HX_VARI( int,x) = (_g1 - 1);
HXLINE( 486)									{
...
HXLINE( 507)
HXLINE( 508)		HX_VAR( int,fillColor);
...
HXLINE( 525)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
...
HXLINE( 534)			HX_VARI( int,format) = image->buffer->format;
HXLINE( 535)			HX_VARI( bool,premultiplied) = image->buffer->premultiplied;
...
HXLINE( 538)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,dataView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,image,rect);
HXLINE( 539)			HX_VAR( int,row);
HXLINE( 541)			{
HXLINE( 541)				int _g = 0;
HXDLIN( 541)				int _g1 = dataView->height;
HXDLIN( 541)				while((_g < _g1)){
HXLINE( 541)					_g = (_g + 1);
HXDLIN( 541)					HX_VARI( int,y) = (_g - 1);
...
HXDLIN( 545)							HX_VARI( int,x) = (_g1 - 1);
HXLINE( 547)							{
...
void ImageDataUtil_obj::floodFill( ::lime::graphics::Image image,int x,int y,int color,int format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 557)
HXLINE( 558)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
...
HXLINE( 569)			HX_VARI( int,format) = image->buffer->format;
HXLINE( 570)			HX_VARI( bool,premultiplied) = image->buffer->premultiplied;
HXLINE( 572)			HX_VARI( int,fillColor) = color;
HXLINE( 574)			HX_VAR( int,hitColor);
HXLINE( 575)			{
...
HXLINE( 587)			HX_VARI( ::Array< int >,dx) = ::Array_obj< int >::fromData( _hx_array_data_0eb0fdcf_29,4);
HXLINE( 588)			HX_VARI( ::Array< int >,dy) = ::Array_obj< int >::fromData( _hx_array_data_0eb0fdcf_30,4);
HXLINE( 590)			HX_VARI( int,minX) = -(image->offsetX);
HXLINE( 591)			HX_VARI( int,minY) = -(image->offsetY);
HXLINE( 592)			HX_VARI( int,maxX) = (minX + image->width);
HXLINE( 593)			HX_VARI( int,maxY) = (minY + image->height);
HXLINE( 595)			HX_VARI( ::Array< int >,queue) = ::Array_obj< int >::__new();
HXLINE( 596)			queue->push(x);
HXLINE( 597)			queue->push(y);
HXLINE( 599)			HX_VAR(  ::Dynamic,curPointX);
HXDLIN( 599)			HX_VAR(  ::Dynamic,curPointY);
HXDLIN( 599)			HX_VAR( int,nextPointX);
HXDLIN( 599)			HX_VAR( int,nextPointY);
HXDLIN( 599)			HX_VAR( int,nextPointOffset);
HXDLIN( 599)			HX_VAR( int,readColor);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC5(ImageDataUtil_obj,floodFill,(void))
 ...
 ::lime::graphics::Image ImageDataUtil_obj::gaussianBlur( ::lime::graphics::Image image, ::lime::graphics::Image sourceImage, ::lime::math::Rectangle sourceRect, ::lime::math::Vector2 destPoint,::hx::Null< Float >  __o_blurX,::hx::Null< Float >  __o_blurY,::hx::Null< int >  __o_quality,::hx::Null< Float >  __o_strength, ::Dynamic color){
            	...
            	HX_STACK_ARG(color,"color")
HXLINE( 641)
HXLINE( 645)		HX_VARI( bool,imagePremultiplied) = image->get_premultiplied();
...
STATIC_HX_DEFINE_DYNAMIC_FUNC9(ImageDataUtil_obj,gaussianBlur,return )
 ...
 ::lime::math::Rectangle ImageDataUtil_obj::getColorBoundsRect( ::lime::graphics::Image image,int mask,int color,bool findColor,int format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 667)
HXLINE( 668)		HX_VARI( int,left) = (image->width + 1);
HXLINE( 669)		HX_VARI( int,right) = 0;
HXLINE( 670)		HX_VARI( int,top) = (image->height + 1);
HXLINE( 671)		HX_VARI( int,bottom) = 0;
HXLINE( 673)		HX_VAR( int,_color);
HXDLIN( 673)		HX_VAR( int,_mask);
...
HXLINE( 696)		HX_VAR( int,pixel);
HXDLIN( 696)		HX_VAR( bool,hit);
HXLINE( 698)		{
HXLINE( 698)			int _g = 0;
HXDLIN( 698)			int _g1 = image->width;
HXDLIN( 698)			while((_g < _g1)){
HXLINE( 698)				_g = (_g + 1);
HXDLIN( 698)				HX_VARI( int,x) = (_g - 1);
...
HXDLIN( 702)						HX_VARI( int,y) = (_g1 - 1);
...
HXDLIN( 745)				HX_VARI( int,y) = (_g4 - 1);
...
HXLINE( 792)		HX_VARI( int,w) = (right - left);
HXLINE( 793)		HX_VARI( int,h) = (bottom - top);
HXLINE( 795)		if ((w > 0)) {
HXLINE( 795)			w = (w + 1);
            		}
HXLINE( 796)		if ((h > 0)) {
...
HXLINE( 851)		HX_VARI( int,length) = ::Std_obj::_hx_int((rect->width * rect->height));
HXLINE( 852)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc((length * 4));
...
HXLINE( 859)			HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
HXLINE( 860)			HX_VARI( int,sourceFormat) = image->buffer->format;
HXLINE( 861)			HX_VARI( bool,premultiplied) = image->buffer->premultiplied;
HXLINE( 863)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,dataView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,image,rect);
HXLINE( 864)			HX_VAR( int,position);
HXDLIN( 864)			HX_VAR( int,argb);
HXDLIN( 864)			HX_VAR( int,bgra);
HXDLIN( 864)			HX_VAR( int,pixel);
HXLINE( 865)			HX_VARI( int,destPosition) = 0;
HXLINE( 867)			{
HXLINE( 867)				int _g = 0;
HXDLIN( 867)				int _g1 = dataView->height;
HXDLIN( 867)				while((_g < _g1)){
HXLINE( 867)					_g = (_g + 1);
HXDLIN( 867)					HX_VARI( int,y) = (_g - 1);
...
HXDLIN( 871)							HX_VARI( int,x) = (_g1 - 1);
HXLINE( 873)							{
...
HXLINE( 910)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,sourceView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,sourceImage,sourceRect);
HXLINE( 911)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,destView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,image, ::lime::math::Rectangle_obj::__alloc( HX_CTX ,destPoint->x,destPoint->y,sourceView->width,sourceView->height));
HXLINE( 913)			HX_VARI(  ::lime::utils::ArrayBufferView,sourceData) = sourceImage->buffer->data;
HXLINE( 914)			HX_VARI(  ::lime::utils::ArrayBufferView,destData) = image->buffer->data;
HXLINE( 915)			HX_VARI( int,sourceFormat) = sourceImage->buffer->format;
HXLINE( 916)			HX_VARI( int,destFormat) = image->buffer->format;
HXLINE( 917)			HX_VARI( bool,sourcePremultiplied) = sourceImage->buffer->premultiplied;
HXLINE( 918)			HX_VARI( bool,destPremultiplied) = image->buffer->premultiplied;
HXLINE( 920)			HX_VAR( int,sourcePosition);
HXDLIN( 920)			HX_VAR( int,destPosition);
HXDLIN( 920)			HX_VAR( int,sourcePixel);
HXDLIN( 920)			HX_VAR( int,destPixel);
HXLINE( 922)			{
HXLINE( 922)				int _g = 0;
HXDLIN( 922)				int _g1 = destView->height;
HXDLIN( 922)				while((_g < _g1)){
HXLINE( 922)					_g = (_g + 1);
HXDLIN( 922)					HX_VARI( int,y) = (_g - 1);
...
HXDLIN( 927)							HX_VARI( int,x) = (_g1 - 1);
HXLINE( 929)							{
...
void ImageDataUtil_obj::multiplyAlpha( ::lime::graphics::Image image){
            	...
            	HX_STACK_ARG(image,"image")
HXLINE( 950)
HXLINE( 951)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
...
HXLINE( 959)			HX_VARI( int,format) = image->buffer->format;
HXLINE( 960)			HX_VARI( int,length) = ::Std_obj::_hx_int((( (Float)(data->length) ) / ( (Float)(4) )));
HXLINE( 961)			HX_VAR( int,pixel);
HXLINE( 963)			{
HXLINE( 963)				int _g = 0;
HXDLIN( 963)				int _g1 = length;
HXDLIN( 963)				while((_g < _g1)){
HXLINE( 963)					_g = (_g + 1);
HXDLIN( 963)					HX_VARI( int,i) = (_g - 1);
HXLINE( 965)					{
...
HXLINE( 976)
HXLINE( 977)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) = image->buffer;
...
HXDLIN( 979)		HX_VARI(  ::lime::graphics::ImageBuffer,newBuffer) =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,newWidth,newHeight,null(),null());
...
HXLINE( 986)			HX_VARI( int,imageWidth) = image->width;
HXLINE( 987)			HX_VARI( int,imageHeight) = image->height;
HXLINE( 989)			HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->get_data();
HXLINE( 990)			HX_VARI(  ::lime::utils::ArrayBufferView,newData) = newBuffer->data;
HXLINE( 991)			HX_VAR( int,sourceIndex);
HXDLIN( 991)			HX_VAR( int,sourceIndexX);
HXDLIN( 991)			HX_VAR( int,sourceIndexY);
HXDLIN( 991)			HX_VAR( int,sourceIndexXY);
HXDLIN( 991)			HX_VAR( int,index);
HXLINE( 996)			HX_VAR( int,sourceX);
HXDLIN( 996)			HX_VAR( int,sourceY);
HXLINE( 997)			HX_VAR( Float,u);
HXDLIN( 997)			HX_VAR( Float,v);
HXDLIN( 997)			HX_VAR( Float,uRatio);
HXDLIN( 997)			HX_VAR( Float,vRatio);
HXDLIN( 997)			HX_VAR( Float,uOpposite);
HXDLIN( 997)			HX_VAR( Float,vOpposite);
HXLINE(1004)			{
HXLINE(1004)				int _g = 0;
HXDLIN(1004)				int _g1 = newHeight;
HXDLIN(1004)				while((_g < _g1)){
HXLINE(1004)					_g = (_g + 1);
HXDLIN(1004)					HX_VARI( int,y) = (_g - 1);
HXLINE(1006)					{
HXLINE(1006)						int _g1 = 0;
HXDLIN(1006)						int _g2 = newWidth;
HXDLIN(1006)						while((_g1 < _g2)){
HXLINE(1006)							_g1 = (_g1 + 1);
HXDLIN(1006)							HX_VARI( int,x) = (_g1 - 1);
...
void ImageDataUtil_obj::resizeBuffer( ::lime::graphics::Image image,int newWidth,int newHeight){
            	...
            	HX_STACK_ARG(newHeight,"newHeight")
HXLINE(1065)
HXLINE(1066)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) = image->buffer;
HXLINE(1067)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->get_data();
...
HXDLIN(1068)		HX_VARI(  ::lime::utils::ArrayBufferView,newData) = this1;
HXLINE(1069)		HX_VAR( int,sourceIndex);
HXDLIN(1069)		HX_VAR( int,index);
HXLINE(1071)		{
HXLINE(1071)			int _g = 0;
HXDLIN(1071)			int _g1 = buffer->height;
HXDLIN(1071)			while((_g < _g1)){
HXLINE(1071)				_g = (_g + 1);
HXDLIN(1071)				HX_VARI( int,y) = (_g - 1);
HXLINE(1073)				{
HXLINE(1073)					int _g1 = 0;
HXDLIN(1073)					int _g2 = buffer->width;
HXDLIN(1073)					while((_g1 < _g2)){
HXLINE(1073)						_g1 = (_g1 + 1);
HXDLIN(1073)						HX_VARI( int,x) = (_g1 - 1);
...
void ImageDataUtil_obj::setFormat( ::lime::graphics::Image image,int format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE(1101)
HXLINE(1102)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
...
HXLINE(1110)			HX_VAR( int,index);
HXDLIN(1110)			HX_VAR(  ::Dynamic,a16);
HXLINE(1111)			HX_VARI( int,length) = ::Std_obj::_hx_int((( (Float)(data->length) ) / ( (Float)(4) )));
HXLINE(1112)			HX_VAR( int,r1);
HXDLIN(1112)			HX_VAR( int,g1);
HXDLIN(1112)			HX_VAR( int,b1);
HXDLIN(1112)			HX_VAR( int,a1);
HXDLIN(1112)			HX_VAR( int,r2);
HXDLIN(1112)			HX_VAR( int,g2);
HXDLIN(1112)			HX_VAR( int,b2);
HXDLIN(1112)			HX_VAR( int,a2);
HXLINE(1113)			HX_VAR(  ::Dynamic,r);
HXDLIN(1113)			HX_VAR(  ::Dynamic,g);
HXDLIN(1113)			HX_VAR(  ::Dynamic,b);
HXDLIN(1113)			HX_VAR(  ::Dynamic,a);
...
HXLINE(1157)					_g = (_g + 1);
HXDLIN(1157)					HX_VARI( int,i) = (_g - 1);
...
HXDLIN(1194)		HX_VARI( int,source) = this1;
HXLINE(1195)		{
...
HXLINE(1237)			HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
HXLINE(1238)			HX_VARI( int,sourceFormat) = image->buffer->format;
HXLINE(1239)			HX_VARI( bool,premultiplied) = image->buffer->premultiplied;
HXLINE(1240)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,dataView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,image,rect);
HXLINE(1241)			HX_VAR( int,row);
HXDLIN(1241)			HX_VAR( int,color);
HXDLIN(1241)			HX_VAR( int,pixel);
HXLINE(1242)			HX_VARI( bool,transparent) = image->get_transparent();
HXLINE(1243)			HX_VARI(  ::haxe::io::Bytes,bytes) = bytePointer->bytes;
HXLINE(1244)			HX_VARI( int,dataPosition) = bytePointer->offset;
HXLINE(1245)			HX_VARI( bool,littleEndian) = ::hx::IsNotEq( endian,::lime::_hx_system::Endian_obj::_hx_BIG_ENDIAN_dyn() );
HXLINE(1247)			{
HXLINE(1247)				int _g = 0;
HXDLIN(1247)				int _g1 = dataView->height;
HXDLIN(1247)				while((_g < _g1)){
HXLINE(1247)					_g = (_g + 1);
HXDLIN(1247)					HX_VARI( int,y) = (_g - 1);
...
HXDLIN(1251)							HX_VARI( int,x) = (_g1 - 1);
...
int ImageDataUtil_obj::threshold( ::lime::graphics::Image image, ::lime::graphics::Image sourceImage, ::lime::math::Rectangle sourceRect, ::lime::math::Vector2 destPoint,::String operation,int threshold,int color,int mask,bool copySource,int format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE(1287)
HXLINE(1288)		HX_VAR( int,_color);
HXDLIN(1288)		HX_VAR( int,_mask);
HXDLIN(1288)		HX_VAR( int,_threshold);
...
HXLINE(1308)		HX_VAR( int,_operation);
...
HXLINE(1321)		HX_VARI(  ::lime::utils::ArrayBufferView,srcData) = sourceImage->buffer->data;
HXLINE(1322)		HX_VARI(  ::lime::utils::ArrayBufferView,destData) = image->buffer->data;
...
HXLINE(1326)		HX_VARI( int,hits) = 0;
...
HXLINE(1334)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,srcView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,sourceImage,sourceRect);
HXLINE(1335)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,destView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,image, ::lime::math::Rectangle_obj::__alloc( HX_CTX ,destPoint->x,destPoint->y,srcView->width,srcView->height));
HXLINE(1337)			HX_VARI( int,srcFormat) = sourceImage->buffer->format;
HXLINE(1338)			HX_VARI( int,destFormat) = image->buffer->format;
HXLINE(1339)			HX_VARI( bool,srcPremultiplied) = sourceImage->buffer->premultiplied;
HXLINE(1340)			HX_VARI( bool,destPremultiplied) = image->buffer->premultiplied;
HXLINE(1342)			HX_VAR( int,srcPosition);
HXDLIN(1342)			HX_VAR( int,destPosition);
HXDLIN(1342)			HX_VAR( int,srcPixel);
HXDLIN(1342)			HX_VAR( int,destPixel);
HXDLIN(1342)			HX_VAR( int,pixelMask);
HXDLIN(1342)			HX_VAR( bool,test);
HXDLIN(1342)			HX_VAR( int,value);
HXLINE(1350)			{
HXLINE(1350)				int _g = 0;
HXDLIN(1350)				int _g1 = destView->height;
HXDLIN(1350)				while((_g < _g1)){
HXLINE(1350)					_g = (_g + 1);
HXDLIN(1350)					HX_VARI( int,y) = (_g - 1);
...
HXDLIN(1355)							HX_VARI( int,x) = (_g1 - 1);
HXLINE(1357)							{
...
void ImageDataUtil_obj::unmultiplyAlpha( ::lime::graphics::Image image){
            	...
            	HX_STACK_ARG(image,"image")
HXLINE(1400)
HXLINE(1401)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
...
HXLINE(1409)			HX_VARI( int,format) = image->buffer->format;
HXLINE(1410)			HX_VARI( int,length) = ::Std_obj::_hx_int((( (Float)(data->length) ) / ( (Float)(4) )));
HXLINE(1411)			HX_VAR( int,pixel);
HXLINE(1413)			{
HXLINE(1413)				int _g = 0;
HXDLIN(1413)				int _g1 = length;
HXDLIN(1413)				while((_g < _g1)){
HXLINE(1413)					_g = (_g + 1);
HXDLIN(1413)					HX_VARI( int,i) = (_g - 1);
HXLINE(1415)					{
...
HXLINE(1431)		HX_VARI( int,bx1) = ::Std_obj::_hx_int(bx);
HXLINE(1432)		HX_VARI( int,by1) = ::Std_obj::_hx_int(by);
HXLINE(1434)		{
...
HXLINE(1446)
HXLINE(1447)		HX_VARI( Float,iarr) = (( (Float)(1) ) / ( (Float)(((r + r) + 1)) ));
HXLINE(1448)		HX_VAR( int,ti);
HXDLIN(1448)		HX_VAR( int,li);
HXDLIN(1448)		HX_VAR( int,ri);
HXDLIN(1448)		HX_VAR(  ::Dynamic,fv);
HXDLIN(1448)		HX_VAR(  ::Dynamic,lv);
HXDLIN(1448)		HX_VAR( int,val);
HXLINE(1450)		{
HXLINE(1450)			int _g = 0;
HXDLIN(1450)			int _g1 = h;
HXDLIN(1450)			while((_g < _g1)){
HXLINE(1450)				_g = (_g + 1);
HXDLIN(1450)				HX_VARI( int,i) = (_g - 1);
HXLINE(1452)				ti = (i * w);
HXLINE(1453)				li = ti;
HXLINE(1454)				ri = (ti + r);
...
HXDLIN(1460)						HX_VARI( int,j) = (_g1 - 1);
...
HXDLIN(1465)						HX_VARI( int,j) = (_g3 - 1);
...
HXDLIN(1473)						HX_VARI( int,j) = (_g5 - 1);
...
HXDLIN(1482)						HX_VARI( int,j) = (_g7 - 1);
...
void ImageDataUtil_obj::_hx___boxBlurT( ::lime::utils::ArrayBufferView imgA, ::lime::utils::ArrayBufferView imgB,int w,int h,int r,int off){
            	...
            	HX_STACK_ARG(off,"off")
HXLINE(1493)
HXLINE(1494)		HX_VARI( Float,iarr) = (( (Float)(1) ) / ( (Float)(((r + r) + 1)) ));
HXLINE(1495)		HX_VARI( int,ws) = (w * 4);
HXLINE(1496)		HX_VAR( int,ti);
HXDLIN(1496)		HX_VAR( int,li);
HXDLIN(1496)		HX_VAR( int,ri);
HXDLIN(1496)		HX_VAR(  ::Dynamic,fv);
HXDLIN(1496)		HX_VAR(  ::Dynamic,lv);
HXDLIN(1496)		HX_VAR( int,val);
HXLINE(1498)		{
HXLINE(1498)			int _g = 0;
HXDLIN(1498)			int _g1 = w;
HXDLIN(1498)			while((_g < _g1)){
HXLINE(1498)				_g = (_g + 1);
HXDLIN(1498)				HX_VARI( int,i) = (_g - 1);
...
HXDLIN(1508)						HX_VARI( int,j) = (_g1 - 1);
...
HXDLIN(1513)						HX_VARI( int,j) = (_g3 - 1);
...
HXDLIN(1521)						HX_VARI( int,j) = (_g5 - 1);
...
HXDLIN(1530)						HX_VARI( int,j) = (_g7 - 1);
...
HXLINE(1545)
HXLINE(1546)		HX_VARI( int,sourceX) = (destX - ::Std_obj::_hx_int(destPoint->x));
HXLINE(1547)		HX_VARI( int,sourceY) = (destY - ::Std_obj::_hx_int(destPoint->y));
HXLINE(1549)		HX_VARI( int,offset) = 0;
...
::Array< Float > ImageDataUtil_obj::_hx___getBoxesForGaussianBlur(Float sigma,int n){
            	...
            	HX_STACK_ARG(n,"n")
HXLINE(1564)
HXLINE(1565)		HX_VARI( Float,wIdeal) = ::Math_obj::sqrt(((((( (Float)(12) ) * sigma) * sigma) / ( (Float)(n) )) + 1));
HXLINE(1566)		HX_VARI( int,wl) = ::Math_obj::floor(wIdeal);
HXLINE(1567)		if ((::hx::Mod(wl,2) == 0)) {
HXLINE(1567)			wl = (wl - 1);
            		}
HXLINE(1568)		HX_VARI( int,wu) = (wl + 2);
HXLINE(1570)		HX_VARI( Float,mIdeal) = ((((((( (Float)(12) ) * sigma) * sigma) - ( (Float)(((n * wl) * wl)) )) - ( (Float)(((4 * n) * wl)) )) - ( (Float)((3 * n)) )) / ( (Float)(((-4 * wl) - 4)) ));
HXLINE(1571)		HX_VARI( int,m) = ::Math_obj::round(mIdeal);
HXLINE(1572)		HX_VARI( ::Array< Float >,sizes) = ::Array_obj< Float >::__new(0);
HXLINE(1574)		{
HXLINE(1574)			int _g = 0;
HXDLIN(1574)			int _g1 = n;
HXDLIN(1574)			while((_g < _g1)){
HXLINE(1574)				_g = (_g + 1);
HXDLIN(1574)				HX_VARI( int,i) = (_g - 1);
...
int ImageDataUtil_obj::_hx___pixelCompare(int n1,int n2){
            	...
            	HX_STACK_ARG(n2,"n2")
HXLINE(1583)
HXLINE(1584)		HX_VARI( int,tmp1) = (::hx::UShr(n1,24) & 255);
HXLINE(1585)		HX_VARI( int,tmp2) = (::hx::UShr(n2,24) & 255);
...
void ImageDataUtil_obj::_hx___translatePixel( ::lime::utils::ArrayBufferView imgB, ::lime::math::Rectangle sourceRect, ::lime::math::Rectangle destRect, ::lime::math::Vector2 destPoint,int destX,int destY,Float strength){
            	...
            	HX_STACK_ARG(strength,"strength")
HXLINE(1632)
HXLINE(1633)		HX_VARI( int,d) = (4 * ((destY * ::Std_obj::_hx_int(destRect->width)) + destX));
...
HXDLIN(1634)		HX_VARI( int,s) = offset;
HXLINE(1636)		if ((s < 0)) {
...
HXDLIN(1646)			HX_VARI( int,a1) = ::Std_obj::_hx_int((a * strength));
HXLINE(1647)			{

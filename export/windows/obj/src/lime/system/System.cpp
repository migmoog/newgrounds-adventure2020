...
HXLINE( 392)			HX_VARI( ::String,seperator) = HX_("\\",5c,00,00,00);
...
HXLINE( 724)			HX_VARI( ::String,label) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_system_get_platform_label()) );

...
HXLINE(  78)			if (async) {
HXLINE(  80)				HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__alloc( HX_CTX );
...
HXLINE( 219)			HX_VARI( int,time) = ::lime::_hx_system::System_obj::getTimer();
HXLINE( 220)			HX_VARI( int,end) = (time + waitTime);
...
HXLINE( 267)				HX_VARI(  ::lime::app::Future,future) =  ::lime::app::Future_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 280)
HXLINE( 281)					HX_VARI(  ::lime::app::Future,future) = ( ( ::lime::app::Future)(next(val)) );
HXLINE( 282)					future->onError(promise->error_dyn());
HXLINE( 283)					future->onComplete(promise->complete_dyn());
            				}
            				HX_END_LOCAL_FUNC1((void))

HXLINE( 274)				HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__alloc( HX_CTX );
...
HXLINE( 105)
HXLINE( 106)		HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__alloc( HX_CTX );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Future_obj,ofEvents,return )
 ...
 ::lime::app::Future Future_obj::withError( ::Dynamic error){
            	...
            	HX_STACK_ARG(error,"error")
HXLINE( 296)
HXLINE( 297)		HX_VARI(  ::lime::app::Future,future) =  ::lime::app::Future_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 309)
HXLINE( 310)		HX_VARI(  ::lime::app::Future,future) =  ::lime::app::Future_obj::__alloc( HX_CTX ,null(),null());

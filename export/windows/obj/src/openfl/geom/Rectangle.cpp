...
HXLINE( 550)		HX_VARI( Float,offsetX) = ((Float)0.0);
HXLINE( 551)		HX_VARI( Float,offsetY) = ((Float)0.0);
HXLINE( 552)		HX_VARI( Float,offsetRight) = ((Float)0.0);
HXLINE( 553)		HX_VARI( Float,offsetBottom) = ((Float)0.0);
...
HXLINE( 577)		HX_VARI( Float,cacheRight) = this->get_right();
HXLINE( 578)		HX_VARI( Float,cacheBottom) = this->get_bottom();
...
void Rectangle_obj::_hx___transform( ::openfl::geom::Rectangle rect, ::openfl::geom::Matrix m){
            	...
            	HX_STACK_ARG(m,"m")
HXLINE( 608)
HXLINE( 609)		HX_VARI( Float,tx0) = ((m->a * this->x) + (m->c * this->y));
HXLINE( 610)		HX_VARI( Float,tx1) = tx0;
HXLINE( 611)		HX_VARI( Float,ty0) = ((m->b * this->x) + (m->d * this->y));
HXLINE( 612)		HX_VARI( Float,ty1) = ty0;
HXLINE( 614)		HX_VARI( Float,tx) = ((m->a * (this->x + this->width)) + (m->c * this->y));
HXLINE( 615)		HX_VARI( Float,ty) = ((m->b * (this->x + this->width)) + (m->d * this->y));

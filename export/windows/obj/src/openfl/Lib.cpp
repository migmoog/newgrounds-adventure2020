...
HXLINE(  90)			HX_VARI(  ::haxe::Timer,timer) = ( ( ::haxe::Timer)(::openfl::Lib_obj::_hx___timers->get(id)) );
...
HXLINE( 106)			HX_VARI(  ::haxe::Timer,timer) = ( ( ::haxe::Timer)(::openfl::Lib_obj::_hx___timers->get(id)) );
...
HXLINE( 161)		HX_VAR( ::hx::Class,ref);
...
HXLINE( 201)		HX_VAR( ::hx::Class,ref);
...
HXLINE( 203)		HX_VARI( ::hx::Class,parentRef) = ::Type_obj::getSuperClass(ref);
...
HXLINE( 404)		HX_VARI( ::String,uri) = request->url;
HXLINE( 406)		if (::hx::IsEq( ::Type_obj::_hx_typeof(request->data),::ValueType_obj::TObject_dyn() )) {
HXLINE( 408)			HX_VARI( ::String,query) = HX_("",00,00,00,00);
HXLINE( 409)			HX_VARI( ::Array< ::String >,fields) = ::Reflect_obj::fields(request->data);
HXLINE( 411)			{
HXLINE( 411)				int _g = 0;
HXDLIN( 411)				while((_g < fields->length)){
HXLINE( 411)					HX_VARI( ::String,field) = fields->__get(_g);
HXDLIN( 411)					_g = (_g + 1);
...
HXLINE( 432)
HXLINE( 433)		HX_VARI( ::String,api) = ( (::String)(((posInfo->__Field(HX_("className",a3,92,3d,dc),::hx::paccDynamic) + HX_(".",2e,00,00,00)) + posInfo->__Field(HX_("methodName",cc,19,0f,12),::hx::paccDynamic))) );
...
void Lib_obj::sendToURL( ::openfl::net::URLRequest request){
            	...
            	HX_STACK_ARG(request,"request")
HXLINE( 499)
HXLINE( 500)		HX_VARI(  ::openfl::net::URLLoader,urlLoader) =  ::openfl::net::URLLoader_obj::__alloc( HX_CTX ,null());
...
HXLINE( 528)
HXLINE( 529)		HX_VARI( int,id) = ++::openfl::Lib_obj::_hx___lastTimerID;
HXLINE( 530)		HX_VARI(  ::haxe::Timer,timer) =  ::haxe::Timer_obj::__alloc( HX_CTX ,( (Float)(delay) ));
...
int Lib_obj::setTimeout( ::Dynamic closure,int delay,::cpp::VirtualArray args){
            	...
            	HX_STACK_ARG(args,"args")
HXLINE( 562)
HXLINE( 563)		HX_VARI( int,id) = ++::openfl::Lib_obj::_hx___lastTimerID;
HXLINE( 564)		{
            			HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,closure,::cpp::VirtualArray,args) HXARGC(0)
            			void _hx_run(){

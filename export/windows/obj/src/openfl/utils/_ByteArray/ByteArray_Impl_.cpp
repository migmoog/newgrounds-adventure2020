...
HXLINE( 169)
HXDLIN( 169)		HX_VARI(  ::openfl::utils::ByteArrayData,this1) =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,length);
...
HXLINE( 435)
HXLINE( 436)			HX_VARI(  ::openfl::utils::ByteArrayData,byteArray) = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(limeBytes);
 ...
 ::lime::app::Future ByteArray_Impl__obj::loadFromFile(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::haxe::io::Bytes limeBytes){
            			...
            			HX_STACK_ARG(limeBytes,"limeBytes")
HXLINE( 457)
HXLINE( 458)			HX_VARI(  ::openfl::utils::ByteArrayData,byteArray) = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(limeBytes);

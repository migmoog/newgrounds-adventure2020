...
HXLINE(  94)			{
HXLINE(  94)				HX_VARI(  ::Dynamic,symbol) = this->swf->symbols->iterator();
HXDLIN(  94)				while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  94)					HX_VARI(  ::openfl::_internal::symbols::SWFSymbol,symbol1) = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(  98)						HX_VARI(  ::openfl::_internal::symbols::BitmapSymbol,bitmapSymbol) = ( ( ::openfl::_internal::symbols::BitmapSymbol)(symbol1) );
HXLINE( 100)						if (::hx::IsNotNull( bitmapSymbol->alpha )) {
HXLINE( 102)							HX_VARI(  ::lime::graphics::Image,image) = this->super::getImage(id);
HXLINE( 103)							HX_VARI(  ::lime::graphics::Image,alpha) = this->super::getImage(bitmapSymbol->alpha);
...
HXLINE( 155)			HX_VAR(  ::openfl::_internal::symbols::BitmapSymbol,bitmapSymbol);
HXLINE( 157)			{
HXLINE( 157)				HX_VARI(  ::Dynamic,symbol) = _gthis->swf->symbols->iterator();
HXDLIN( 157)				while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 157)					HX_VARI(  ::openfl::_internal::symbols::SWFSymbol,symbol1) = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 145)		HX_VARI(  ::lime::app::Promise_lime_utils_AssetLibrary,promise) =  ::lime::app::Promise_lime_utils_AssetLibrary_obj::__alloc( HX_CTX );
HXLINE( 146)		this->preloading = true;
HXLINE( 148)		HX_VARI(  ::Dynamic,onComplete) =  ::Dynamic(new _hx_Closure_1(_gthis,promise));
...
HXLINE( 192)			{
HXLINE( 192)				HX_VARI(  ::Dynamic,id) = this->paths->keys();
HXDLIN( 192)				while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 192)					HX_VARI( ::String,id1) = ( (::String)(id->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 194)					this->preload->set(id1,true);
            				}
            			}
HXLINE( 197)			HX_VARI( ::String,path) = null();
...
HXLINE( 208)			HX_VARI(  ::openfl::net::URLLoader,loader) =  ::openfl::net::URLLoader_obj::__alloc( HX_CTX ,null());
...
HXLINE( 230)			HX_VARI(  ::Dynamic,symbol) = this->swf->symbols->iterator();
HXDLIN( 230)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 230)				HX_VARI(  ::openfl::_internal::symbols::SWFSymbol,symbol1) = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 234)					HX_VARI(  ::openfl::_internal::symbols::BitmapSymbol,bitmapSymbol) = ( ( ::openfl::_internal::symbols::BitmapSymbol)(symbol1) );
...
HXLINE( 238)						HX_VARI(  ::lime::app::Promise_lime_graphics_Image,promise) =  ::lime::app::Promise_lime_graphics_Image_obj::__alloc( HX_CTX );
...
HXLINE( 278)		HX_VAR(  ::openfl::_internal::symbols::BitmapSymbol,bitmap);
HXLINE( 280)		{
HXLINE( 280)			HX_VARI(  ::Dynamic,symbol) = this->swf->symbols->iterator();
HXDLIN( 280)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 280)				HX_VARI(  ::openfl::_internal::symbols::SWFSymbol,symbol1) = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 315)		{
HXLINE( 315)			HX_VARI(  ::Dynamic,id) = this->paths->keys();
HXDLIN( 315)			while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 315)				HX_VARI( ::String,id1) = ( (::String)(id->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );

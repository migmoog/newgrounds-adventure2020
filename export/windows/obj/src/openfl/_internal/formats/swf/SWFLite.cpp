...
HXLINE(  51)			HX_VARI(  ::openfl::_internal::symbols::SWFSymbol,symbol) = ( ( ::openfl::_internal::symbols::SWFSymbol)(this->symbolsByClassName->get(className)) );
...
HX_DEFINE_DYNAMIC_FUNC1(SWFLite_obj,createMovieClip,return )
 ...
 ::openfl::display::BitmapData SWFLite_obj::getBitmapData(::String className){
            	...
            	HX_STACK_ARG(className,"className")
HXLINE(  65)
HXLINE(  66)		HX_VARI(  ::openfl::_internal::symbols::SWFSymbol,symbol) = ( ( ::openfl::_internal::symbols::SWFSymbol)(this->symbolsByClassName->get(className)) );
...
HXLINE(  72)				HX_VARI(  ::openfl::_internal::symbols::BitmapSymbol,bitmap) = ( ( ::openfl::_internal::symbols::BitmapSymbol)(symbol) );
...
::String SWFLite_obj::serialize(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 128)
HXLINE( 129)		HX_VARI(  ::haxe::Serializer,serializer) =  ::haxe::Serializer_obj::__alloc( HX_CTX );
...
HXLINE( 158)		{
HXLINE( 158)			HX_VARI(  ::Dynamic,symbol) = this->symbols->iterator();
HXDLIN( 158)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 158)				HX_VARI(  ::openfl::_internal::symbols::SWFSymbol,symbol1) = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(  87)
HXLINE(  88)		HX_VARI( ::hx::Class,value) = ::Type_obj::resolveClass(name);
...
::hx::Class SWFLite_obj::resolveEnum(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE( 106)
HXLINE( 107)		HX_VARI( ::hx::Class,value) = ::Type_obj::resolveEnum(name);
...
HXLINE( 141)		HX_VARI(  ::haxe::Unserializer,unserializer) =  ::haxe::Unserializer_obj::__alloc( HX_CTX ,data);
...
HXLINE( 144)		HX_VARI(  ::openfl::_internal::formats::swf::SWFLite,swfLite) = ( ( ::openfl::_internal::formats::swf::SWFLite)(unserializer->unserialize()) );

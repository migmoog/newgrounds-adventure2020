...
HXLINE(  40)		HX_VARI( ::Array< ::String >,segments) = value.split(HX_("<",3c,00,00,00));
...
HXLINE(  54)			HX_VARI(  ::openfl::_internal::text::TextFormatRange,range) = textFormatRanges->get(0).StaticCast<  ::openfl::_internal::text::TextFormatRange >();
...
HXLINE(  66)			HX_VAR( ::String,segment);
HXLINE(  68)			{
HXLINE(  68)				int _g = 0;
HXDLIN(  68)				int _g1 = segments->length;
HXDLIN(  68)				while((_g < _g1)){
HXLINE(  68)					_g = (_g + 1);
HXDLIN(  68)					HX_VARI( int,i) = (_g - 1);
...
HXLINE(  76)			HX_VARI( ::Array< ::Dynamic>,formatStack) = ::Array_obj< ::Dynamic>::__new(1)->init(0,textFormat->clone());
HXLINE(  77)			HX_VARI( ::Array< ::Dynamic>,tagStack) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  78)			HX_VAR( ::String,sub);
HXLINE(  79)			HX_VARI( bool,noLineBreak) = false;
HXLINE(  81)			{
HXLINE(  81)				int _g2 = 0;
HXDLIN(  81)				while((_g2 < segments->length)){
HXLINE(  81)					HX_VARI( ::String,segment) = segments->__get(_g2);
HXDLIN(  81)					_g2 = (_g2 + 1);
HXLINE(  83)					if ((segment == HX_("",00,00,00,00))) {
HXLINE(  83)						continue;
            					}
HXLINE(  85)					HX_VARI( bool,isClosingTag) = (segment.substr(0,1) == HX_("/",2f,00,00,00));
HXLINE(  86)					HX_VARI( int,tagEndIndex) = segment.indexOf(HX_(">",3e,00,00,00),null());
HXLINE(  87)					HX_VARI( int,start) = (tagEndIndex + 1);
HXLINE(  88)					HX_VARI( int,spaceIndex) = segment.indexOf(HX_(" ",20,00,00,00),null());
...
HXDLIN(  89)					HX_VARI( ::String,tagName3) = segment.substring(tagName,tagName1);
HXLINE(  91)					HX_VAR(  ::openfl::text::TextFormat,format);
...
HXLINE( 159)									HX_VARI( ::String,sizeAttr) = ::openfl::_internal::formats::html::HTMLParser_obj::_hx___getAttributeMatch(::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexSize);
HXLINE( 160)									HX_VARI(  ::Dynamic,firstChar) = sizeAttr.charCodeAt(0);
...
HXLINE( 164)										HX_VAR(  ::openfl::text::TextFormat,parentFormat);
...
HXLINE( 142)									HX_VARI( ::String,align) = ::openfl::_internal::formats::html::HTMLParser_obj::_hx___getAttributeMatch(::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexAlign).toLowerCase();
...
HXLINE( 210)									HX_VARI( ::Array< ::String >,values) = ::openfl::_internal::formats::html::HTMLParser_obj::_hx___getAttributeMatch(::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexTabStops).split(HX_(" ",20,00,00,00));
HXLINE( 211)									HX_VARI( ::Array< ::Dynamic>,tabStops) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 213)									{
HXLINE( 213)										int _g = 0;
HXDLIN( 213)										while((_g < values->length)){
HXLINE( 213)											HX_VARI( ::String,stop) = values->__get(_g);
HXDLIN( 213)											_g = (_g + 1);

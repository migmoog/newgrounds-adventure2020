...
HXLINE( 603)				HX_VARI(  ::openfl::_internal::formats::agal::_AGALConverter::RegisterMapEntry,entry) = _g1->__get(_g).StaticCast<  ::openfl::_internal::formats::agal::_AGALConverter::RegisterMapEntry >();
HXDLIN( 603)				_g = (_g + 1);
...
HXLINE( 616)		HX_VARI(  ::openfl::_internal::formats::agal::_AGALConverter::RegisterMapEntry,entry) =  ::openfl::_internal::formats::agal::_AGALConverter::RegisterMapEntry_obj::__alloc( HX_CTX );
...
HXLINE( 658)				HX_VARI(  ::openfl::_internal::formats::agal::_AGALConverter::RegisterMapEntry,entry) = _g1->__get(_g).StaticCast<  ::openfl::_internal::formats::agal::_AGALConverter::RegisterMapEntry >();
HXDLIN( 658)				_g = (_g + 1);
...
HXLINE( 676)		HX_VAR(  ::openfl::_internal::formats::agal::_AGALConverter::RegisterMapEntry,entry);
HXLINE( 678)		this->mEntries->sort( ::Dynamic(new _hx_Closure_1()));
HXLINE( 683)		HX_VARI(  ::StringBuf,sb) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 685)		{
HXLINE( 685)			int _g = 0;

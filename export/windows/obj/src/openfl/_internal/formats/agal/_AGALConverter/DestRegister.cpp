...
::String DestRegister_obj::getWriteMask(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 540)
HXLINE( 541)		HX_VARI( ::String,str) = HX_(".",2e,00,00,00);
...
HXLINE( 550)
HXLINE( 551)		HX_VARI(  ::openfl::_internal::formats::agal::_AGALConverter::DestRegister,dr) =  ::openfl::_internal::formats::agal::_AGALConverter::DestRegister_obj::__alloc( HX_CTX );

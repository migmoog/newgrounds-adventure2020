...
HXLINE(  85)		HX_VAR(  ::openfl::_internal::formats::agal::_AGALConverter::ProgramType,programType);
...
HXLINE(  87)		HX_VARI(  ::openfl::_internal::formats::agal::RegisterMap,map) =  ::openfl::_internal::formats::agal::RegisterMap_obj::__alloc( HX_CTX );
...
HXLINE(  95)			HX_VARI(  cpp::Int64Struct,source1) = ::openfl::_internal::formats::agal::AGALConverter_obj::readUInt64(agal);
HXLINE(  96)			HX_VARI(  cpp::Int64Struct,source2) = ::openfl::_internal::formats::agal::AGALConverter_obj::readUInt64(agal);
HXLINE(  99)			HX_VARI(  ::openfl::_internal::formats::agal::_AGALConverter::DestRegister,dr) = ::openfl::_internal::formats::agal::_AGALConverter::DestRegister_obj::parse(dest,programType);
HXLINE( 100)			HX_VARI(  ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister,sr1) = ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister_obj::parse(source1,programType,dr->mask);
HXLINE( 101)			HX_VARI(  ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister,sr2) = ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister_obj::parse(source2,programType,dr->mask);
HXLINE( 104)			{
...
HXLINE( 268)					map->addSR(sr1,::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn(),null());
            				...
            				break;
            				case (int)23: {
HXLINE( 276)					HX_VARI(  ::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage,existingUsage) = map->getRegisterUsage(sr2);
...
HXLINE( 296)						map->addSR(sr2,::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn(),2);
            				...
            				break;
            				case (int)24: {
HXLINE( 307)					HX_VARI(  ::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage,existingUsage) = map->getRegisterUsage(sr2);
...
HXLINE( 342)					HX_VARI(  ::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage,existingUsage) = map->getRegisterUsage(sr2);
...
HXLINE( 374)					map->addSR(sr1,::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn(),null());
            				...
            				break;
            				case (int)40: {
HXLINE( 379)					HX_VARI(  ::openfl::_internal::formats::agal::_AGALConverter::SamplerRegister,sampler) = ::openfl::_internal::formats::agal::_AGALConverter::SamplerRegister_obj::parse(source2,programType);

...
HXDLIN( 877)		HX_VARI( ::String,str1) = (str + this->n);
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::renderer::SamplerState SamplerRegister_obj::toSamplerState(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 882)
HXLINE( 883)		HX_VAR(  ::Dynamic,wrap);
HXLINE( 884)		HX_VAR(  ::Dynamic,filter);
HXLINE( 885)		HX_VAR(  ::Dynamic,mipfilter);
...
HXLINE( 929)		HX_VARI( bool,ignoreSampler) = ((this->s & 4) == 4);
HXLINE( 930)		HX_VARI( bool,centroid) = ((this->s & 1) == 1);
HXLINE( 931)		HX_VARI( bool,textureAlpha) = (this->t == 2);
HXLINE( 934)		HX_VARI( Float,lodBias) = (( (Float)(((this->b << 24) >> 24)) ) / ((Float)8.0));
...
HXLINE( 860)
HXLINE( 861)		HX_VARI(  ::openfl::_internal::formats::agal::_AGALConverter::SamplerRegister,sr) =  ::openfl::_internal::formats::agal::_AGALConverter::SamplerRegister_obj::__alloc( HX_CTX );

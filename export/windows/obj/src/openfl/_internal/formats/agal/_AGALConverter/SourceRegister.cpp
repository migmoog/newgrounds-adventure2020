...
HXLINE( 981)		HX_VAR( bool,fullxyzw);
...
HXLINE( 982)		HX_VARI( ::String,swizzle) = HX_("",00,00,00,00);
...
HXLINE(1006)		HX_VARI( ::String,str) = ::openfl::_internal::formats::agal::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXLINE(1008)		if ((this->d == 0)) {
HXLINE(1011)			str = (str + (this->n + offset));
            		}
            		else {
HXLINE(1016)			str = (str + this->o);
HXLINE(1017)			HX_VARI( ::String,indexComponent) = HX_("",00,00,00,00);
...
HXDLIN(1029)			HX_VARI( ::String,indexRegister1) = (((indexRegister + this->n) + HX_(".",2e,00,00,00)) + indexComponent);
...
HXLINE( 960)
HXLINE( 961)		HX_VARI(  ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister,sr) =  ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister_obj::__alloc( HX_CTX );

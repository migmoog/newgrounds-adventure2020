...
HXLINE(  36)
HXLINE(  37)		HX_VARI(  ::openfl::display::Shape,shape) =  ::openfl::display::Shape_obj::__alloc( HX_CTX );
HXLINE(  38)		HX_VARI(  ::openfl::display::Graphics,graphics) = shape->get_graphics();
...
HXLINE(  46)				HX_VARI(  ::openfl::_internal::formats::swf::ShapeCommand,command) = _g1->__get(_g).StaticCast<  ::openfl::_internal::formats::swf::ShapeCommand >();
HXDLIN(  46)				_g = (_g + 1);
HXLINE(  48)				switch((int)(command->_hx_getIndex())){
            					case (int)0: {
HXLINE(  53)						HX_VARI( bool,smooth) = command->_hx_getBool(3);
HXDLIN(  53)						HX_VARI( bool,repeat) = command->_hx_getBool(2);
HXDLIN(  53)						HX_VARI(  ::openfl::geom::Matrix,matrix) = command->_hx_getObject(1).StaticCast<  ::openfl::geom::Matrix >();
HXDLIN(  53)						HX_VARI( int,bitmapID) = command->_hx_getInt(0);
HXDLIN(  53)						{
HXLINE(  55)							HX_VARI(  ::openfl::_internal::symbols::BitmapSymbol,bitmapSymbol) = ( ( ::openfl::_internal::symbols::BitmapSymbol)(swf->symbols->get(bitmapID)) );
HXLINE(  56)							HX_VARI(  ::lime::graphics::Image,bitmap) = swf->library->getImage(bitmapSymbol->path);
...
HXLINE(  60)								graphics->beginBitmapFill(::openfl::display::BitmapData_obj::fromImage(bitmap,null()),matrix,repeat,smooth);
            					...
            					break;
            					case (int)1: {
HXLINE(  50)						HX_VARI( Float,alpha) = command->_hx_getFloat(1);
HXDLIN(  50)						HX_VARI( int,color) = command->_hx_getInt(0);
HXLINE(  51)						graphics->beginFill(color,alpha);
            					}
            					break;
            					case (int)2: {
HXLINE(  64)						HX_VARI( Float,focalPointRatio) = command->_hx_getFloat(7);
HXDLIN(  64)						HX_VARI(  ::Dynamic,interpolationMethod) = command->_hx_getObject(6);
HXDLIN(  64)						HX_VARI(  ::Dynamic,spreadMethod) = command->_hx_getObject(5);
HXDLIN(  64)						HX_VARI(  ::openfl::geom::Matrix,matrix) = command->_hx_getObject(4).StaticCast<  ::openfl::geom::Matrix >();
HXDLIN(  64)						HX_VARI( ::Array< int >,ratios) = command->_hx_getObject(3).StaticCast< ::Array< int > >();
HXDLIN(  64)						HX_VARI( ::Array< Float >,alphas) = command->_hx_getObject(2).StaticCast< ::Array< Float > >();
HXDLIN(  64)						HX_VARI( ::Array< int >,colors) = command->_hx_getObject(1).StaticCast< ::Array< int > >();
HXDLIN(  64)						HX_VARI(  ::Dynamic,fillType) = command->_hx_getObject(0);
HXLINE(  65)						graphics->beginGradientFill(fillType,colors,alphas,ratios,matrix,spreadMethod,interpolationMethod,focalPointRatio);
            					...
            					break;
            					case (int)3: {
HXLINE(  68)						HX_VARI( Float,anchorY) = command->_hx_getFloat(3);
HXDLIN(  68)						HX_VARI( Float,anchorX) = command->_hx_getFloat(2);
HXDLIN(  68)						HX_VARI( Float,controlY) = command->_hx_getFloat(1);
HXDLIN(  68)						HX_VARI( Float,controlX) = command->_hx_getFloat(0);
...
HXLINE(  72)						graphics->endFill();
            					...
            					break;
            					case (int)5: {
HXLINE(  74)						HX_VARI(  ::Dynamic,miterLimit) = command->_hx_getObject(7);
HXDLIN(  74)						HX_VARI(  ::Dynamic,joints) = command->_hx_getObject(6);
HXDLIN(  74)						HX_VARI(  ::Dynamic,caps) = command->_hx_getObject(5);
HXDLIN(  74)						HX_VARI(  ::Dynamic,scaleMode) = command->_hx_getObject(4);
HXDLIN(  74)						HX_VARI(  ::Dynamic,pixelHinting) = command->_hx_getObject(3);
HXDLIN(  74)						HX_VARI(  ::Dynamic,alpha) = command->_hx_getObject(2);
HXDLIN(  74)						HX_VARI(  ::Dynamic,color) = command->_hx_getObject(1);
HXDLIN(  74)						HX_VARI(  ::Dynamic,thickness) = command->_hx_getObject(0);
...
HXLINE(  82)							graphics->lineStyle(null(),null(),null(),null(),null(),null(),null(),null());
            					...
            					break;
            					case (int)6: {
HXLINE(  85)						HX_VARI( Float,y) = command->_hx_getFloat(1);
HXDLIN(  85)						HX_VARI( Float,x) = command->_hx_getFloat(0);
HXLINE(  86)						graphics->lineTo(x,y);
            					}
            					break;
            					case (int)7: {
HXLINE(  88)						HX_VARI( Float,y) = command->_hx_getFloat(1);
HXDLIN(  88)						HX_VARI( Float,x) = command->_hx_getFloat(0);

...
HXLINE(  30)
HXLINE(  31)		HX_VARI(  ::openfl::text::StaticText,staticText) =  ::openfl::text::StaticText_obj::__alloc( HX_CTX );
HXLINE(  32)		HX_VARI(  ::openfl::display::Graphics,graphics) = staticText->_hx___graphics;
...
HXLINE(  41)		HX_VARI( ::String,text) = HX_("",00,00,00,00);
HXLINE(  43)		if (::hx::IsNotNull( this->records )) {
HXLINE(  45)			HX_VARI(  ::openfl::_internal::symbols::FontSymbol,font) = null();
HXLINE(  46)			HX_VARI( int,color) = 16777215;
HXLINE(  47)			HX_VARI( Float,offsetX) = this->matrix->tx;
HXLINE(  48)			HX_VARI( Float,offsetY) = this->matrix->ty;
HXLINE(  50)			HX_VAR( Float,scale);
HXDLIN(  50)			HX_VAR( int,index);
HXLINE(  52)			{
HXLINE(  52)				int _g = 0;
HXDLIN(  52)				::Array< ::Dynamic> _g1 = this->records;
HXDLIN(  52)				while((_g < _g1->length)){
HXLINE(  52)					HX_VARI(  ::openfl::_internal::symbols::StaticTextRecord,record) = _g1->__get(_g).StaticCast<  ::openfl::_internal::symbols::StaticTextRecord >();
HXDLIN(  52)					_g = (_g + 1);
...
HXLINE(  68)										HX_VARI(  ::openfl::_internal::formats::swf::ShapeCommand,command) = _g2->__get(_g1).StaticCast<  ::openfl::_internal::formats::swf::ShapeCommand >();
HXDLIN(  68)										_g1 = (_g1 + 1);
HXLINE(  70)										switch((int)(command->_hx_getIndex())){
            											case (int)1: {
HXLINE(  72)												int _g = command->_hx_getInt(0);
HXDLIN(  72)												{
HXLINE(  72)													HX_VARI( Float,alpha) = command->_hx_getFloat(1);
HXLINE(  73)													graphics->beginFill((color & 16777215),(( (Float)(((color >> 24) & 255)) ) / ( (Float)(255) )));
            												}
            											}
            											break;
            											case (int)3: {
HXLINE(  75)												HX_VARI( Float,anchorY) = command->_hx_getFloat(3);
HXDLIN(  75)												HX_VARI( Float,anchorX) = command->_hx_getFloat(2);
HXDLIN(  75)												HX_VARI( Float,controlY) = command->_hx_getFloat(1);
HXDLIN(  75)												HX_VARI( Float,controlX) = command->_hx_getFloat(0);
...
HXLINE(  80)												graphics->endFill();
            											...
            											break;
            											case (int)5: {
HXLINE(  82)												HX_VARI(  ::Dynamic,miterLimit) = command->_hx_getObject(7);
HXDLIN(  82)												HX_VARI(  ::Dynamic,joints) = command->_hx_getObject(6);
HXDLIN(  82)												HX_VARI(  ::Dynamic,caps) = command->_hx_getObject(5);
HXDLIN(  82)												HX_VARI(  ::Dynamic,scaleMode) = command->_hx_getObject(4);
HXDLIN(  82)												HX_VARI(  ::Dynamic,pixelHinting) = command->_hx_getObject(3);
HXDLIN(  82)												HX_VARI(  ::Dynamic,alpha) = command->_hx_getObject(2);
HXDLIN(  82)												HX_VARI(  ::Dynamic,color) = command->_hx_getObject(1);
HXDLIN(  82)												HX_VARI(  ::Dynamic,thickness) = command->_hx_getObject(0);
...
HXLINE(  90)													graphics->lineStyle(null(),null(),null(),null(),null(),null(),null(),null());
            											...
            											break;
            											case (int)6: {
HXLINE(  93)												HX_VARI( Float,y) = command->_hx_getFloat(1);
HXDLIN(  93)												HX_VARI( Float,x) = command->_hx_getFloat(0);
HXLINE(  94)												graphics->lineTo(((x * scale) + offsetX),((y * scale) + offsetY));
            											}
            											break;
            											case (int)7: {
HXLINE(  96)												HX_VARI( Float,y) = command->_hx_getFloat(1);
HXDLIN(  96)												HX_VARI( Float,x) = command->_hx_getFloat(0);

...
HXLINE( 147)			HX_VARI( ::Array< ::Dynamic>,_info) = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphInfo(this->_hx___hbBuffer);
HXLINE( 148)			HX_VARI( ::Array< ::Dynamic>,_positions) = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphPositions(this->_hx___hbBuffer);
...
HXLINE( 152)				HX_VAR(  ::lime::text::harfbuzz::HBGlyphInfo,info);
HXDLIN( 152)				HX_VAR(  ::lime::text::harfbuzz::HBGlyphPosition,position);
HXLINE( 153)				HX_VARI( int,lastCluster) = -1;
HXLINE( 155)				HX_VARI( int,length) = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(_info->length) ),( (Float)(_positions->length) )));
HXLINE( 157)				{
HXLINE( 157)					int _g = 0;
...
HXDLIN( 162)								HX_VARI( int,j) = (_g1 - 1);
...
::Array< int > TextLayout_obj::get_glyphs(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 217)
HXLINE( 218)		HX_VARI( ::Array< int >,glyphs) = ::Array_obj< int >::__new(0);
HXLINE( 220)		{
HXLINE( 220)			int _g = 0;
HXDLIN( 220)			::Array< ::Dynamic> _g1 = this->get_positions();
HXDLIN( 220)			while((_g < _g1->length)){
HXLINE( 220)				HX_VARI(  ::openfl::_internal::text::GlyphPosition,position) = _g1->__get(_g).StaticCast<  ::openfl::_internal::text::GlyphPosition >();
HXDLIN( 220)				_g = (_g + 1);

...
HXLINE(  27)		HX_VARI( Float,alpha) = renderer->_hx___getAlpha(shape->_hx___worldAlpha);
...
HXLINE(  36)			HX_VARI( int,width) = graphics->_hx___width;
HXLINE(  37)			HX_VARI( int,height) = graphics->_hx___height;
HXLINE(  38)			HX_VARI(  ::lime::graphics::cairo::Cairo,cairo) = renderer->cairo;
...
HXLINE(  42)				HX_VARI(  ::openfl::geom::Matrix,transform) = graphics->_hx___worldTransform;
...
HXLINE(  50)					HX_VARI(  ::openfl::geom::Rectangle,bounds) = graphics->_hx___bounds;
HXLINE(  52)					HX_VARI(  ::openfl::geom::Matrix,renderTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE(  54)					HX_VARI( Float,scaleX) = graphics->_hx___renderTransform->a;
HXLINE(  55)					HX_VARI( Float,scaleY) = graphics->_hx___renderTransform->d;
HXLINE(  56)					HX_VARI( Float,renderScaleX) = transform->a;
HXLINE(  57)					HX_VARI( Float,renderScaleY) = transform->d;
HXLINE(  59)					HX_VARI( int,left) = ::Math_obj::round((scale9Grid->x * scaleX));
HXLINE(  60)					HX_VARI( int,top) = ::Math_obj::round((scale9Grid->y * scaleY));
HXLINE(  61)					Float right = bounds->get_right();
HXDLIN(  61)					HX_VARI( int,right1) = ::Math_obj::round(((right - scale9Grid->get_right()) * scaleX));
HXLINE(  62)					Float bottom = bounds->get_bottom();
HXDLIN(  62)					HX_VARI( int,bottom1) = ::Math_obj::round(((bottom - scale9Grid->get_bottom()) * scaleY));
HXLINE(  63)					HX_VARI( int,centerWidth) = ::Math_obj::round((scale9Grid->width * scaleX));
HXLINE(  64)					HX_VARI( int,centerHeight) = ::Math_obj::round((scale9Grid->height * scaleY));
HXLINE(  66)					HX_VARI( int,renderLeft) = ::Math_obj::round((scale9Grid->x * renderScaleX));
HXLINE(  67)					HX_VARI( int,renderTop) = ::Math_obj::round((scale9Grid->y * renderScaleY));
HXLINE(  68)					Float renderRight = bounds->get_right();
HXDLIN(  68)					HX_VARI( int,renderRight1) = ::Math_obj::round(((renderRight - scale9Grid->get_right()) * renderScaleX));
HXLINE(  69)					Float renderBottom = bounds->get_bottom();
HXDLIN(  69)					HX_VARI( int,renderBottom1) = ::Math_obj::round(((renderBottom - scale9Grid->get_bottom()) * renderScaleY));
HXLINE(  70)					HX_VARI( int,renderCenterWidth) = ((::Math_obj::round((( (Float)(width) ) * renderScaleX)) - renderLeft) - renderRight1);
HXLINE(  71)					HX_VARI( int,renderCenterHeight) = ((::Math_obj::round((( (Float)(height) ) * renderScaleY)) - renderTop) - renderBottom1);
HXLINE(  73)					HX_VARI(  ::Dynamic,pattern) = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(graphics->_hx___cairo->get_target());
HXLINE(  75)					::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,3);
HXLINE(  78)					HX_VARI(  ::Dynamic,drawImage) =  ::Dynamic(new _hx_Closure_0(alpha,renderer,cairo,pattern,transform,renderTransform));
...
HXLINE( 127)							HX_VARI( int,renderWidth) = ((renderLeft + renderCenterWidth) + renderRight1);
...
HXLINE( 135)								HX_VARI( int,renderHeight) = ((renderTop + renderCenterHeight) + renderBottom1);

...
bool SamplerState_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::SamplerState SamplerState_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  36)
HXLINE(  37)		HX_VARI(  ::openfl::_internal::renderer::SamplerState,copy) =  ::openfl::_internal::renderer::SamplerState_obj::__alloc( HX_CTX ,this->wrap,this->filter,this->mipfilter,this->lodBias,this->ignoreSampler,this->centroid,this->textureAlpha);

...
HXLINE(  65)			HX_VARI(  ::openfl::display3D::Context3D,context) = renderer->_hx___context3D;
HXLINE(  67)			HX_VARI(  ::openfl::_internal::renderer::context3D::Context3DMaskShader,shader) = renderer->_hx___maskShader;
...
HXLINE(  73)			HX_VARI(  ::openfl::display3D::VertexBuffer3D,vertexBuffer) = bitmap->_hx___bitmapData->getVertexBuffer(context,null(),null());
...
HXLINE(  76)			HX_VARI(  ::openfl::display3D::IndexBuffer3D,indexBuffer) = bitmap->_hx___bitmapData->getIndexBuffer(context,null());

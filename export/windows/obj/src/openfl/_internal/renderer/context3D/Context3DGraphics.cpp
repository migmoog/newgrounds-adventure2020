...
HXLINE(  40)
HXLINE(  41)		HX_VARI( int,quadBufferPosition) = 0;
HXLINE(  42)		HX_VARI( int,triangleIndexBufferPosition) = 0;
HXLINE(  43)		HX_VARI( int,vertexBufferPosition) = 0;
HXLINE(  44)		HX_VARI( int,vertexBufferPositionUVT) = 0;
HXLINE(  46)		HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,data) =  ::openfl::_internal::renderer::DrawCommandReader_obj::__alloc( HX_CTX ,graphics->_hx___commands);
HXLINE(  48)		HX_VARI(  ::openfl::display3D::Context3D,context) = renderer->_hx___context3D;
HXLINE(  50)		HX_VARI(  ::openfl::geom::Rectangle,tileRect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(  51)		HX_VARI(  ::openfl::geom::Matrix,tileTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE(  53)		HX_VARI(  ::openfl::display::BitmapData,bitmap) = null();
HXLINE(  55)		{
HXLINE(  55)			int _g = 0;
HXDLIN(  55)			::Array< ::Dynamic> _g1 = graphics->_hx___commands->types;
HXDLIN(  55)			while((_g < _g1->length)){
HXLINE(  55)				HX_VARI(  ::openfl::_internal::renderer::DrawCommandType,type) = _g1->__get(_g).StaticCast<  ::openfl::_internal::renderer::DrawCommandType >();
HXDLIN(  55)				_g = (_g + 1);
...
HXDLIN(  60)						HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,c) = this1;
...
HXDLIN(  68)						HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,c) = this1;
HXLINE(  69)						HX_VARI(  ::openfl::_internal::renderer::ShaderBuffer,shaderBuffer) = ( ( ::openfl::_internal::renderer::ShaderBuffer)(c->buffer->o->__get(c->oPos)) );
...
HXDLIN(  90)							HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,c) = this1;
HXLINE(  91)							HX_VARI(  ::openfl::_Vector::FloatVector,rects) = ( ( ::openfl::_Vector::FloatVector)(c->buffer->o->__get(c->oPos)) );
HXLINE(  92)							HX_VARI(  ::openfl::_Vector::IntVector,indices) = ( ( ::openfl::_Vector::IntVector)(c->buffer->o->__get((c->oPos + 1))) );
HXLINE(  93)							HX_VARI(  ::openfl::_Vector::FloatVector,transforms) = ( ( ::openfl::_Vector::FloatVector)(c->buffer->o->__get((c->oPos + 2))) );
HXLINE(  96)							HX_VAR( ::Array< Float >,rects1);
...
HXLINE(  97)							HX_VAR( ::Array< int >,indices1);
...
HXLINE(  98)							HX_VAR( ::Array< Float >,transforms1);
...
HXLINE( 101)							HX_VARI( bool,hasIndices) = ::hx::IsNotNull( indices1 );
HXLINE( 102)							HX_VARI( bool,transformABCD) = false;
HXDLIN( 102)							HX_VARI( bool,transformXY) = false;
HXLINE( 104)							HX_VAR( int,length);
...
HXLINE( 124)							HX_VARI( int,dataPerVertex) = 4;
HXLINE( 125)							HX_VARI( int,stride) = (dataPerVertex * 4);
...
HXLINE( 136)							HX_VAR( int,vertexOffset);
HXDLIN( 136)							HX_VARI( Float,alpha) = ((Float)1.0);
HXDLIN( 136)							HX_VAR(  ::Dynamic,tileData);
HXDLIN( 136)							HX_VAR(  ::Dynamic,id);
HXLINE( 137)							HX_VAR( Float,tileWidth);
HXDLIN( 137)							HX_VAR( Float,tileHeight);
HXLINE( 141)							HX_VAR( Float,uvX);
HXDLIN( 141)							HX_VAR( Float,uvY);
HXDLIN( 141)							HX_VAR( Float,uvWidth);
HXDLIN( 141)							HX_VAR( Float,uvHeight);
HXLINE( 142)							HX_VAR( Float,x);
HXDLIN( 142)							HX_VAR( Float,y);
HXDLIN( 142)							HX_VAR( Float,x2);
HXDLIN( 142)							HX_VAR( Float,y2);
HXDLIN( 142)							HX_VAR( Float,x3);
HXDLIN( 142)							HX_VAR( Float,y3);
HXDLIN( 142)							HX_VAR( Float,x4);
HXDLIN( 142)							HX_VAR( Float,y4);
HXLINE( 143)							HX_VAR( int,ri);
HXDLIN( 143)							HX_VAR( int,ti);
HXLINE( 145)							HX_VARI(  ::lime::utils::ArrayBufferView,vertexBufferData) = graphics->_hx___quadBuffer->vertexBufferData;
HXLINE( 137)							HX_VARI( int,bitmapWidth) = bitmap->width;
HXDLIN( 137)							HX_VARI( int,bitmapHeight) = bitmap->height;
HXLINE( 163)							HX_VARI(  ::openfl::geom::Rectangle,sourceRect) = bitmap->rect;
HXLINE( 165)							{
HXLINE( 165)								int _g = 0;
...
HXDLIN( 243)						HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,c) = this1;
HXLINE( 244)						HX_VARI(  ::openfl::_Vector::FloatVector,vertices) = ( ( ::openfl::_Vector::FloatVector)(c->buffer->o->__get(c->oPos)) );
HXLINE( 245)						HX_VARI(  ::openfl::_Vector::IntVector,indices) = ( ( ::openfl::_Vector::IntVector)(c->buffer->o->__get((c->oPos + 1))) );
HXLINE( 246)						HX_VARI(  ::openfl::_Vector::FloatVector,uvtData) = ( ( ::openfl::_Vector::FloatVector)(c->buffer->o->__get((c->oPos + 2))) );
HXLINE( 247)						HX_VARI(  ::Dynamic,culling) = c->buffer->o->__get((c->oPos + 3));
HXLINE( 249)						HX_VARI( bool,hasIndices) = ::hx::IsNotNull( indices );
HXLINE( 250)						HX_VARI( int,numVertices) = ::Math_obj::floor((( (Float)(vertices->get_length()) ) / ( (Float)(2) )));
HXLINE( 251)						HX_VAR( int,length);
...
HXLINE( 253)						HX_VARI( bool,hasUVData) = ::hx::IsNotNull( uvtData );
HXLINE( 254)						HX_VAR( bool,hasUVTData);
...
HXLINE( 255)						HX_VAR( int,vertLength);
...
HXLINE( 256)						HX_VAR( int,uvStride);
...
HXLINE( 258)						HX_VARI( int,dataPerVertex) = (vertLength + 2);
HXLINE( 259)						HX_VAR( int,vertexOffset);
...
HXLINE( 267)						HX_VAR(  ::lime::utils::ArrayBufferView,vertexBufferData);
...
HXLINE( 268)						HX_VAR( int,offset);
HXDLIN( 268)						HX_VAR( int,vertOffset);
HXDLIN( 268)						HX_VAR( int,uvOffset);
HXDLIN( 268)						HX_VAR( Float,t);
HXLINE( 270)						{
HXLINE( 270)							int _g = 0;
HXDLIN( 270)							int _g1 = length;
HXDLIN( 270)							while((_g < _g1)){
HXLINE( 270)								_g = (_g + 1);
HXDLIN( 270)								HX_VARI( int,i) = (_g - 1);
...
HXLINE( 324)			HX_VARI(  ::openfl::display3D::IndexBuffer3D,buffer) = graphics->_hx___triangleIndexBuffer;
...
HXLINE( 338)			HX_VARI(  ::openfl::display3D::VertexBuffer3D,buffer) = graphics->_hx___vertexBuffer;
...
HXLINE( 352)			HX_VARI(  ::openfl::display3D::VertexBuffer3D,buffer) = graphics->_hx___vertexBufferUVT;
...
HXLINE( 381)		HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,data) =  ::openfl::_internal::renderer::DrawCommandReader_obj::__alloc( HX_CTX ,graphics->_hx___commands);
HXLINE( 382)		HX_VARI( bool,hasColorFill) = false;
HXDLIN( 382)		HX_VARI( bool,hasBitmapFill) = false;
HXDLIN( 382)		HX_VARI( bool,hasShaderFill) = false;
HXLINE( 384)		{
HXLINE( 384)			int _g = 0;
HXDLIN( 384)			::Array< ::Dynamic> _g1 = graphics->_hx___commands->types;
HXDLIN( 384)			while((_g < _g1->length)){
HXLINE( 384)				HX_VARI(  ::openfl::_internal::renderer::DrawCommandType,type) = _g1->__get(_g).StaticCast<  ::openfl::_internal::renderer::DrawCommandType >();
HXDLIN( 384)				_g = (_g + 1);
...
HXLINE( 481)			HX_VARI(  ::openfl::geom::Matrix,cacheTransform) = renderer->_hx___softwareRenderer->_hx___worldTransform;
...
HXLINE( 497)			HX_VARI(  ::openfl::geom::Rectangle,bounds) = graphics->_hx___bounds;
HXLINE( 499)			HX_VARI( int,width) = graphics->_hx___width;
HXLINE( 500)			HX_VARI( int,height) = graphics->_hx___height;
...
HXLINE( 510)				HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,data) =  ::openfl::_internal::renderer::DrawCommandReader_obj::__alloc( HX_CTX ,graphics->_hx___commands);
HXLINE( 512)				HX_VARI(  ::openfl::display3D::Context3D,context) = renderer->_hx___context3D;
HXLINE( 513)				HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
HXLINE( 515)				HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 517)				HX_VARI(  ::openfl::_internal::renderer::ShaderBuffer,shaderBuffer) = null();
HXLINE( 518)				HX_VARI(  ::openfl::display::BitmapData,bitmap) = null();
HXLINE( 519)				HX_VARI( bool,repeat) = false;
HXLINE( 520)				HX_VARI( bool,smooth) = false;
HXLINE( 521)				HX_VARI(  ::Dynamic,fill) = null();
HXLINE( 523)				HX_VARI( Float,positionX) = ((Float)0.0);
HXLINE( 524)				HX_VARI( Float,positionY) = ((Float)0.0);
HXLINE( 526)				HX_VARI( int,quadBufferPosition) = 0;
HXLINE( 527)				HX_VARI( int,shaderBufferOffset) = 0;
HXLINE( 528)				HX_VARI( int,triangleIndexBufferPosition) = 0;
HXLINE( 529)				HX_VARI( int,vertexBufferPosition) = 0;
HXLINE( 530)				HX_VARI( int,vertexBufferPositionUVT) = 0;
HXLINE( 532)				{
HXLINE( 532)					int _g = 0;
HXDLIN( 532)					::Array< ::Dynamic> _g1 = graphics->_hx___commands->types;
HXDLIN( 532)					while((_g < _g1->length)){
HXLINE( 532)						HX_VARI(  ::openfl::_internal::renderer::DrawCommandType,type) = _g1->__get(_g).StaticCast<  ::openfl::_internal::renderer::DrawCommandType >();
HXDLIN( 532)						_g = (_g + 1);
...
HXDLIN( 537)								HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,c) = this1;
...
HXDLIN( 545)								HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,c) = this1;
HXLINE( 546)								HX_VARI( int,color) = ::Std_obj::_hx_int(( (Float)(c->buffer->i->__get(c->iPos)) ));
HXLINE( 547)								HX_VARI( int,alpha) = ::Std_obj::_hx_int((c->buffer->f->__get(c->fPos) * ( (Float)(255) )));
...
HXDLIN( 554)								HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,c) = this1;
...
HXDLIN( 572)									HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,c) = this1;
HXLINE( 573)									HX_VARI(  ::openfl::_Vector::FloatVector,rects) = ( ( ::openfl::_Vector::FloatVector)(c->buffer->o->__get(c->oPos)) );
HXLINE( 574)									HX_VARI(  ::openfl::_Vector::IntVector,indices) = ( ( ::openfl::_Vector::IntVector)(c->buffer->o->__get((c->oPos + 1))) );
HXLINE( 575)									HX_VARI(  ::openfl::_Vector::FloatVector,transforms) = ( ( ::openfl::_Vector::FloatVector)(c->buffer->o->__get((c->oPos + 2))) );
HXLINE( 578)									HX_VAR( ::Array< Float >,rects1);
...
HXLINE( 579)									HX_VAR( ::Array< int >,indices1);
...
HXLINE( 580)									HX_VAR( ::Array< Float >,transforms1);
...
HXLINE( 583)									HX_VARI( bool,hasIndices) = ::hx::IsNotNull( indices1 );
HXLINE( 584)									HX_VAR( int,length);
...
HXLINE( 586)									HX_VARI( ::Array< Float >,uMatrix) = renderer->_hx___getMatrix(graphics->_hx___owner->_hx___renderTransform,1);
HXLINE( 587)									HX_VAR(  ::openfl::display::Shader,shader);
...
HXLINE( 611)									HX_VARI( int,end) = (quadBufferPosition + length);
...
HXDLIN( 644)									HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,c) = this1;
HXLINE( 645)									HX_VARI( Float,x) = c->buffer->f->__get(c->fPos);
HXLINE( 646)									HX_VARI( Float,y) = c->buffer->f->__get((c->fPos + 1));
HXLINE( 647)									HX_VARI( Float,width) = c->buffer->f->__get((c->fPos + 2));
HXLINE( 648)									HX_VARI( Float,height) = c->buffer->f->__get((c->fPos + 3));
HXLINE( 651)									HX_VARI( int,color) = ( (int)(fill) );
...
HXLINE( 664)									HX_VAR(  ::openfl::display::Shader,shader);
...
HXLINE( 674)									HX_VARI(  ::openfl::display3D::VertexBuffer3D,vertexBuffer) = ::openfl::_internal::renderer::context3D::Context3DGraphics_obj::blankBitmapData->getVertexBuffer(context,null(),null());
...
HXLINE( 677)									HX_VARI(  ::openfl::display3D::IndexBuffer3D,indexBuffer) = ::openfl::_internal::renderer::context3D::Context3DGraphics_obj::blankBitmapData->getIndexBuffer(context,null());
...
HXDLIN( 690)								HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,c) = this1;
HXLINE( 691)								HX_VARI(  ::openfl::_Vector::FloatVector,vertices) = ( ( ::openfl::_Vector::FloatVector)(c->buffer->o->__get(c->oPos)) );
HXLINE( 692)								HX_VARI(  ::openfl::_Vector::IntVector,indices) = ( ( ::openfl::_Vector::IntVector)(c->buffer->o->__get((c->oPos + 1))) );
HXLINE( 693)								HX_VARI(  ::openfl::_Vector::FloatVector,uvtData) = ( ( ::openfl::_Vector::FloatVector)(c->buffer->o->__get((c->oPos + 2))) );
HXLINE( 694)								HX_VARI(  ::Dynamic,culling) = c->buffer->o->__get((c->oPos + 3));
HXLINE( 696)								HX_VARI( bool,hasIndices) = ::hx::IsNotNull( indices );
HXLINE( 697)								HX_VARI( int,numVertices) = ::Math_obj::floor((( (Float)(vertices->get_length()) ) / ( (Float)(2) )));
HXLINE( 698)								HX_VAR( int,length);
...
HXLINE( 700)								HX_VARI( bool,hasUVData) = ::hx::IsNotNull( uvtData );
HXLINE( 701)								HX_VAR( bool,hasUVTData);
...
HXLINE( 702)								HX_VAR( int,vertLength);
...
HXLINE( 703)								HX_VAR( int,uvStride);
...
HXLINE( 705)								HX_VARI( int,dataPerVertex) = (vertLength + 2);
HXLINE( 706)								HX_VAR(  ::openfl::display3D::VertexBuffer3D,vertexBuffer);
...
HXLINE( 707)								HX_VAR( int,bufferPosition);
...
HXLINE( 709)								HX_VARI( ::Array< Float >,uMatrix) = renderer->_hx___getMatrix(graphics->_hx___owner->_hx___renderTransform,1);
HXLINE( 710)								HX_VAR(  ::openfl::display::Shader,shader);
...
HXDLIN( 797)								HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,c) = this1;
...
HXDLIN( 802)								HX_VARI(  ::openfl::_internal::renderer::DrawCommandReader,c) = this1;
...
HXLINE( 831)		HX_VAR(  ::lime::utils::ArrayBufferView,buffer);
...
HXLINE( 832)		HX_VARI( int,position) = 0;
HXDLIN( 832)		HX_VARI(  ::lime::utils::ArrayBufferView,newBuffer) = null();
...
void Context3DGraphics_obj::resizeVertexBuffer( ::openfl::display::Graphics graphics,bool hasUVTData,int length){
            	...
            	HX_STACK_ARG(length,"length")
HXLINE( 876)
HXLINE( 877)		HX_VAR(  ::lime::utils::ArrayBufferView,buffer);
...
HXLINE( 878)		HX_VARI(  ::lime::utils::ArrayBufferView,newBuffer) = null();

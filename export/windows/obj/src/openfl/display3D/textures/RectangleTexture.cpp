...
HXLINE(  60)		HX_VARI(  ::lime::graphics::Image,image) = this->_hx___getImage(source);
...
void RectangleTexture_obj::uploadFromTypedArray( ::lime::utils::ArrayBufferView data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 118)
HXLINE( 119)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 130)			HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 132)			if ((::openfl::display3D::Context3D_obj::_hx___glMaxTextureMaxAnisotropy != 0)) {
HXLINE( 134)				HX_VAR( int,aniso);

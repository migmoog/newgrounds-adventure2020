...
HXLINE( 394)		HX_VARI( ::String,glslVertex) = ::openfl::_internal::formats::agal::AGALConverter_obj::convertToGLSL(vertexProgram,null());
HXLINE( 395)		HX_VARI( ::String,glslFragment) = ::openfl::_internal::formats::agal::AGALConverter_obj::convertToGLSL(fragmentProgram,samplerStates);

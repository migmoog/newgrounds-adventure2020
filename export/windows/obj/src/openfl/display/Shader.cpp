...
HXLINE( 270)				HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
HXDLIN( 270)				_g = (_g + 1);
...
HXLINE( 275)				HX_VARI(  ::openfl::display::ShaderParameter_Float,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 280)				HX_VARI(  ::openfl::display::ShaderParameter_Int,parameter) = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
HXLINE( 317)
HXLINE( 318)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 320)		HX_VARI(  ::lime::graphics::opengl::GLObject,shader) = gl->createShader(type);
...
HXLINE( 326)			HX_VAR( ::String,message);
...
HXLINE( 336)
HXLINE( 337)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 339)		HX_VARI(  ::lime::graphics::opengl::GLObject,vertexShader) = this->_hx___createGLShader(vertexSource,gl->VERTEX_SHADER);
HXLINE( 340)		HX_VARI(  ::lime::graphics::opengl::GLObject,fragmentShader) = this->_hx___createGLShader(fragmentSource,gl->FRAGMENT_SHADER);
HXLINE( 342)		HX_VARI(  ::lime::graphics::opengl::GLObject,program) = gl->createProgram();
HXLINE( 345)		{
HXLINE( 345)			int _g = 0;
HXDLIN( 345)			::Array< ::Dynamic> _g1 = this->_hx___paramFloat;
HXDLIN( 345)			while((_g < _g1->length)){
HXLINE( 345)				HX_VARI(  ::openfl::display::ShaderParameter_Float,param) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 345)				_g = (_g + 1);
...
HXLINE( 360)			HX_VARI( ::String,message) = HX_("Unable to initialize the shader program",f0,86,8b,39);
...
void Shader_obj::_hx___disableGL(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 377)
HXLINE( 378)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 380)		HX_VARI( int,textureCount) = 0;
HXLINE( 382)		{
HXLINE( 382)			int _g = 0;
HXDLIN( 382)			::Array< ::Dynamic> _g1 = this->_hx___inputBitmapData;
HXDLIN( 382)			while((_g < _g1->length)){
HXLINE( 382)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 382)				_g = (_g + 1);
...
HXLINE( 388)				HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
...
HXLINE( 393)				HX_VARI(  ::openfl::display::ShaderParameter_Float,parameter) = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 398)				HX_VARI(  ::openfl::display::ShaderParameter_Int,parameter) = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
void Shader_obj::_hx___enableGL(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 424)
HXLINE( 425)		HX_VARI( int,textureCount) = 0;
HXLINE( 427)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 429)		{
HXLINE( 429)			int _g = 0;
HXDLIN( 429)			::Array< ::Dynamic> _g1 = this->_hx___inputBitmapData;
HXDLIN( 429)			while((_g < _g1->length)){
HXLINE( 429)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 429)				_g = (_g + 1);
...
HXLINE( 475)			HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 477)			HX_VARI( ::String,prefix1) = ((HX_("#ifdef GL_ES\r\n\t\t\t\t",8a,03,36,96) + prefix) + HX_("\r\n\t\t\t\t#endif\r\n\t\t\t\t",ef,f5,15,73));
HXLINE( 488)			HX_VARI( ::String,vertex) = (prefix1 + this->get_glVertexSource());
HXLINE( 489)			HX_VARI( ::String,fragment) = (prefix1 + this->get_glFragmentSource());
HXLINE( 491)			HX_VARI( ::String,id) = (vertex + fragment);
...
HXLINE( 512)						HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 512)						_g = (_g + 1);
...
HXLINE( 524)						HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
...
HXLINE( 536)						HX_VARI(  ::openfl::display::ShaderParameter_Float,parameter) = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 548)						HX_VARI(  ::openfl::display::ShaderParameter_Int,parameter) = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
HXLINE( 564)
HXLINE( 565)		HX_VARI( int,lastMatch) = 0;
HXDLIN( 565)		HX_VAR(  ::Dynamic,position);
HXDLIN( 565)		HX_VAR(  ::EReg,regex);
HXDLIN( 565)		HX_VAR( ::String,name);
HXDLIN( 565)		HX_VAR( ::String,type);
...
HXLINE( 586)			HX_VARI( bool,isUniform) = (storageType == HX_("uniform",34,41,64,b5));
HXLINE( 588)			if (::StringTools_obj::startsWith(type,HX_("sampler",08,c5,c9,83))) {
HXLINE( 590)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) =  ::openfl::display::ShaderInput_openfl_display_BitmapData_obj::__alloc( HX_CTX );
...
HXLINE( 609)					HX_VAR(  ::Dynamic,parameterType);
...
HXLINE( 635)						length = 1;
            					...
            					_hx_goto_26:;
HXLINE( 645)					HX_VAR( int,arrayLength);
...
HXLINE( 656)						HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) =  ::openfl::display::ShaderParameter_Bool_obj::__alloc( HX_CTX );
...
HXLINE( 674)						HX_VARI(  ::openfl::display::ShaderParameter_Int,parameter) =  ::openfl::display::ShaderParameter_Int_obj::__alloc( HX_CTX );
...
HXLINE( 673)						goto _hx_goto_29;
            					...
            					/* default */{
HXLINE( 686)						HX_VARI(  ::openfl::display::ShaderParameter_Float,parameter) =  ::openfl::display::ShaderParameter_Float_obj::__alloc( HX_CTX );
...
void Shader_obj::_hx___updateGL(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 740)
HXLINE( 741)		HX_VARI( int,textureCount) = 0;
HXLINE( 743)		{
HXLINE( 743)			int _g = 0;
HXDLIN( 743)			::Array< ::Dynamic> _g1 = this->_hx___inputBitmapData;
HXDLIN( 743)			while((_g < _g1->length)){
HXLINE( 743)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 743)				_g = (_g + 1);
...
HXLINE( 749)				HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
...
HXLINE( 754)				HX_VARI(  ::openfl::display::ShaderParameter_Float,parameter) = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 759)				HX_VARI(  ::openfl::display::ShaderParameter_Int,parameter) = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
void Shader_obj::_hx___updateGLFromBuffer( ::openfl::_internal::renderer::ShaderBuffer shaderBuffer,int bufferOffset){
            	...
            	HX_STACK_ARG(bufferOffset,"bufferOffset")
HXLINE( 766)
HXLINE( 767)		HX_VARI( int,textureCount) = 0;
HXLINE( 768)		HX_VAR(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input);
HXDLIN( 768)		HX_VAR(  ::openfl::display::BitmapData,inputData);
HXDLIN( 768)		HX_VAR(  ::Dynamic,inputFilter);
HXDLIN( 768)		HX_VAR(  ::Dynamic,inputMipFilter);
HXDLIN( 768)		HX_VAR(  ::Dynamic,inputWrap);
HXLINE( 770)		{
HXLINE( 770)			int _g = 0;
HXDLIN( 770)			int _g1 = shaderBuffer->inputCount;
HXDLIN( 770)			while((_g < _g1)){
HXLINE( 770)				_g = (_g + 1);
HXDLIN( 770)				HX_VARI( int,i) = (_g - 1);
...
HXLINE( 785)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 806)		HX_VARI( int,boolIndex) = 0;
HXLINE( 807)		HX_VARI( int,floatIndex) = 0;
HXLINE( 808)		HX_VARI( int,intIndex) = 0;
HXLINE( 810)		HX_VARI( int,boolCount) = shaderBuffer->paramBoolCount;
HXLINE( 811)		HX_VARI( int,floatCount) = shaderBuffer->paramFloatCount;
HXLINE( 812)		HX_VARI(  ::lime::utils::ArrayBufferView,paramData) = shaderBuffer->paramData;
HXLINE( 814)		HX_VAR(  ::openfl::display::ShaderParameter_Bool,boolRef);
HXDLIN( 814)		HX_VAR(  ::openfl::display::ShaderParameter_Float,floatRef);
HXDLIN( 814)		HX_VAR(  ::openfl::display::ShaderParameter_Int,intRef);
HXDLIN( 814)		HX_VAR( bool,hasOverride);
HXLINE( 815)		HX_VARI( ::Array< bool >,overrideBoolValue) = null();
HXDLIN( 815)		HX_VARI( ::Array< Float >,overrideFloatValue) = null();
HXDLIN( 815)		HX_VARI( ::Array< int >,overrideIntValue) = null();
HXLINE( 819)		{
HXLINE( 819)			int _g2 = 0;
HXDLIN( 819)			int _g3 = shaderBuffer->paramCount;
HXDLIN( 819)			while((_g2 < _g3)){
HXLINE( 819)				_g2 = (_g2 + 1);
HXDLIN( 819)				HX_VARI( int,i) = (_g2 - 1);

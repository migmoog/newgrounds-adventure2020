...
HXLINE( 196)			HX_VARI(  ::openfl::errors::TypeError,error) =  ::openfl::errors::TypeError_obj::__alloc( HX_CTX ,HX_("Error #2007: Parameter child must be non-null.",30,5a,a7,aa));
...
HXLINE( 203)				HX_VARI(  ::openfl::errors::ArgumentError,error) =  ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("Error #3783: A Stage object cannot be added as the child of another object.",fa,51,93,42));
...
HXLINE( 234)			HX_VAR( bool,addedToStage);
...
HXLINE( 246)			HX_VARI(  ::openfl::events::Event,event) = ::openfl::events::Event_obj::_hx___pool->get().StaticCast<  ::openfl::events::Event >();
...
HXLINE( 371)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 371)				_g = (_g + 1);
...
::Array< ::Dynamic> DisplayObjectContainer_obj::getObjectsUnderPoint( ::openfl::geom::Point point){
            	...
            	HX_STACK_ARG(point,"point")
HXLINE( 417)
HXLINE( 418)		HX_VARI( ::Array< ::Dynamic>,stack) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 451)			HX_VARI(  ::openfl::events::Event,event) =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("removed",a0,1f,00,f3),true,null());
...
HXLINE( 461)				HX_VARI(  ::openfl::events::Event,event) =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("removedFromStage",34,21,76,ba),false,false);
...
HXLINE( 540)		HX_VARI( int,numRemovals) = (endIndex - beginIndex);
...
HXLINE( 636)			HX_VARI( int,index1) = this->_hx___children->indexOf(child1,null());
HXLINE( 637)			HX_VARI( int,index2) = this->_hx___children->indexOf(child2,null());
...
HXLINE( 656)
HXLINE( 657)		HX_VARI(  ::openfl::display::DisplayObject,swap) = this->_hx___children->__get(index1).StaticCast<  ::openfl::display::DisplayObject >();
...
HXLINE( 668)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 668)				_g = (_g + 1);
...
HXLINE( 677)
HXLINE( 678)		{
HXLINE( 678)			HX_VARI(  ::Dynamic,orphan) = this->_hx___removedChildren->iterator();
HXDLIN( 678)			while(( (bool)(orphan->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 678)				HX_VARI(  ::openfl::display::DisplayObject,orphan1) = ( ( ::openfl::display::DisplayObject)(orphan->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 693)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 693)				_g = (_g + 1);
...
HXDLIN( 709)			HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 709)			_g = (_g + 1);
...
HXLINE( 721)		HX_VARI(  ::openfl::geom::Matrix,childWorldTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 723)		{
HXLINE( 723)			int _g = 0;
HXDLIN( 723)			::Array< ::Dynamic> _g1 = this->_hx___children;
HXDLIN( 723)			while((_g < _g1->length)){
HXLINE( 723)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 723)				_g = (_g + 1);
...
HXLINE( 742)		HX_VARI(  ::openfl::geom::Matrix,childWorldTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 744)		{
HXLINE( 744)			int _g = 0;
...
HXLINE( 770)		HX_VARI(  ::openfl::geom::Matrix,childWorldTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 772)		{
HXLINE( 772)			int _g = 0;
...
HXLINE( 792)			HX_VARI(  ::openfl::geom::Point,point) = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
...
HXLINE( 805)		HX_VARI( int,i) = this->_hx___children->length;
...
HXLINE( 825)					HX_VARI( int,length) = stack->length;
HXLINE( 827)					HX_VARI( bool,interactive) = false;
HXLINE( 828)					HX_VARI( bool,hitTest) = false;
...
HXLINE( 857)			HX_VARI( bool,hitTest) = false;
...
bool DisplayObjectContainer_obj::_hx___hitTestMask(Float x,Float y){
            	...
            	HX_STACK_ARG(y,"y")
HXLINE( 875)
HXLINE( 876)		HX_VARI( int,i) = this->_hx___children->length;
...
HXLINE( 895)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 895)				_g = (_g + 1);
...
HXLINE( 917)					HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 917)					_g = (_g + 1);
...
HXLINE( 927)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 927)				_g = (_g + 1);
...
HXLINE( 947)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 947)				_g = (_g + 1);
...
HXLINE( 979)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 979)				_g = (_g + 1);
...
HXLINE( 998)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 998)				_g = (_g + 1);
...
HXLINE(1005)
HXLINE(1006)		{
HXLINE(1006)			HX_VARI(  ::Dynamic,orphan) = this->_hx___removedChildren->iterator();
HXDLIN(1006)			while(( (bool)(orphan->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1006)				HX_VARI(  ::openfl::display::DisplayObject,orphan1) = ( ( ::openfl::display::DisplayObject)(orphan->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1024)					HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1024)					_g = (_g + 1);
...
HXLINE(1034)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1034)				_g = (_g + 1);
...
HXLINE(1044)
HXLINE(1045)		{
HXLINE(1045)			HX_VARI(  ::Dynamic,orphan) = this->_hx___removedChildren->iterator();
HXDLIN(1045)			while(( (bool)(orphan->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1045)				HX_VARI(  ::openfl::display::DisplayObject,orphan1) = ( ( ::openfl::display::DisplayObject)(orphan->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1055)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1055)				_g = (_g + 1);
...
HXLINE(1078)						HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1078)						_g = (_g + 1);
...
HXLINE(1088)					HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1088)					_g = (_g + 1);
...
HXLINE(1112)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1112)				_g = (_g + 1);
...
HXLINE(1124)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1124)				_g = (_g + 1);
...
HXLINE(1139)					HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1139)					_g = (_g + 1);
...
HXLINE(1155)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1155)				_g = (_g + 1);
...
HXDLIN(1167)			HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1167)			_g = (_g + 1);
...
HXLINE(1179)		HX_VARI( bool,interactive) = false;
HXLINE(1180)		HX_VARI(  ::openfl::display::InteractiveObject,interactiveObject) = null();
HXLINE(1182)		{
HXLINE(1182)			int _g = 0;
HXDLIN(1182)			::Array< ::Dynamic> _g1 = this->_hx___children;
HXDLIN(1182)			while((_g < _g1->length)){
HXLINE(1182)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1182)				_g = (_g + 1);
...
HXLINE(1200)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1200)				_g = (_g + 1);

...
HXLINE( 248)			HX_VARI(  ::openfl::geom::Point,point) = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
...
HXLINE( 286)				HX_VARI( bool,hitTest) = this->hitArea->_hx___hitTest(x,y,shapeFlag,null(),true,hitObject);

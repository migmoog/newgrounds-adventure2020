...
HXLINE( 398)			HX_VARI( ::String,extension) = HX_("",00,00,00,00);
HXLINE( 399)			this->_hx___path = request->url;
HXLINE( 401)			HX_VARI( int,queryIndex) = this->_hx___path.indexOf(HX_("?",3f,00,00,00),null());
...
HXLINE( 426)			HX_VARI( int,extIndex) = this->_hx___path.lastIndexOf(HX_(".",2e,00,00,00),null());
...
HXLINE( 463)		HX_VARI(  ::openfl::net::URLLoader,loader) =  ::openfl::net::URLLoader_obj::__alloc( HX_CTX ,null());
...
HXLINE( 696)
HXLINE( 697)		HX_VARI(  ::openfl::events::IOErrorEvent,event) =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,HX_("ioError",02,fe,41,76),null(),null(),null(),null());
...
HXLINE( 742)
HXLINE( 743)		HX_VARI(  ::openfl::events::ProgressEvent,event) =  ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,HX_("progress",ad,f7,2a,86),null(),null(),null(),null());
...
HXLINE( 753)		HX_VARI(  ::openfl::net::URLLoader,loader) = ( ( ::openfl::net::URLLoader)(event->target) );
...
HXDLIN( 758)			HX_VARI(  ::lime::utils::AssetManifest,manifest) = ::lime::utils::AssetManifest_obj::parse(( (::String)(loader1) ),::haxe::io::Path_obj::directory(this->_hx___path));
HXLINE( 760)			if (::hx::IsNull( manifest )) {
HXLINE( 762)				this->_hx___dispatchError(HX_("Cannot parse asset manifest",49,e5,68,e9));
HXLINE( 763)				return;
            			}
HXLINE( 766)			HX_VARI(  ::lime::utils::AssetLibrary,library) = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
...
HXLINE( 786)					HX_VARI(  ::openfl::display::MovieClip,clip) = _gthis->_hx___library->getMovieClip(HX_("",00,00,00,00));

...
bool Event_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event Event_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 760)
HXLINE( 761)		HX_VARI(  ::openfl::events::Event,event) =  ::openfl::events::Event_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable);
...
::String Event_obj::formatToString(::String className,::String p1,::String p2,::String p3,::String p4,::String p5){
            	...
            	HX_STACK_ARG(p5,"p5")
HXLINE( 793)
HXLINE( 794)		HX_VARI( ::Array< ::String >,parameters) = ::Array_obj< ::String >::__new(0);
...
HXLINE( 881)
HXLINE( 884)		HX_VARI( ::String,output) = (HX_("[",5b,00,00,00) + className);
HXLINE( 885)		HX_VARI(  ::Dynamic,arg) = null();
HXLINE( 887)		{
HXLINE( 887)			int _g = 0;
HXDLIN( 887)			while((_g < parameters->length)){
HXLINE( 887)				HX_VARI( ::String,param) = parameters->__get(_g);
HXDLIN( 887)				_g = (_g + 1);

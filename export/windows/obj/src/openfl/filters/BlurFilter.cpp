...
HXDLIN( 184)		HX_VARI(  ::lime::graphics::Image,finalImage2) = ::lime::_internal::graphics::ImageDataUtil_obj::gaussianBlur(bitmapData1,sourceBitmapData1,finalImage,finalImage1,this->_hx___blurX,this->_hx___blurY,this->_hx___quality,null(),null());
...
HXDLIN( 186)		HX_VARI( Float,elapsed1) = (elapsed - time);
...
HXLINE( 198)			HX_VARI( Float,scale) = ::Math_obj::pow(((Float)0.5),( (Float)((pass >> 1)) ));
...
HXLINE( 204)			HX_VARI( Float,scale) = ::Math_obj::pow(((Float)0.5),( (Float)(((pass - this->_hx___horizontalPasses) >> 1)) ));

...
HXLINE( 242)
HXLINE( 246)		HX_VARI( int,r) = ((this->_hx___color >> 16) & 255);
HXLINE( 247)		HX_VARI( int,g) = ((this->_hx___color >> 8) & 255);
HXLINE( 248)		HX_VARI( int,b) = (this->_hx___color & 255);
...
HXDLIN( 250)		HX_VARI(  ::lime::graphics::Image,finalImage2) = ::lime::_internal::graphics::ImageDataUtil_obj::gaussianBlur(bitmapData1,sourceBitmapData1,finalImage,finalImage1,this->_hx___blurX,this->_hx___blurY,this->_hx___quality,this->_hx___strength,null());
...
HXLINE( 264)			HX_VARI( Float,scale) = ::Math_obj::pow(((Float)0.5),( (Float)((pass >> 1)) ));
...
HXLINE( 270)			HX_VARI( Float,scale) = ::Math_obj::pow(((Float)0.5),( (Float)(((pass - this->_hx___horizontalPasses) >> 1)) ));

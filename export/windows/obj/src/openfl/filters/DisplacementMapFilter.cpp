...
void DisplacementMapFilter_obj::__construct( ::openfl::display::BitmapData mapBitmap, ::openfl::geom::Point mapPoint,::hx::Null< int >  __o_componentX,::hx::Null< int >  __o_componentY,::hx::Null< Float >  __o_scaleX,::hx::Null< Float >  __o_scaleY,::String __o_mode,::hx::Null< int >  __o_color,::hx::Null< Float >  __o_alpha){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(mapBitmap,"mapBitmap")
...
void DisplacementMapFilter_obj::_hx___updateMapMatrix(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 261)
HXLINE( 262)		HX_VAR( int,columnX);
HXDLIN( 262)		HX_VAR( int,columnY);
HXLINE( 263)		HX_VARI( Float,scale) = ((Float)1.0);
HXLINE( 264)		HX_VARI( Float,textureWidth) = ( (Float)(this->_hx___mapBitmap->width) );
HXLINE( 265)		HX_VARI( Float,textureHeight) = ( (Float)(this->_hx___mapBitmap->height) );
HXLINE( 267)		{

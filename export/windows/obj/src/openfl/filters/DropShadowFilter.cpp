...
HXLINE( 276)
HXLINE( 280)		HX_VARI( int,r) = ((this->_hx___color >> 16) & 255);
HXLINE( 281)		HX_VARI( int,g) = ((this->_hx___color >> 8) & 255);
HXLINE( 282)		HX_VARI( int,b) = (this->_hx___color & 255);
HXLINE( 284)		HX_VARI(  ::openfl::geom::Point,point) =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,(destPoint->x + this->_hx___offsetX),(destPoint->y + this->_hx___offsetY));
...
HXDLIN( 286)		HX_VARI(  ::lime::graphics::Image,finalImage2) = ::lime::_internal::graphics::ImageDataUtil_obj::gaussianBlur(bitmapData1,sourceBitmapData1,finalImage,finalImage1,this->_hx___blurX,this->_hx___blurY,this->_hx___quality,this->_hx___strength,null());

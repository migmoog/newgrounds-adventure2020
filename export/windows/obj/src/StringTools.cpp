...
HXLINE( 230)		HX_VARI( ::cpp::Pointer< char >,p0) = cpp::Pointer_obj::fromPointer(s.c_str());
HXLINE( 231)		HX_VARI( ::cpp::Pointer< char >,p1) = cpp::Pointer_obj::fromPointer(start.c_str());
HXLINE( 232)		{
HXLINE( 232)			int _g = 0;
...
HXLINE( 252)
HXLINE( 264)		HX_VARI( int,elen) = end.length;
HXLINE( 265)		HX_VARI( int,slen) = s.length;
...
HXLINE( 279)
HXLINE( 284)		HX_VARI(  ::Dynamic,c) = s.charCodeAt(pos);
...
::String StringTools_obj::ltrim(::String s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE( 297)
HXLINE( 301)		HX_VARI( int,l) = s.length;
HXLINE( 302)		HX_VARI( int,r) = 0;
...
::String StringTools_obj::rtrim(::String s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE( 322)
HXLINE( 326)		HX_VARI( int,l) = s.length;
HXLINE( 327)		HX_VARI( int,r) = 0;
...
HXLINE( 370)		HX_VARI(  ::StringBuf,buf) =  ::StringBuf_obj::__alloc( HX_CTX );
...
HXLINE( 435)
HXLINE( 441)		HX_VARI( ::String,s) = HX_("",00,00,00,00);
HXLINE( 442)		HX_VARI( ::String,hexChars) = HX_("0123456789ABCDEF",68,2a,58,a2);

...
HXLINE( 607)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 607)				_g = (_g + 1);
...
HXLINE( 626)		HX_VARI( int,numProps) = FunctionArray->length;
HXLINE( 627)		if ((numProps > ValueArray->length)) {
HXLINE( 628)			return;
            		}
HXLINE( 630)		HX_VAR(  ::Dynamic,lambda);
HXLINE( 631)		{
HXLINE( 631)			int _g = 0;
HXDLIN( 631)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 631)			while((_g < _g1->length)){
HXLINE( 631)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 631)				_g = (_g + 1);
...
HXLINE( 564)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 564)				_g = (_g + 1);
...
void FlxTypedSpriteGroup_obj::setPosition(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y){
            	...
            	HX_STACK_ARG(Y,"Y")
HXLINE( 581)
HXLINE( 583)		HX_VARI( Float,dx) = (X - this->x);
HXLINE( 584)		HX_VARI( Float,dy) = (Y - this->y);
...
HXLINE( 692)			HX_VARI( Float,offset) = (Value - this->x);
...
HXLINE( 703)			HX_VARI( Float,offset) = (Value - this->y);
...
HXLINE( 714)			HX_VARI( Float,offset) = (Value - this->angle);
...
HXLINE( 726)			HX_VAR( Float,factor);
...
int FlxTypedSpriteGroup_obj::set_color(int _tmp_Value){
            	...
            	HX_STACK_THIS(this)
HXLINE( 778)
HXLINE( 779)		HX_VARI( int,Value) = _tmp_Value;
...
HXLINE( 818)		HX_VARI( Float,minX) = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 819)		HX_VARI( Float,maxX) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 821)		{
HXLINE( 821)			int _g = 0;
HXDLIN( 821)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 821)			while((_g < _g1->length)){
HXLINE( 821)				HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 821)				_g = (_g + 1);
HXLINE( 823)				if (::hx::IsNull( member )) {
HXLINE( 824)					continue;
            				}
HXLINE( 825)				HX_VARI( Float,minMemberX) = member->x;
HXLINE( 826)				HX_VARI( Float,maxMemberX) = (minMemberX + member->get_width());
...
HXLINE( 851)		HX_VARI( Float,minY) = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 852)		HX_VARI( Float,maxY) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 854)		{
HXLINE( 854)			int _g = 0;
HXDLIN( 854)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 854)			while((_g < _g1->length)){
HXLINE( 854)				HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 854)				_g = (_g + 1);
HXLINE( 856)				if (::hx::IsNull( member )) {
HXLINE( 857)					continue;
            				}
HXLINE( 858)				HX_VARI( Float,minMemberY) = member->y;
HXLINE( 859)				HX_VARI( Float,maxMemberY) = (minMemberY + member->get_height());
...
HXDLIN(1024)		return null();
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::makeGraphic(int Width,int Height,::hx::Null< int >  __o__tmp_Color,::hx::Null< bool >  __o_Unique,::String Key){
            	...
            	HX_STACK_ARG(Key,"Key")
HXLINE(1036)
HXDLIN(1036)		HX_VARI( int,Color) = _tmp_Color;

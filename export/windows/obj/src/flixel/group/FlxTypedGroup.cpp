...
HXLINE( 141)			HX_VARI( int,i) = 0;
HXLINE( 142)			HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 160)
HXLINE( 161)		HX_VARI( int,i) = 0;
HXLINE( 162)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
void FlxTypedGroup_obj::draw(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 179)
HXLINE( 180)		HX_VARI( int,i) = 0;
HXLINE( 181)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
HXLINE( 183)		HX_VARI( ::Array< ::Dynamic>,oldDefaultCameras) = ::flixel::FlxCamera_obj::defaultCameras;
...
HXLINE( 225)		HX_VARI( int,index) = this->getFirstNull();
...
HXLINE( 330)
HXLINE( 331)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HX_DEFINE_DYNAMIC_FUNC4(FlxTypedGroup_obj,recycle,return )
 ...
 ::Dynamic FlxTypedGroup_obj::recycleCreateObject(::hx::Class ObjectClass, ::Dynamic ObjectFactory){
            	...
            	HX_STACK_ARG(ObjectFactory,"ObjectFactory")
HXLINE( 373)
HXLINE( 374)		HX_VARI(  ::Dynamic,object) = null();
...
HXLINE( 396)		HX_VARI( int,index) = this->members->indexOf(Object,null());
...
HXLINE( 424)
HXLINE( 425)		HX_VARI( int,index) = this->members->indexOf(OldObject,null());
...
HX_DEFINE_DYNAMIC_FUNC2(FlxTypedGroup_obj,sort,(void))
 ...
 ::Dynamic FlxTypedGroup_obj::getFirstAvailable(::hx::Class ObjectClass,::hx::Null< bool >  __o_Force){
            	...
            	HX_STACK_ARG(Force,"Force")
HXLINE( 465)
HXLINE( 466)		HX_VARI( int,i) = 0;
HXLINE( 467)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTypedGroup_obj,getFirstNull,return )
 ...
 ::Dynamic FlxTypedGroup_obj::getFirstExisting(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 513)
HXLINE( 514)		HX_VARI( int,i) = 0;
HXLINE( 515)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTypedGroup_obj,getFirstExisting,return )
 ...
 ::Dynamic FlxTypedGroup_obj::getFirstAlive(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 535)
HXLINE( 536)		HX_VARI( int,i) = 0;
HXLINE( 537)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTypedGroup_obj,getFirstAlive,return )
 ...
 ::Dynamic FlxTypedGroup_obj::getFirstDead(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 557)
HXLINE( 558)		HX_VARI( int,i) = 0;
HXLINE( 559)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
int FlxTypedGroup_obj::countLiving(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 578)
HXLINE( 579)		HX_VARI( int,i) = 0;
HXLINE( 580)		HX_VARI( int,count) = -1;
HXLINE( 581)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
int FlxTypedGroup_obj::countDead(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 605)
HXLINE( 606)		HX_VARI( int,i) = 0;
HXLINE( 607)		HX_VARI( int,count) = -1;
HXLINE( 608)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 654)				HX_VARI(  ::Dynamic,member) = _g1->__get(_g);
HXDLIN( 654)				_g = (_g + 1);
...
void FlxTypedGroup_obj::kill(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 669)
HXLINE( 670)		HX_VARI( int,i) = 0;
HXLINE( 671)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
void FlxTypedGroup_obj::revive(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 688)
HXLINE( 689)		HX_VARI( int,i) = 0;
HXLINE( 690)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 718)
HXLINE( 719)		HX_VARI( int,i) = 0;
HXLINE( 720)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 730)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(basic);
...
void FlxTypedGroup_obj::forEachAlive( ::Dynamic Function,::hx::Null< bool >  __o_Recurse){
            	...
            	HX_STACK_ARG(Recurse,"Recurse")
HXLINE( 747)
HXLINE( 748)		HX_VARI( int,i) = 0;
HXLINE( 749)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 759)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(basic);
...
HXLINE( 778)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 788)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(basic);
...
void FlxTypedGroup_obj::forEachExists( ::Dynamic Function,::hx::Null< bool >  __o_Recurse){
            	...
            	HX_STACK_ARG(Recurse,"Recurse")
HXLINE( 805)
HXLINE( 806)		HX_VARI( int,i) = 0;
HXLINE( 807)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 817)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(basic);
...
void FlxTypedGroup_obj::forEachOfType(::hx::Class ObjectClass, ::Dynamic Function,::hx::Null< bool >  __o_Recurse){
            	...
            	HX_STACK_ARG(Recurse,"Recurse")
HXLINE( 835)
HXLINE( 836)		HX_VARI( int,i) = 0;
HXLINE( 837)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 847)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(basic);
...
HXLINE( 870)		HX_VARI( int,i) = this->maxSize;
HXLINE( 871)		HX_VARI( int,l) = this->length;
HXLINE( 872)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE(  26)
HXLINE(  27)		HX_VARI( bool,result) = false;
HXLINE(  28)		if (::hx::IsNotNull( Group )) {
HXLINE(  30)			HX_VARI( int,i) = 0;
HXLINE(  31)			HX_VARI( int,l) = Group->length;
HXLINE(  32)			HX_VAR(  ::flixel::FlxBasic,basic);
HXLINE(  34)			while((i < l)){
HXLINE(  36)				i = (i + 1);
...
HXLINE(  50)
HXLINE(  51)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = null();
...
HXLINE(  60)					HX_VARI(  ::flixel::group::FlxTypedSpriteGroup,spriteGroup) = ( ( ::flixel::group::FlxTypedSpriteGroup)(ObjectOrGroup) );

...
HXDLIN( 740)		HX_VARI( Float,velocityDelta1) = (((Float)0.5) * (velocityDelta - this->angularVelocity));
...
HXLINE( 747)		HX_VARI( Float,delta) = (this->velocity->x * elapsed);
HXLINE( 748)		{
...
HXLINE( 784)
HXLINE( 785)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(ObjectOrGroup);
...
HXLINE( 795)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(ObjectOrGroup) );
HXLINE( 796)			return tilemap->overlaps(::hx::ObjectPtr<OBJ_>(this),InScreenSpace,Camera);
            		}
HXLINE( 799)		HX_VARI(  ::flixel::FlxObject,object) = ( ( ::flixel::FlxObject)(ObjectOrGroup) );
...
HXLINE( 809)		HX_VARI(  ::flixel::math::FlxPoint,objectScreenPos) = object->getScreenPosition(null(),Camera);
...
bool FlxObject_obj::overlapsAt(Float X,Float Y, ::flixel::FlxBasic ObjectOrGroup,::hx::Null< bool >  __o_InScreenSpace, ::flixel::FlxCamera Camera){
            	...
            	HX_STACK_ARG(Camera,"Camera")
HXLINE( 843)
HXLINE( 844)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(ObjectOrGroup);
...
HXLINE( 856)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(ObjectOrGroup) );
HXLINE( 857)			return tilemap->overlapsAt((tilemap->x - (X - this->x)),(tilemap->y - (Y - this->y)),::hx::ObjectPtr<OBJ_>(this),InScreenSpace,Camera);
            		}
HXLINE( 860)		HX_VARI(  ::flixel::FlxObject,object) = ( ( ::flixel::FlxObject)(ObjectOrGroup) );
...
HXLINE( 870)		HX_VARI(  ::flixel::math::FlxPoint,objectScreenPos) = object->getScreenPosition(null(),Camera);
...
HXLINE( 904)		HX_VARI( Float,xPos) = (point->x - Camera->scroll->x);
HXLINE( 905)		HX_VARI( Float,yPos) = (point->y - Camera->scroll->y);
...
HXLINE(1104)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(1104)				_g = (_g + 1);
...
HXLINE(1124)		HX_VARI(  ::flixel::math::FlxRect,rect) = this->getBoundingBox(camera);
HXLINE(1125)		HX_VAR(  ::openfl::display::Graphics,gfx);
...
HXLINE(1131)
HXLINE(1133)		HX_VARI(  ::Dynamic,color) = this->debugBoundingBoxColor;
...
HXLINE(  93)
HXLINE(  94)		HX_VARI( bool,separatedX) = ::flixel::FlxObject_obj::separateX(Object1,Object2);
HXLINE(  95)		HX_VARI( bool,separatedY) = ::flixel::FlxObject_obj::separateY(Object1,Object2);
...
bool FlxObject_obj::updateTouchingFlags( ::flixel::FlxObject Object1, ::flixel::FlxObject Object2){
            	...
            	HX_STACK_ARG(Object2,"Object2")
HXLINE( 108)
HXLINE( 109)		HX_VARI( bool,touchingX) = ::flixel::FlxObject_obj::updateTouchingFlagsX(Object1,Object2);
HXLINE( 110)		HX_VARI( bool,touchingY) = ::flixel::FlxObject_obj::updateTouchingFlagsY(Object1,Object2);
...
HXLINE( 121)
HXLINE( 122)		HX_VARI( Float,overlap) = ( (Float)(0) );
HXLINE( 124)		HX_VARI( Float,obj1delta) = (Object1->x - Object1->last->x);
HXLINE( 125)		HX_VARI( Float,obj2delta) = (Object2->x - Object2->last->x);
HXLINE( 127)		if ((obj1delta != obj2delta)) {
HXLINE( 130)			HX_VAR( Float,obj1deltaAbs);
...
HXLINE( 131)			HX_VAR( Float,obj2deltaAbs);
...
HXDLIN( 133)			HX_VARI(  ::flixel::math::FlxRect,obj1rect) = _this;
...
HXDLIN( 135)			HX_VARI(  ::flixel::math::FlxRect,obj2rect) = _this1;
...
HXLINE( 143)				HX_VAR( Float,maxOverlap);
...
bool FlxObject_obj::separateX( ::flixel::FlxObject Object1, ::flixel::FlxObject Object2){
            	...
            	HX_STACK_ARG(Object2,"Object2")
HXLINE( 189)
HXLINE( 191)		HX_VARI( bool,obj1immovable) = Object1->immovable;
HXLINE( 192)		HX_VARI( bool,obj2immovable) = Object2->immovable;
...
HXLINE( 201)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object1) );
...
HXLINE( 206)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );
HXLINE( 207)			return tilemap->overlapsWithCallback(Object1,::flixel::FlxObject_obj::separateX_dyn(),true,null());
            		}
HXLINE( 210)		HX_VARI( Float,overlap) = ::flixel::FlxObject_obj::computeOverlapX(Object1,Object2,null());
HXLINE( 212)		if ((overlap != 0)) {
HXLINE( 214)			HX_VARI( Float,obj1v) = Object1->velocity->x;
HXLINE( 215)			HX_VARI( Float,obj2v) = Object2->velocity->x;
...
HXDLIN( 223)				HX_VARI( Float,obj1velocity1) = (::Math_obj::sqrt((((obj2v * obj2v) * Object2->mass) / Object1->mass)) * ( (Float)(obj1velocity) ));
...
HXDLIN( 224)				HX_VARI( Float,obj2velocity1) = (::Math_obj::sqrt((((obj1v * obj1v) * Object1->mass) / Object2->mass)) * ( (Float)(obj2velocity) ));
HXLINE( 225)				HX_VARI( Float,average) = ((obj1velocity1 + obj2velocity1) * ((Float)0.5));
...
HXLINE( 259)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object1) );
...
HXLINE( 264)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );
...
Float FlxObject_obj::computeOverlapY( ::flixel::FlxObject Object1, ::flixel::FlxObject Object2,::hx::Null< bool >  __o_checkMaxOverlap){
            	...
            	HX_STACK_ARG(checkMaxOverlap,"checkMaxOverlap")
HXLINE( 278)
HXLINE( 279)		HX_VARI( Float,overlap) = ( (Float)(0) );
HXLINE( 281)		HX_VARI( Float,obj1delta) = (Object1->y - Object1->last->y);
HXLINE( 282)		HX_VARI( Float,obj2delta) = (Object2->y - Object2->last->y);
HXLINE( 284)		if ((obj1delta != obj2delta)) {
HXLINE( 287)			HX_VAR( Float,obj1deltaAbs);
...
HXLINE( 288)			HX_VAR( Float,obj2deltaAbs);
...
HXDLIN( 290)			HX_VARI(  ::flixel::math::FlxRect,obj1rect) = _this;
...
HXDLIN( 292)			HX_VARI(  ::flixel::math::FlxRect,obj2rect) = _this1;
...
HXLINE( 300)				HX_VAR( Float,maxOverlap);
...
bool FlxObject_obj::separateY( ::flixel::FlxObject Object1, ::flixel::FlxObject Object2){
            	...
            	HX_STACK_ARG(Object2,"Object2")
HXLINE( 346)
HXLINE( 348)		HX_VARI( bool,obj1immovable) = Object1->immovable;
HXLINE( 349)		HX_VARI( bool,obj2immovable) = Object2->immovable;
...
HXLINE( 358)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object1) );
...
HXLINE( 363)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );
HXLINE( 364)			return tilemap->overlapsWithCallback(Object1,::flixel::FlxObject_obj::separateY_dyn(),true,null());
            		}
HXLINE( 367)		HX_VARI( Float,overlap) = ::flixel::FlxObject_obj::computeOverlapY(Object1,Object2,null());
HXLINE( 369)		if ((overlap != 0)) {
HXLINE( 371)			HX_VARI( Float,obj1delta) = (Object1->y - Object1->last->y);
HXLINE( 372)			HX_VARI( Float,obj2delta) = (Object2->y - Object2->last->y);
HXLINE( 373)			HX_VARI( Float,obj1v) = Object1->velocity->y;
HXLINE( 374)			HX_VARI( Float,obj2v) = Object2->velocity->y;
...
HXDLIN( 382)				HX_VARI( Float,obj1velocity1) = (::Math_obj::sqrt((((obj2v * obj2v) * Object2->mass) / Object1->mass)) * ( (Float)(obj1velocity) ));
...
HXDLIN( 383)				HX_VARI( Float,obj2velocity1) = (::Math_obj::sqrt((((obj1v * obj1v) * Object1->mass) / Object2->mass)) * ( (Float)(obj2velocity) ));
HXLINE( 384)				HX_VARI( Float,average) = ((obj1velocity1 + obj2velocity1) * ((Float)0.5));
...
HXLINE( 428)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object1) );
...
HXLINE( 433)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );

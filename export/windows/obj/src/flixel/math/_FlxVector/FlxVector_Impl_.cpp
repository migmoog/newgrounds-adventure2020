...
bool FlxVector_Impl__obj::isParallel( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE( 355)
HXLINE( 356)		HX_VARI( bool,p) = (::Math_obj::abs(((this1->x * v->y) - (this1->y * v->x))) < ((Float)9.9999999999999984e-015));
...
HXLINE( 506)
HXLINE( 507)		HX_VARI( Float,dp) = ((this1->x * v->x) + (this1->y * v->y));
HXLINE( 508)		HX_VARI( Float,lenSq) = ((v->x * v->x) + (v->y * v->y));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(FlxVector_Impl__obj,projectToNormalized,return )
 ...
 ::flixel::math::FlxPoint FlxVector_Impl__obj::projectToNormalizedWeak( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint v, ::flixel::math::FlxPoint proj){
            	...
            	HX_STACK_ARG(proj,"proj")
HXLINE( 543)
HXLINE( 544)		HX_VARI( Float,dp) = ((this1->x * v->x) + (this1->y * v->y));
...
Float FlxVector_Impl__obj::perpProduct( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE( 558)
HXLINE( 559)		HX_VARI( Float,pp) = ((this1->y * v->x) + (-(this1->x) * v->y));
...
Float FlxVector_Impl__obj::radiansBetween( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE( 694)
HXLINE( 695)		HX_VARI( Float,rads) = ::Math_obj::acos((((this1->x * v->x) + (this1->y * v->y)) / (::Math_obj::sqrt(((this1->x * this1->x) + (this1->y * this1->y))) * ::Math_obj::sqrt(((v->x * v->x) + (v->y * v->y))))));
...
int FlxVector_Impl__obj::sign( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint a, ::flixel::math::FlxPoint b){
            	...
            	HX_STACK_ARG(b,"b")
HXLINE( 718)
HXLINE( 719)		HX_VARI( Float,signFl) = (((a->x - this1->x) * (b->y - this1->y)) - ((a->y - this1->y) * (b->x - this1->x)));
...
Float FlxVector_Impl__obj::distSquared( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE( 741)
HXLINE( 742)		HX_VARI( Float,dx) = (v->x - this1->x);
HXLINE( 743)		HX_VARI( Float,dy) = (v->y - this1->y);
...
HXLINE( 756)
HXLINE( 757)		HX_VARI( Float,d) = ((1 + bounceCoeff) * ((this1->x * normal->x) + (this1->y * normal->y)));
HXLINE( 758)		{
...
HXDLIN( 774)		HX_VARI(  ::flixel::math::FlxPoint,p1) = proj->set((dp * v->x),(dp * v->y));
...
HXDLIN( 775)		HX_VARI(  ::flixel::math::FlxPoint,p2) = proj1->set((dp1 * normal->x),(dp1 * normal->y));
HXLINE( 776)		HX_VARI( Float,bounceX) = -(p2->x);
HXLINE( 777)		HX_VARI( Float,bounceY) = -(p2->y);
HXLINE( 778)		HX_VARI( Float,frictionX) = p1->x;
HXLINE( 779)		HX_VARI( Float,frictionY) = p1->y;
...
HXLINE( 859)			HX_VARI( Float,a) = ::flixel::math::_FlxVector::FlxVector_Impl__obj::get_radians(this1);
...
Float FlxVector_Impl__obj::set_radians( ::flixel::math::FlxPoint this1,Float rads){
            	...
            	HX_STACK_ARG(rads,"rads")
HXLINE( 891)
HXLINE( 892)		HX_VARI( Float,len) = ::Math_obj::sqrt(((this1->x * this1->x) + (this1->y * this1->y)));

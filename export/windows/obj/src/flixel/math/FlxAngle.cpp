...
HXLINE( 209)				degrees = 90;
            			...
            			break;
            			default:{
HXLINE( 215)				HX_VARI( int,f) = FacingBitmask;
HXDLIN( 215)				if ((f == 257)) {
HXLINE( 209)					degrees = -135;
            				}
            				else {
HXLINE( 216)					HX_VARI( int,f) = FacingBitmask;
HXDLIN( 216)					if ((f == 272)) {
HXLINE( 209)						degrees = -45;
            					}
            					else {
HXLINE( 217)						HX_VARI( int,f) = FacingBitmask;
HXDLIN( 217)						if ((f == 4097)) {
HXLINE( 209)							degrees = 135;
            						}
            						else {
HXLINE( 218)							HX_VARI( int,f) = FacingBitmask;

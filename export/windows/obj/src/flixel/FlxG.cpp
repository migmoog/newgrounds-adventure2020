...
HXLINE( 416)		HX_VARI(  ::flixel::_hx_system::FlxQuadTree,quadTree) = ::flixel::_hx_system::FlxQuadTree_obj::recycle(::flixel::FlxG_obj::worldBounds->x,::flixel::FlxG_obj::worldBounds->y,::flixel::FlxG_obj::worldBounds->width,::flixel::FlxG_obj::worldBounds->height,null());
HXLINE( 417)		quadTree->load(ObjectOrGroup1,ObjectOrGroup2,NotifyCallback,ProcessCallback);
HXLINE( 418)		HX_VARI( bool,result) = quadTree->execute();
...
HXLINE( 474)
HXLINE( 475)		HX_VARI( int,index) = ::flixel::FlxG_obj::game->getChildIndex(::flixel::FlxG_obj::game->_inputContainer);
HXLINE( 476)		HX_VARI( int,max) = ::flixel::FlxG_obj::game->get_numChildren();
...
HXLINE( 560)
HXLINE( 561)		HX_VARI( ::String,prefix) = HX_("",00,00,00,00);
...
HXDLIN( 102)		VERSION =  ::flixel::_hx_system::FlxVersion_obj::__alloc( HX_CTX ,4,8,0);
            	}
{

...
HXLINE( 208)		HX_VAR( ::Array< ::String >,columns);
HXLINE( 210)		HX_VARI(  ::EReg,regex) =  ::EReg_obj::__alloc( HX_CTX ,HX_("[ \t]*((\r\n)|\r|\n)[ \t]*",22,2c,8d,6d),HX_("g",67,00,00,00));
HXLINE( 211)		HX_VARI( ::Array< ::String >,lines) = regex->split(MapData);
...
HXDLIN( 212)		HX_VARI( ::Array< ::String >,rows) = _g;
HXLINE( 214)		this->heightInTiles = rows->length;
HXLINE( 215)		this->widthInTiles = 0;
HXLINE( 217)		HX_VARI( int,row) = 0;
HXLINE( 218)		while((row < this->heightInTiles)){
HXLINE( 220)			HX_VARI( ::String,rowString) = rows->__get(row);
...
HXLINE( 235)			HX_VARI( int,column) = 0;
HXLINE( 236)			while((column < this->widthInTiles)){
HXLINE( 239)				HX_VARI( ::String,columnString) = columns->__get(column);
HXLINE( 240)				HX_VARI(  ::Dynamic,curTile) = ::Std_obj::parseInt(columnString);
...
HX_DEFINE_DYNAMIC_FUNC8(FlxBaseTilemap_obj,loadMapFrom2DArray,return )
 ...
 ::flixel::tile::FlxBaseTilemap FlxBaseTilemap_obj::loadMapFromGraphic( ::Dynamic MapGraphic,::hx::Null< bool >  __o_Invert,::hx::Null< int >  __o_Scale,::Array< int > ColorMap, ::Dynamic TileGraphic,::hx::Null< int >  __o_TileWidth,::hx::Null< int >  __o_TileHeight, ::flixel::tile::FlxTilemapAutoTiling AutoTile,::hx::Null< int >  __o_StartingIndex,::hx::Null< int >  __o_DrawIndex,::hx::Null< int >  __o_CollideIndex){
            	...
            	HX_STACK_ARG(CollideIndex,"CollideIndex")
HXLINE( 341)
HXLINE( 342)		HX_VARI(  ::openfl::display::BitmapData,mapBitmap) = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(MapGraphic);
HXLINE( 343)		HX_VARI( ::String,mapData) = ::flixel::util::FlxStringUtil_obj::bitmapToCSV(mapBitmap,Invert,Scale,ColorMap);
...
void FlxBaseTilemap_obj::applyCustomRemap(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 399)
HXLINE( 400)		HX_VARI( int,i) = 0;
HXLINE( 402)		if (::hx::IsNotNull( this->customTileRemap )) {
HXLINE( 404)			while((i < this->totalTiles)){
HXLINE( 406)				HX_VARI( int,oldIndex) = this->_data->__get(i);
HXLINE( 407)				HX_VARI( int,newIndex) = oldIndex;
...
void FlxBaseTilemap_obj::randomizeIndices(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 419)
HXLINE( 420)		HX_VARI( int,i) = 0;
HXLINE( 422)		if (::hx::IsNotNull( this->_randomIndices )) {
HXLINE( 424)			HX_VAR(  ::Dynamic,randLambda);
...
HXLINE( 431)				HX_VARI( int,oldIndex) = this->_data->__get(i);
HXLINE( 432)				HX_VARI( int,j) = 0;
HXLINE( 433)				HX_VARI( int,newIndex) = oldIndex;
HXLINE( 434)				{
HXLINE( 434)					int _g = 0;
HXDLIN( 434)					::Array< int > _g1 = this->_randomIndices;
HXDLIN( 434)					while((_g < _g1->length)){
HXLINE( 434)						HX_VARI( int,rand) = _g1->__get(_g);
HXDLIN( 434)						_g = (_g + 1);
HXLINE( 436)						if ((oldIndex == rand)) {
HXLINE( 438)							Float k = ( (Float)(randLambda()) );
HXDLIN( 438)							HX_VARI( int,k1) = ::Std_obj::_hx_int((k * ( (Float)(this->_randomChoices->__get(j).StaticCast< ::Array< int > >()->length) )));
...
HXLINE( 529)		HX_VARI( bool,wallUp) = ((Index - this->widthInTiles) < 0);
HXLINE( 530)		HX_VARI( bool,wallRight) = (::hx::Mod(Index,this->widthInTiles) >= (this->widthInTiles - 1));
HXLINE( 531)		int wallDown = ::Std_obj::_hx_int(( (Float)((Index + this->widthInTiles)) ));
HXDLIN( 531)		HX_VARI( bool,wallDown1) = (wallDown >= this->totalTiles);
HXLINE( 532)		HX_VARI( bool,wallLeft) = (::hx::Mod(Index,this->widthInTiles) <= 0);
HXLINE( 534)		HX_VAR( bool,up);
...
HXLINE( 535)		HX_VAR( bool,upRight);
...
HXLINE( 537)		HX_VAR( bool,rightDown);
...
HXLINE( 539)		HX_VAR( bool,downLeft);
...
::Array< int > FlxBaseTilemap_obj::getTileInstances(int Index){
            	...
            	HX_STACK_ARG(Index,"Index")
HXLINE( 627)
HXLINE( 628)		HX_VARI( ::Array< int >,array) = null();
HXLINE( 629)		HX_VARI( int,i) = 0;
HXLINE( 630)		HX_VARI( int,l) = (this->widthInTiles * this->heightInTiles);
...
HXLINE( 682)		HX_VARI( bool,ok) = true;
...
HXLINE( 699)		HX_VAR( int,i);
HXLINE( 700)		HX_VARI( int,row) = (::Std_obj::_hx_int((( (Float)(Index) ) / ( (Float)(this->widthInTiles) ))) - 1);
HXLINE( 701)		HX_VARI( int,rowLength) = (row + 3);
HXLINE( 702)		HX_VARI( int,column) = (::hx::Mod(Index,this->widthInTiles) - 1);
HXLINE( 703)		HX_VARI( int,columnHeight) = (column + 3);
...
HXLINE( 743)		HX_VAR(  ::Dynamic,tile);
HXLINE( 744)		HX_VARI( int,i) = Tile;
HXLINE( 745)		HX_VARI( int,l) = (Tile + Range);
HXLINE( 747)		HX_VARI( int,maxIndex) = this->_tileObjects->get_length();
...
HXLINE( 776)		HX_VARI( int,i) = 0;
HXLINE( 777)		HX_VARI( int,l) = this->_data->length;
HXLINE( 778)		HX_VARI( ::Array< int >,data) = ::Array_obj< int >::__new();
...
HXLINE( 803)
HXLINE( 805)		HX_VARI( int,startIndex) = this->getTileIndexByCoords(Start);
HXLINE( 806)		HX_VARI( int,endIndex) = this->getTileIndexByCoords(End);
...
HXLINE( 819)		HX_VARI( ::Array< int >,distances) = this->computePathDistance(startIndex,endIndex,DiagonalPolicy,null());
HXLINE( 821)		if (::hx::IsNull( distances )) {
HXLINE( 823)			return null();
            		}
HXLINE( 827)		HX_VARI( ::Array< ::Dynamic>,points) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 828)		this->walkPath(distances,endIndex,points);
HXLINE( 831)		HX_VARI(  ::flixel::math::FlxPoint,node) = points->__get((points->length - 1)).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE( 833)		{
...
HXLINE( 848)		HX_VARI( ::Array< ::Dynamic>,path) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 849)		HX_VARI( int,i) = (points->length - 1);
...
HXLINE( 875)
HXLINE( 878)		HX_VARI( int,mapSize) = (this->widthInTiles * this->heightInTiles);
HXLINE( 879)		HX_VARI( ::Array< int >,distances) = ::Array_obj< int >::__new();
HXLINE( 880)		::flixel::util::FlxArrayUtil_obj::setLength_Int(distances,mapSize);
HXLINE( 881)		HX_VARI( int,i) = 0;
...
HXLINE( 897)		HX_VARI( int,distance) = 1;
HXLINE( 898)		HX_VARI( ::Array< int >,neighbors) = ::Array_obj< int >::__new(1)->init(0,StartIndex);
HXLINE( 899)		HX_VAR( ::Array< int >,current);
HXLINE( 900)		HX_VAR( int,currentIndex);
HXLINE( 901)		HX_VAR( bool,left);
HXLINE( 902)		HX_VAR( bool,right);
HXLINE( 903)		HX_VAR( bool,up);
HXLINE( 904)		HX_VAR( bool,down);
HXLINE( 905)		HX_VAR( int,currentLength);
HXLINE( 906)		HX_VARI( bool,foundEnd) = false;
...
HXLINE( 980)					HX_VARI( bool,wideDiagonal) = (DiagonalPolicy == 2);
...
HXLINE(1083)		HX_VARI( bool,left) = (::hx::Mod(Start,this->widthInTiles) > 0);
HXLINE(1084)		HX_VARI( bool,right) = (::hx::Mod(Start,this->widthInTiles) < (this->widthInTiles - 1));
HXLINE(1085)		HX_VARI( bool,up) = ((( (Float)(Start) ) / ( (Float)(this->widthInTiles) )) > 0);
HXLINE(1086)		HX_VARI( bool,down) = ((( (Float)(Start) ) / ( (Float)(this->widthInTiles) )) < (this->heightInTiles - 1));
HXLINE(1088)		HX_VARI( int,current) = Data->__get(Start);
HXLINE(1089)		HX_VAR( int,i);
HXLINE(1091)		if (up) {
...
void FlxBaseTilemap_obj::simplifyPath(::Array< ::Dynamic> Points){
            	...
            	HX_STACK_ARG(Points,"Points")
HXLINE(1173)
HXLINE(1174)		HX_VAR( Float,deltaPrevious);
HXLINE(1175)		HX_VAR( Float,deltaNext);
HXLINE(1176)		HX_VARI(  ::flixel::math::FlxPoint,last) = Points->__get(0).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE(1177)		HX_VAR(  ::flixel::math::FlxPoint,node);
HXLINE(1178)		HX_VARI( int,i) = 1;
HXLINE(1179)		HX_VARI( int,l) = (Points->length - 1);
...
void FlxBaseTilemap_obj::raySimplifyPath(::Array< ::Dynamic> Points){
            	...
            	HX_STACK_ARG(Points,"Points")
HXLINE(1206)
HXLINE(1207)		HX_VARI(  ::flixel::math::FlxPoint,source) = Points->__get(0).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE(1208)		HX_VARI( int,lastIndex) = -1;
HXLINE(1209)		HX_VAR(  ::flixel::math::FlxPoint,node);
HXLINE(1210)		HX_VARI( int,i) = 1;
HXLINE(1211)		HX_VARI( int,l) = Points->length;
...
HXLINE(1250)
HXLINE(1251)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(ObjectOrGroup);
...
bool FlxBaseTilemap_obj::overlapsAt(Float X,Float Y, ::flixel::FlxBasic ObjectOrGroup,::hx::Null< bool >  __o_InScreenSpace, ::flixel::FlxCamera Camera){
            	...
            	HX_STACK_ARG(Camera,"Camera")
HXLINE(1289)
HXLINE(1290)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(ObjectOrGroup);
...
HXLINE(1338)
HXLINE(1339)		HX_VARI( int,tileIndex) = this->getTileIndexByCoords(point);

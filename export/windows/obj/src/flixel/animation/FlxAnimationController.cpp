...
HXLINE( 107)		{
HXLINE( 107)			HX_VARI(  ::Dynamic,anim) = controller->_animations->iterator();
HXDLIN( 107)			while(( (bool)(anim->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 107)				HX_VARI(  ::flixel::animation::FlxAnimation,anim1) = ( ( ::flixel::animation::FlxAnimation)(anim->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 162)			HX_VAR(  ::flixel::animation::FlxAnimation,anim);
HXLINE( 163)			{
HXLINE( 163)				HX_VARI(  ::Dynamic,key) = this->_animations->keys();
HXDLIN( 163)				while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 163)					HX_VARI( ::String,key1) = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 188)
HXLINE( 190)		HX_VARI( ::Array< int >,framesToAdd) = Frames;
HXLINE( 191)		HX_VARI( int,numFrames) = (framesToAdd->length - 1);
HXLINE( 192)		HX_VARI( int,i) = numFrames;
...
HXLINE( 211)			HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,framesToAdd,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::remove(::String Name){
            	...
            	HX_STACK_ARG(Name,"Name")
HXLINE( 222)
HXLINE( 223)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
void FlxAnimationController_obj::append(::String Name,::Array< int > Frames){
            	...
            	HX_STACK_ARG(Frames,"Frames")
HXLINE( 240)
HXLINE( 241)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
HXLINE( 250)		HX_VARI( int,numFrames) = (Frames->length - 1);
HXLINE( 251)		HX_VARI( int,i) = numFrames;
...
HXLINE( 277)			HX_VARI( ::Array< int >,indices) = ::Array_obj< int >::__new();
HXLINE( 278)			this->byNamesHelper(indices,FrameNames);
HXLINE( 280)			if ((indices->length > 0)) {
HXLINE( 282)				HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,indices,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::appendByNames(::String Name,::Array< ::String > FrameNames){
            	...
            	HX_STACK_ARG(FrameNames,"FrameNames")
HXLINE( 297)
HXLINE( 298)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
HXLINE( 329)			HX_VARI( ::Array< int >,frameIndices) = ::Array_obj< int >::__new();
HXLINE( 331)			this->byStringIndicesHelper(frameIndices,Prefix,Indices,Postfix);
HXLINE( 333)			if ((frameIndices->length > 0)) {
HXLINE( 335)				HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,frameIndices,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::appendByStringIndices(::String Name,::String Prefix,::Array< ::String > Indices,::String Postfix){
            	...
            	HX_STACK_ARG(Postfix,"Postfix")
HXLINE( 353)
HXLINE( 354)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
HXLINE( 385)			HX_VARI( ::Array< int >,frameIndices) = ::Array_obj< int >::__new();
HXLINE( 387)			this->byIndicesHelper(frameIndices,Prefix,Indices,Postfix);
HXLINE( 389)			if ((frameIndices->length > 0)) {
HXLINE( 391)				HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,frameIndices,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::appendByIndices(::String Name,::String Prefix,::Array< int > Indices,::String Postfix){
            	...
            	HX_STACK_ARG(Postfix,"Postfix")
HXLINE( 410)
HXLINE( 411)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
int FlxAnimationController_obj::findSpriteFrame(::String Prefix,int Index,::String Postfix){
            	...
            	HX_STACK_ARG(Postfix,"Postfix")
HXLINE( 432)
HXLINE( 433)		HX_VARI( int,numFrames) = this->_sprite->numFrames;
HXLINE( 434)		HX_VARI( ::Array< ::Dynamic>,flxFrames) = this->_sprite->frames->frames;
HXLINE( 435)		{
HXLINE( 435)			int _g = 0;
...
HXLINE( 437)				HX_VARI( ::String,name) = flxFrames->__get(i).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->name;
...
HXLINE( 440)					HX_VARI(  ::Dynamic,index) = ::Std_obj::parseInt(name.substring(Prefix.length,(name.length - Postfix.length)));
...
HXLINE( 465)			HX_VARI( ::Array< ::Dynamic>,animFrames) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 466)			this->findByPrefix(animFrames,Prefix);
HXLINE( 468)			if ((animFrames->length > 0)) {
HXLINE( 470)				HX_VARI( ::Array< int >,frameIndices) = ::Array_obj< int >::__new();
HXLINE( 471)				this->byPrefixHelper(frameIndices,animFrames,Prefix);
HXLINE( 473)				if ((frameIndices->length > 0)) {
HXLINE( 475)					HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,frameIndices,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::appendByPrefix(::String Name,::String Prefix){
            	...
            	HX_STACK_ARG(Prefix,"Prefix")
HXLINE( 493)
HXLINE( 494)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
HXLINE( 503)			HX_VARI( ::Array< ::Dynamic>,animFrames) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 541)		HX_VARI( bool,oldFlipX) = false;
HXLINE( 542)		HX_VARI( bool,oldFlipY) = false;
...
HXDLIN( 668)			HX_VARI( ::String,frameName) = FrameNames->__get(_g);
HXDLIN( 668)			_g = (_g + 1);
HXLINE( 670)			if (this->_sprite->frames->framesHash->exists(frameName)) {
HXLINE( 672)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frameToAdd) = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesHash->get(frameName)) );
...
HXDLIN( 680)			HX_VARI( ::String,index) = Indices->__get(_g);
HXDLIN( 680)			_g = (_g + 1);
HXLINE( 682)			HX_VARI( ::String,name) = ((Prefix + index) + Postfix);
HXLINE( 683)			if (this->_sprite->frames->framesHash->exists(name)) {
HXLINE( 685)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frameToAdd) = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesHash->get(name)) );
...
HXDLIN( 693)			HX_VARI( int,index) = Indices->__get(_g);
HXDLIN( 693)			_g = (_g + 1);
HXLINE( 695)			HX_VARI( int,indexToAdd) = this->findSpriteFrame(Prefix,index,Postfix);
...
void FlxAnimationController_obj::byPrefixHelper(::Array< int > AddTo,::Array< ::Dynamic> AnimFrames,::String Prefix){
            	...
            	HX_STACK_ARG(Prefix,"Prefix")
HXLINE( 704)
HXLINE( 705)		HX_VARI( ::String,name) = AnimFrames->__get(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->name;
HXLINE( 706)		HX_VARI( int,postIndex) = name.indexOf(HX_(".",2e,00,00,00),Prefix.length);
...
HXDLIN( 707)		HX_VARI( ::String,postFix1) = name.substring(postFix,name.length);
...
HXLINE( 710)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,animFrame) = AnimFrames->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 710)				_g = (_g + 1);
...
HXDLIN( 718)			HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 718)			_g = (_g + 1);
...
HXLINE( 755)			HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesHash->get(Value)) );
...
::String FlxAnimationController_obj::get_name(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 766)
HXLINE( 767)		HX_VARI( ::String,animName) = null();
...
bool FlxAnimationController_obj::get_paused(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 804)
HXLINE( 805)		HX_VARI( bool,paused) = false;
...
bool FlxAnimationController_obj::get_finished(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 830)
HXLINE( 831)		HX_VARI( bool,finished) = true;

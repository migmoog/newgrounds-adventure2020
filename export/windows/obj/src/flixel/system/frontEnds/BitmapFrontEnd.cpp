...
void BitmapFrontEnd_obj::onAssetsReload( ::Dynamic _){
            	...
            	HX_STACK_ARG(_,"_")
HXLINE(  51)
HXDLIN(  51)		HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN(  51)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN(  51)			HX_VARI( ::String,key1) = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  53)			HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
void BitmapFrontEnd_obj::onContext(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  67)
HXDLIN(  67)		HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN(  67)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN(  67)			HX_VARI( ::String,key1) = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  69)			HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
void BitmapFrontEnd_obj::dumpCache(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  84)
HXDLIN(  84)		HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN(  84)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN(  84)			HX_VARI( ::String,key1) = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  86)			HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
void BitmapFrontEnd_obj::undumpCache(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 101)
HXDLIN( 101)		HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN( 101)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 101)			HX_VARI( ::String,key1) = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 103)			HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
HXLINE( 193)
HXLINE( 194)		{
HXLINE( 194)			HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN( 194)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 194)				HX_VARI( ::String,key1) = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 196)				HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
::String BitmapFrontEnd_obj::generateKey(::String systemKey,::String userKey,::hx::Null< bool >  __o_unique){
            	...
            	HX_STACK_ARG(unique,"unique")
HXLINE( 223)
HXLINE( 224)		HX_VARI( ::String,key) = userKey;
...
HXLINE( 248)		HX_VARI( int,i) = this->_lastUniqueKeyIndex;
HXLINE( 249)		HX_VAR( ::String,uniqueKey);
...
HXLINE( 272)
HXLINE( 273)		HX_VARI( ::String,result) = baseKey;
...
HXLINE( 311)			HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key)) );
...
HXLINE( 337)		{
HXLINE( 337)			HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN( 337)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 337)				HX_VARI( ::String,key1) = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 339)				HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
HXLINE( 368)		{
HXLINE( 368)			HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN( 368)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 368)				HX_VARI( ::String,key1) = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 370)				HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
void BitmapFrontEnd_obj::clearUnused(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 384)
HXDLIN( 384)		HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN( 384)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 384)			HX_VARI( ::String,key1) = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 386)			HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
HXLINE( 405)			HX_VARI(  ::openfl::display::BitmapData,bd) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,10,10,true,-1);
HXLINE( 406)			HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->add(bd,true,HX_("whitePixels",b6,92,ba,9e));

...
HX_DEFINE_DYNAMIC_FUNC1(PluginFrontEnd_obj,get,return )
 ...
 ::flixel::FlxBasic PluginFrontEnd_obj::remove( ::flixel::FlxBasic Plugin){
            	...
            	HX_STACK_ARG(Plugin,"Plugin")
HXLINE(  63)
HXLINE(  65)		HX_VARI( int,i) = (this->list->length - 1);
HXLINE(  67)		while((i >= 0)){
...
HXLINE(  90)		HX_VARI( int,i) = (this->list->length - 1);
HXLINE(  92)		while((i >= 0)){
...
HXDLIN( 118)			HX_VARI(  ::flixel::FlxBasic,plugin) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN( 118)			_g = (_g + 1);
...
HXDLIN( 133)			HX_VARI(  ::flixel::FlxBasic,plugin) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN( 133)			_g = (_g + 1);

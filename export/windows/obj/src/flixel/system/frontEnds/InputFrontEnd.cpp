...
HXDLIN(  96)			HX_VARI( ::Dynamic,input) = _g1->__get(_g);
HXDLIN(  96)			_g = (_g + 1);
...
HXDLIN( 108)			HX_VARI( ::Dynamic,input) = _g1->__get(_g);
HXDLIN( 108)			_g = (_g + 1);
...
HXDLIN( 117)			HX_VARI( ::Dynamic,input) = _g1->__get(_g);
HXDLIN( 117)			_g = (_g + 1);
...
HXDLIN( 126)			HX_VARI( ::Dynamic,input) = _g1->__get(_g);
HXDLIN( 126)			_g = (_g + 1);
...
HXDLIN( 144)			HX_VARI( ::Dynamic,input) = _g1->__get(_g);
HXDLIN( 144)			_g = (_g + 1);

...
HXLINE( 174)			{
HXLINE( 174)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile19 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::flixel::input::gamepad::FlxGamepad >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_32,8),null());
HXDLIN( 174)				if (::hx::IsNotNull( Profile19 )) {
HXLINE( 174)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 174)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile19);
            				}
            			}
HXLINE( 181)			{
HXLINE( 181)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile20 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::openfl::display::DisplayObject >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_33,8),::Array_obj< ::Dynamic>::__new(1)->init(0,::hx::ClassOf< ::flixel::math::FlxRect >()));
HXDLIN( 181)				if (::hx::IsNotNull( Profile20 )) {
HXLINE( 181)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 181)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile20);
            				}
            			}
HXLINE( 182)			{
HXLINE( 182)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile21 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::openfl::geom::Point >(),null(),::Array_obj< ::Dynamic>::__new(1)->init(0,::hx::ClassOf< ::flixel::math::FlxPoint >()));
HXDLIN( 182)				if (::hx::IsNotNull( Profile21 )) {
HXLINE( 182)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 182)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile21);
            				}
            			}
HXLINE( 183)			{
HXLINE( 183)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile22 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::openfl::geom::Rectangle >(),null(),::Array_obj< ::Dynamic>::__new(1)->init(0,::hx::ClassOf< ::flixel::math::FlxRect >()));
...
HXLINE( 184)			{
HXLINE( 184)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile23 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::openfl::geom::Matrix >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_34,6),null());
HXDLIN( 184)				if (::hx::IsNotNull( Profile23 )) {
HXLINE( 184)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 184)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile23);
            				}
            			}
            		}
            	}

...
HXDLIN(  94)					HX_VARI(  ::Dynamic,object) = _g->_hx_getObject(0);
...
HXDLIN( 111)		switch((int)(_g->_hx_getIndex())){
            			case (int)0: {
HXLINE( 113)				HX_VARI( ::String,field) = _g->_hx_getString(1);
HXDLIN( 113)				HX_VARI(  ::Dynamic,object) = _g->_hx_getObject(0);
...
HXLINE( 138)			HX_VARI( ::String,field) = _g->_hx_getString(1);
HXDLIN( 138)			HX_VARI(  ::Dynamic,object) = _g->_hx_getObject(0);

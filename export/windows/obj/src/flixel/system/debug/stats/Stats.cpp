...
HXLINE( 125)		HX_VARI( int,gutter) = 5;
HXLINE( 126)		HX_VARI( int,graphX) = gutter;
HXLINE( 127)		HX_VARI( int,graphY) = (::Std_obj::_hx_int(this->_header->get_height()) + gutter);
HXLINE( 128)		HX_VARI( int,graphHeight) = 40;
HXLINE( 129)		HX_VARI( int,graphWidth) = 140;
...
HXLINE( 161)		HX_VARI( ::String,drawMethod) = HX_("",00,00,00,00);
...
HXLINE( 254)		HX_VARI( int,time) = (this->_currentTime = ::flixel::FlxG_obj::game->ticks);
HXLINE( 256)		HX_VARI( int,elapsed) = (time - this->_lastTime);
...
HXDLIN( 283)					HX_VARI( int,i) = (_g2 - 1);
...
HXDLIN( 290)					HX_VARI( int,i) = (_g4 - 1);
...
HXDLIN( 295)					HX_VARI( int,i) = (_g6 - 1);
...
void Stats_obj::updateTexts(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 324)
HXLINE( 325)		HX_VARI( Float,updTime) = ::flixel::math::FlxMath_obj::roundDecimal(this->divide(( (Float)(this->updateTime) ),( (Float)(this->_updateMarker) )),1);
HXLINE( 326)		HX_VARI( Float,drwTime) = ::flixel::math::FlxMath_obj::roundDecimal(this->divide(( (Float)(this->drawTime) ),( (Float)(this->_drawMarker) )),1);

...
HXLINE( 100)
HXLINE( 106)		HX_VARI( Float,offsetX) = ((Float)0.0);
HXLINE( 107)		HX_VARI( Float,offsetY) = ((Float)0.0);
HXLINE( 111)		if (::hx::IsNotNull( this->activeTool )) {
HXLINE( 113)			HX_VARI(  ::openfl::display::BitmapData,cursorIcon) = this->activeTool->cursor;
...
int Interaction_obj::countToolsWithUIButton(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 187)
HXLINE( 188)		HX_VARI( int,count) = 0;
HXLINE( 189)		{
HXLINE( 189)			int _g = 0;
HXDLIN( 189)			::Array< ::Dynamic> _g1 = this->_tools;
HXDLIN( 189)			while((_g < _g1->length)){
HXLINE( 189)				HX_VARI(  ::flixel::_hx_system::debug::interaction::tools::Tool,tool) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::interaction::tools::Tool >();
HXDLIN( 189)				_g = (_g + 1);
...
HXLINE( 213)		HX_VARI(  ::flixel::_hx_system::ui::FlxSystemButton,button) = tool->button;
HXLINE( 214)		if (::hx::IsNull( button )) {
HXLINE( 215)			return;
            		}
HXLINE( 217)		HX_VARI( int,buttonsPerLine) = 2;
HXLINE( 218)		HX_VARI( int,buttons) = this->countToolsWithUIButton();
HXLINE( 219)		HX_VARI( int,lines) = ::Std_obj::_hx_int(( (Float)(::Math_obj::ceil((( (Float)(buttons) ) / ( (Float)(buttonsPerLine) )))) ));
HXLINE( 220)		HX_VARI( int,slot) = ::Std_obj::_hx_int((( (Float)(buttons) ) / ( (Float)(lines) )));
...
HXLINE( 275)				HX_VARI(  ::flixel::_hx_system::debug::interaction::tools::Tool,tool) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::interaction::tools::Tool >();
HXDLIN( 275)				_g = (_g + 1);
...
HXLINE( 291)				HX_VARI(  ::flixel::_hx_system::debug::interaction::tools::Tool,tool) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::interaction::tools::Tool >();
HXDLIN( 291)				_g = (_g + 1);
...
void Interaction_obj::drawItemsSelection(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 314)
HXLINE( 315)		HX_VARI(  ::openfl::display::Graphics,gfx) = this->getDebugGraphics();
HXLINE( 316)		if (::hx::IsNull( gfx )) {
HXLINE( 317)			return;
            		}
HXLINE( 319)		{
HXLINE( 319)			 ::Dynamic filter = null();
HXDLIN( 319)			HX_VARI(  ::flixel::group::FlxTypedGroupIterator,member) =  ::flixel::group::FlxTypedGroupIterator_obj::__alloc( HX_CTX ,this->selectedItems->members,filter);
HXDLIN( 319)			while(member->hasNext()){
HXLINE( 319)				HX_VARI(  ::flixel::FlxObject,member1) = member->next().StaticCast<  ::flixel::FlxObject >();
...
HXLINE( 344)				HX_VARI(  ::flixel::_hx_system::debug::interaction::tools::Tool,tool) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::interaction::tools::Tool >();
HXDLIN( 344)				_g = (_g + 1);
...
HXLINE( 370)		HX_VARI(  ::openfl::display::Sprite,sprite) =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
...
void Interaction_obj::findItemsWithinArea(::Array< ::Dynamic> items,::Array< ::Dynamic> members, ::flixel::math::FlxRect area){
            	...
            	HX_STACK_ARG(area,"area")
HXLINE( 549)
HXLINE( 551)		HX_VARI( int,i) = members->length;
HXLINE( 552)		while(true){
HXLINE( 552)			i = (i - 1);
HXDLIN( 552)			if (!(((i + 1) > 0))) {
HXLINE( 552)				goto _hx_goto_35;
            			}
HXLINE( 554)			HX_VARI(  ::flixel::FlxBasic,member) = members->__get(i).StaticCast<  ::flixel::FlxBasic >();
...
HXLINE( 559)			HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(member);

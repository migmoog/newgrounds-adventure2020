...
HXLINE( 288)		HX_VARI( Float,radialMultiplier) = ((Float)1.0);
HXLINE( 291)		if (::hx::IsNotNull( this->_target )) {
HXLINE( 293)			HX_VARI(  ::flixel::math::FlxPoint,targetPosition) = this->_target->getPosition(null());
...
HXLINE( 300)				HX_VARI( Float,d) = ((this->x - this->_target->x) / this->_radius);
...
HXLINE( 688)			HX_VARI(  ::flixel::_hx_system::FlxSoundGroup,oldGroup) = this->group;

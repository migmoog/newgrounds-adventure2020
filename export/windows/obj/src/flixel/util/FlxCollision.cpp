...
HXDLIN(  67)			HX_VARI( Float,lengthA) = ::Math_obj::sqrt(((this1->x * this1->x) + (this1->y * this1->y)));
...
HXDLIN(  73)			HX_VARI( Float,lengthB) = ::Math_obj::sqrt(((this2->x * this2->x) + (this2->y * this2->y)));
...
HXLINE( 130)			HX_VARI(  ::openfl::display::BitmapData,testA2) = ::flixel::util::FlxBitmapDataPool_obj::get(::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsA->width),::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsA->height),true,0,false);
...
HXLINE( 142)			HX_VARI(  ::openfl::display::BitmapData,testB2) = ::flixel::util::FlxBitmapDataPool_obj::get(::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsB->width),::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsB->height),true,0,false);
...
HXLINE( 236)		HX_VARI(  ::openfl::display::BitmapData,test) = Target->framePixels;
HXLINE( 238)		HX_VARI( int,pixelAlpha) = ((::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(test->getPixel32(::Math_obj::floor((( (Float)(PointX) ) - Target->x)),::Math_obj::floor((( (Float)(PointY) ) - Target->y)))) >> 24) & 255);
...
HXLINE( 259)
HXLINE( 260)		HX_VARI(  ::flixel::tile::FlxTileblock,left) = null();
HXLINE( 261)		HX_VARI(  ::flixel::tile::FlxTileblock,right) = null();
HXLINE( 262)		HX_VARI(  ::flixel::tile::FlxTileblock,top) = null();
HXLINE( 263)		HX_VARI(  ::flixel::tile::FlxTileblock,bottom) = null();

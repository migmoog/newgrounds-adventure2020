...
HXLINE(  56)
HXLINE(  57)		HX_VARI(  ::openfl::display::BitmapData,data) = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(source);
HXLINE(  58)		HX_VARI(  ::openfl::display::BitmapData,maskData) = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(mask);
...
HXLINE(  87)		HX_VARI(  ::openfl::display::BitmapData,data) = sprite->get_pixels()->clone();
...
HXLINE( 170)
HXLINE( 171)		HX_VARI( Float,prevWidth) = ( (Float)(0) );
HXLINE( 172)		HX_VARI( Float,runningX) = ( (Float)(0) );
...
HXLINE( 187)		HX_VARI( Float,prevHeight) = ( (Float)(0) );
HXLINE( 188)		HX_VARI( Float,runningY) = ( (Float)(0) );
...
HXLINE( 213)		HX_VARI( Float,curX) = ( (Float)(0) );
HXLINE( 214)		HX_VARI( Float,curY) = ( (Float)(0) );
HXLINE( 216)		{
HXLINE( 216)			int _g = 1;
HXDLIN( 216)			int _g1 = objects->length;
HXDLIN( 216)			while((_g < _g1)){
HXLINE( 216)				_g = (_g + 1);
HXDLIN( 216)				HX_VARI( int,i) = (_g - 1);
HXLINE( 218)				HX_VARI(  ::flixel::FlxObject,object) = objects->__get(i).StaticCast<  ::flixel::FlxObject >();
...
HXLINE( 400)			HX_VARI(  ::flixel::math::FlxPoint,midPoint) = sprite->getGraphicMidpoint(null());
HXLINE( 402)			if ((X == -1)) {
...
HXLINE( 412)			HX_VARI( Float,minVal) = ::Math_obj::min(( (Float)(sprite->frameWidth) ),( (Float)(sprite->frameHeight) ));
...
HXLINE( 482)		HX_VARI(  ::flixel::math::FlxPoint,p) = Vertices->shift().StaticCast<  ::flixel::math::FlxPoint >();
HXLINE( 483)		::flixel::util::FlxSpriteUtil_obj::flashGfx->moveTo(p->x,p->y);
HXLINE( 484)		{
HXLINE( 484)			int _g = 0;
HXDLIN( 484)			while((_g < Vertices->length)){
HXLINE( 484)				HX_VARI(  ::flixel::math::FlxPoint,p) = Vertices->__get(_g).StaticCast<  ::flixel::math::FlxPoint >();
HXDLIN( 484)				_g = (_g + 1);
...
HXLINE( 560)			HX_VAR(  ::Dynamic,color);

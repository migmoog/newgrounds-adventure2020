...
HXLINE( 124)		HX_VARI(  ::openfl::display::BitmapData,data) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,height,true,0);
...
HXDLIN( 132)			HX_VARI(  ::openfl::display::Bitmap,tempBitmap2) =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,::Std_obj::_hx_int((tempBitmap / tempBitmap1)),true,0),null(),null());
...
HXLINE( 136)			HX_VARI(  ::openfl::geom::Matrix,sM) =  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
...
HXLINE( 173)		HX_VARI(  ::flixel::FlxSprite,source) = ::flixel::util::FlxGradient_obj::createGradientFlxSprite(width,height,colors,chunkSize,rotation,interpolate);
...
HXLINE( 207)		HX_VARI(  ::openfl::display::BitmapData,source) = ::flixel::util::FlxGradient_obj::createGradientBitmapData(width,height,colors,chunkSize,rotation,interpolate);

...
HXLINE( 299)				HX_VARI( int,markerLength) = ::_UnicodeString::UnicodeString_Impl__obj::get_length(rule->marker);
...
HXDLIN( 305)						HX_VARI( int,charIndex) = (_g1 - 1);
...
HXLINE( 333)				HX_VARI(  ::flixel::text::FlxTextFormatMarkerPair,rule) = rules->__get(_g1).StaticCast<  ::flixel::text::FlxTextFormatMarkerPair >();
...
HXDLIN( 337)				HX_VARI( int,i) = (_g2 - 1);
HXLINE( 340)				HX_VARI( int,delIndex) = rangeStarts->__get(i);
HXLINE( 341)				HX_VARI( int,markerLength) = ::_UnicodeString::UnicodeString_Impl__obj::get_length(rulesToApply->__get(i).StaticCast<  ::flixel::text::FlxTextFormatMarkerPair >()->marker);
HXLINE( 344)				{
HXLINE( 344)					int _g = 0;
HXDLIN( 344)					int _g1 = rangeStarts->length;
HXDLIN( 344)					while((_g < _g1)){
HXLINE( 344)						_g = (_g + 1);
HXDLIN( 344)						HX_VARI( int,j) = (_g - 1);
...
HXDLIN( 360)						HX_VARI( int,j) = (_g3 - 1);
...
HXDLIN( 377)				HX_VARI( int,i) = (_g4 - 1);
...
HX_DEFINE_DYNAMIC_FUNC3(FlxText_obj,addFormat,return )
 ...
 ::flixel::text::FlxText FlxText_obj::removeFormat( ::flixel::text::FlxTextFormat Format, ::Dynamic Start, ::Dynamic End){
            	...
            	HX_STACK_ARG(End,"End")
HXLINE( 408)
HXLINE( 409)		HX_VARI( int,i) = this->_formatRanges->length;
HXLINE( 410)		while(true){
HXLINE( 410)			i = (i - 1);
HXDLIN( 410)			if (!(((i + 1) > 0))) {
HXLINE( 410)				goto _hx_goto_14;
            			}
HXLINE( 412)			HX_VARI(  ::flixel::text::_FlxText::FlxTextFormatRange,formatRange) = this->_formatRanges->__get(i).StaticCast<  ::flixel::text::_FlxText::FlxTextFormatRange >();
...
HXLINE( 418)				HX_VARI(  ::flixel::util::helpers::FlxRange,range) = formatRange->range;
...
HXLINE( 569)			HX_VARI( ::String,ot) = this->textField->get_text();
...
HXLINE( 611)			HX_VARI( ::String,newFontName) = Font;
...
HX_DEFINE_DYNAMIC_FUNC1(FlxText_obj,set_borderQuality,return )
 ...
 ::flixel::graphics::FlxGraphic FlxText_obj::set_graphic( ::flixel::graphics::FlxGraphic Value){
            	...
            	HX_STACK_ARG(Value,"Value")
HXLINE( 737)
HXLINE( 738)		HX_VARI(  ::flixel::graphics::FlxGraphic,oldGraphic) = this->graphic;
HXLINE( 739)		HX_VARI(  ::flixel::graphics::FlxGraphic,graph) = this->super::set_graphic(Value);
...
HXLINE( 780)		HX_VARI( int,oldWidth) = 0;
HXLINE( 781)		HX_VARI( int,oldHeight) = 4;
HXLINE( 783)		if (::hx::IsNotNull( this->graphic )) {
HXLINE( 785)			oldWidth = this->graphic->width;
HXLINE( 786)			oldHeight = this->graphic->height;
            		}
HXLINE( 789)		HX_VARI( Float,newWidth) = this->textField->get_width();
HXLINE( 791)		HX_VARI( Float,newHeight) = (this->textField->get_textHeight() + 4);
...
HXLINE( 803)			HX_VARI( ::String,key) = ::flixel::FlxG_obj::bitmap->getUniqueKey(HX_("text",ad,cc,f9,4c));
...
void FlxText_obj::applyBorderStyle(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 922)
HXLINE( 923)		HX_VARI( int,iterations) = ::Std_obj::_hx_int((this->borderSize * this->borderQuality));
HXLINE( 924)		if ((iterations <= 0)) {
HXLINE( 926)			iterations = 1;
            		}
HXLINE( 928)		HX_VARI( Float,delta) = (this->borderSize / ( (Float)(iterations) ));
...
HXLINE( 949)				HX_VARI( Float,curDelta) = delta;
HXLINE( 950)				{
HXLINE( 950)					int _g = 0;
HXDLIN( 950)					int _g1 = iterations;
HXDLIN( 950)					while((_g < _g1)){
HXLINE( 950)						_g = (_g + 1);
HXDLIN( 950)						HX_VARI( int,i) = (_g - 1);
HXLINE( 952)						{
...
HXLINE( 971)				HX_VARI( Float,curDelta) = delta;
HXLINE( 972)				{
HXLINE( 972)					int _g = 0;
...
void FlxText_obj::copyTextWithOffset(Float x,Float y){
            	...
            	HX_STACK_ARG(y,"y")
HXLINE(1004)
HXLINE(1005)		HX_VAR(  ::openfl::display::BitmapData,graphic);
...
HXLINE(1018)				HX_VARI(  ::flixel::text::_FlxText::FlxTextFormatRange,formatRange) = _g1->__get(_g).StaticCast<  ::flixel::text::_FlxText::FlxTextFormatRange >();
HXDLIN(1018)				_g = (_g + 1);
...
HXLINE(1027)					HX_VARI(  ::openfl::text::TextFormat,textFormat) = formatRange->format->format;

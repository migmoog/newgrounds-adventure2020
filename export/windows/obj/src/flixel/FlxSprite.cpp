...
HXLINE( 384)
HXLINE( 385)		HX_VARI(  ::flixel::graphics::FlxGraphic,graph) = ::flixel::FlxG_obj::bitmap->add(Graphic,Unique,Key);
...
HX_DEFINE_DYNAMIC_FUNC6(FlxSprite_obj,loadGraphic,return )
 ...
 ::flixel::FlxSprite FlxSprite_obj::loadRotatedGraphic( ::Dynamic Graphic,::hx::Null< int >  __o_Rotations,::hx::Null< int >  __o_Frame,::hx::Null< bool >  __o_AntiAliasing,::hx::Null< bool >  __o_AutoBuffer,::String Key){
            	...
            	HX_STACK_ARG(Key,"Key")
HXLINE( 427)
HXLINE( 428)		HX_VARI(  ::flixel::graphics::FlxGraphic,brushGraphic) = ::flixel::FlxG_obj::bitmap->add(Graphic,false,Key);
HXLINE( 429)		if (::hx::IsNull( brushGraphic )) {
HXLINE( 430)			return ::hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE( 432)		HX_VARI(  ::openfl::display::BitmapData,brush) = brushGraphic->bitmap;
HXLINE( 433)		HX_VARI( ::String,key) = brushGraphic->key;
HXLINE( 435)		if ((Frame >= 0)) {
HXLINE( 438)			HX_VARI( int,brushSize) = brush->height;
HXLINE( 439)			HX_VARI( int,framesNum) = ::Std_obj::_hx_int((( (Float)(brush->width) ) / ( (Float)(brushSize) )));
HXLINE( 440)			if ((framesNum <= Frame)) {
HXLINE( 440)				Frame = ::hx::Mod(Frame,framesNum);
            			}
HXLINE( 441)			key = (key + (HX_(":",3a,00,00,00) + Frame));
HXLINE( 443)			HX_VARI(  ::openfl::display::BitmapData,full) = brush;
...
HXLINE( 452)		HX_VARI(  ::flixel::graphics::FlxGraphic,tempGraph) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
HXLINE( 453)		if (::hx::IsNull( tempGraph )) {
HXLINE( 455)			HX_VARI(  ::openfl::display::BitmapData,bitmap) = ::flixel::util::FlxBitmapDataUtil_obj::generateRotations(brush,Rotations,AntiAliasing,AutoBuffer);
HXLINE( 456)			tempGraph = ::flixel::graphics::FlxGraphic_obj::fromBitmapData(bitmap,false,key,null());
            		}
HXLINE( 459)		HX_VAR( int,max);
...
HX_DEFINE_DYNAMIC_FUNC6(FlxSprite_obj,loadRotatedGraphic,return )
 ...
 ::flixel::FlxSprite FlxSprite_obj::loadRotatedFrame( ::flixel::graphics::frames::FlxFrame Frame,::hx::Null< int >  __o_Rotations,::hx::Null< bool >  __o_AntiAliasing,::hx::Null< bool >  __o_AutoBuffer){
            	...
            	HX_STACK_ARG(AutoBuffer,"AutoBuffer")
HXLINE( 488)
HXLINE( 489)		HX_VARI( ::String,key) = Frame->parent->key;
...
HXLINE( 495)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
...
HX_DEFINE_DYNAMIC_FUNC4(FlxSprite_obj,loadRotatedFrame,return )
 ...
 ::flixel::FlxSprite FlxSprite_obj::makeGraphic(int Width,int Height,::hx::Null< int >  __o_Color,::hx::Null< bool >  __o_Unique,::String Key){
            	...
            	HX_STACK_ARG(Key,"Key")
HXLINE( 523)
HXLINE( 524)		HX_VARI(  ::flixel::graphics::FlxGraphic,graph) = ::flixel::FlxG_obj::bitmap->create(Width,Height,Color,Unique,Key);
...
HXLINE( 591)		HX_VARI( Float,newScaleX) = (( (Float)(Width) ) / ( (Float)(this->frameWidth) ));
HXLINE( 592)		HX_VARI( Float,newScaleY) = (( (Float)(Height) ) / ( (Float)(this->frameHeight) ));
...
HXLINE( 673)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 673)				_g = (_g + 1);
...
HXLINE( 748)		HX_VARI(  ::openfl::display::BitmapData,bitmapData) = Brush->framePixels;
...
HXLINE( 770)			HX_VARI(  ::Dynamic,brushBlend) = Brush->blend;
...
HXLINE( 839)
HXLINE( 840)		HX_VARI( ::Array< ::Dynamic>,positions) = ::flixel::util::FlxBitmapDataUtil_obj::replaceColor(this->graphic->bitmap,Color,NewColor,FetchPositions,null());
...
HXLINE( 914)			HX_VARI(  ::openfl::display::BitmapData,frameData) = this->updateFramePixels();
HXLINE( 915)			int pixelColor = ::Std_obj::_hx_int(this->_flashPoint->x);
HXDLIN( 915)			HX_VARI( int,pixelColor1) = frameData->getPixel32(pixelColor,::Std_obj::_hx_int(this->_flashPoint->y));
...
HXDLIN( 952)		HX_VAR( bool,doFlipX1);
...
HXDLIN( 953)		HX_VAR( bool,doFlipY1);
...
HXLINE(1007)		HX_VARI( Float,minX) = ((this->x - this->offset->x) - (Camera->scroll->x * this->scrollFactor->x));
HXLINE(1008)		HX_VARI( Float,minY) = ((this->y - this->offset->y) - (Camera->scroll->y * this->scrollFactor->y));
...
HXLINE(1016)		HX_VARI( Float,radiusX) = this->_halfSize->x;
HXLINE(1017)		HX_VARI( Float,radiusY) = this->_halfSize->y;
HXLINE(1019)		HX_VARI( Float,ox) = this->origin->x;
HXLINE(1020)		if ((ox != radiusX)) {
HXLINE(1022)			HX_VARI( Float,x1) = ::Math_obj::abs(ox);
HXLINE(1023)			HX_VARI( Float,x2) = ::Math_obj::abs((( (Float)(this->frameWidth) ) - ox));
HXLINE(1024)			radiusX = ::Math_obj::max(x2,x1);
            		}
HXLINE(1027)		HX_VARI( Float,oy) = this->origin->y;
HXLINE(1028)		if ((oy != radiusY)) {
HXLINE(1030)			HX_VARI( Float,y1) = ::Math_obj::abs(oy);
HXLINE(1031)			HX_VARI( Float,y2) = ::Math_obj::abs((( (Float)(this->frameHeight) ) - oy));
...
HXLINE(1037)		HX_VARI( Float,radius) = ::Math_obj::max(radiusX,radiusY);
HXLINE(1038)		radius = (radius * ((Float)1.41421356237));
HXLINE(1040)		minX = (minX + (ox - radius));
HXLINE(1041)		minY = (minY + (oy - radius));
HXLINE(1043)		HX_VARI( Float,doubleRadius) = (( (Float)(2) ) * radius);
...
bool FlxSprite_obj::isSimpleRenderBlit( ::flixel::FlxCamera camera){
            	...
            	HX_STACK_ARG(camera,"camera")
HXLINE(1070)
HXLINE(1071)		HX_VAR( bool,result);
...
HXLINE(1103)			HX_VARI(  ::haxe::ds::StringMap,animations) = this->animation->_animations;
HXLINE(1104)			HX_VARI( bool,reverse) = false;
HXLINE(1105)			HX_VARI( int,index) = 0;
HXLINE(1106)			HX_VARI( int,frameIndex) = this->animation->frameIndex;
HXLINE(1107)			HX_VARI( ::String,currName) = null();
...
HXLINE(1142)
HXLINE(1143)		HX_VARI( ::String,key) = ::flixel::FlxG_obj::bitmap->findKeyForBitmap(Pixels);
...
int FlxSprite_obj::set_facing(int Direction){
            	...
            	HX_STACK_ARG(Direction,"Direction")
HXLINE(1197)
HXLINE(1198)		HX_VARI(  ::Dynamic,flip) = this->_facingFlip->get(Direction);
...
Float FlxSprite_obj::set_angle(Float Value){
            	...
            	HX_STACK_ARG(Value,"Value")
HXLINE(1234)
HXLINE(1235)		HX_VARI( bool,newAngle) = (this->angle != Value);
HXLINE(1236)		HX_VARI( Float,ret) = this->super::set_angle(Value);
...
HXLINE(1250)			HX_VARI( Float,radians) = (this->angle * (::Math_obj::PI / ( (Float)(180) )));
...
HX_DEFINE_DYNAMIC_FUNC1(FlxSprite_obj,set_blend,return )
 ...
 ::flixel::graphics::FlxGraphic FlxSprite_obj::set_graphic( ::flixel::graphics::FlxGraphic Value){
            	...
            	HX_STACK_ARG(Value,"Value")
HXLINE(1269)
HXLINE(1270)		HX_VARI(  ::flixel::graphics::FlxGraphic,oldGraphic) = this->graphic;
...
bool FlxSprite_obj::checkFlipX(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1390)
HXLINE(1391)		HX_VARI( bool,doFlipX) = (this->flipX != this->_frame->flipX);
...
bool FlxSprite_obj::checkFlipY(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1401)
HXLINE(1402)		HX_VARI( bool,doFlipY) = (this->flipY != this->_frame->flipY);

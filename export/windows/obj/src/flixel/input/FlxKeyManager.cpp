...
HXLINE(  94)				HX_VARI(  ::flixel::input::FlxInput,key) = _g1->__get(_g).StaticCast<  ::flixel::input::FlxInput >();
HXDLIN(  94)				_g = (_g + 1);
...
HXLINE( 111)				HX_VARI(  ::flixel::input::FlxInput,key) = _g1->__get(_g).StaticCast<  ::flixel::input::FlxInput >();
HXDLIN( 111)				_g = (_g + 1);
...
HXLINE( 128)				HX_VARI(  ::flixel::input::FlxInput,key) = _g1->__get(_g).StaticCast<  ::flixel::input::FlxInput >();
HXDLIN( 128)				_g = (_g + 1);
...
HXLINE( 158)			goto _hx_goto_10;
            		...
            		/* default */{
HXLINE( 166)			HX_VARI(  ::flixel::input::FlxInput,key) = ( ( ::flixel::input::FlxInput)(this->_keyListMap->get(KeyCode)) );
...
::Array< ::Dynamic> FlxKeyManager_obj::getIsDown(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 184)
HXLINE( 185)		HX_VARI( ::Array< ::Dynamic>,keysDown) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 187)		{
HXLINE( 187)			int _g = 0;
...
HXDLIN( 211)			HX_VARI(  ::flixel::input::FlxInput,key) = _g1->__get(_g).StaticCast<  ::flixel::input::FlxInput >();
HXDLIN( 211)			_g = (_g + 1);
...
HXDLIN( 236)			HX_VARI(  ::flixel::input::FlxInput,key) = _g1->__get(_g).StaticCast<  ::flixel::input::FlxInput >();
HXDLIN( 236)			_g = (_g + 1);
...
HXLINE( 259)				HX_VARI(  ::Dynamic,code) = KeyArray->__get(_g);
HXDLIN( 259)				_g = (_g + 1);
...
HXLINE( 272)
HXLINE( 273)		HX_VARI( int,c) = this->resolveKeyCode(event);
...
void FlxKeyManager_obj::onKeyDown( ::openfl::events::KeyboardEvent event){
            	...
            	HX_STACK_ARG(event,"event")
HXLINE( 286)
HXLINE( 287)		HX_VARI( int,c) = this->resolveKeyCode(event);
...
void FlxKeyManager_obj::handlePreventDefaultKeys(int keyCode, ::openfl::events::KeyboardEvent event){
            	...
            	HX_STACK_ARG(event,"event")
HXLINE( 297)
HXLINE( 298)		HX_VARI(  ::flixel::input::FlxInput,key) = ( ( ::flixel::input::FlxInput)(this->_keyListMap->get(keyCode)) );
...
HXLINE( 321)			HX_VARI( int,code) = this->resolveKeyCode(Event);
HXLINE( 322)			{
HXLINE( 322)				int _g = 0;
HXDLIN( 322)				while((_g < KeyArray->get_length())){
HXLINE( 322)					HX_VARI(  ::Dynamic,key) = KeyArray->__get(_g);
HXDLIN( 322)					_g = (_g + 1);
...
HXLINE( 342)
HXLINE( 343)		HX_VARI(  ::flixel::input::FlxInput,key) = ( ( ::flixel::input::FlxInput)(this->_keyListMap->get(KeyCode)) );

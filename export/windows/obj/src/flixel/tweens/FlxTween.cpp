...
HXLINE( 523)		HX_VARI( int,type) = (this->type & ~(16));
...
HXLINE( 639)
HXLINE( 640)		HX_VARI( Float,dly) = ::Math_obj::abs(value);
...
Float FlxTween_obj::set_loopDelay( ::Dynamic value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE( 650)
HXLINE( 651)		HX_VARI( Float,dly) = ::Math_obj::abs(( (Float)(value) ));

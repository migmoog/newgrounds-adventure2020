...
HXLINE(  59)					HX_VARI(  ::Dynamic,info) = _g1->__get(_g);
HXDLIN(  59)					_g = (_g + 1);
...
void VarTween_obj::initializeVars(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  65)
HXLINE(  66)		HX_VAR( ::Array< ::String >,fieldPaths);
...
HXLINE(  72)				HX_VARI( ::String,fieldPath) = fieldPaths->__get(_g);
HXDLIN(  72)				_g = (_g + 1);
HXLINE(  74)				HX_VARI(  ::Dynamic,target) = this->_object;
HXLINE(  75)				HX_VARI( ::Array< ::String >,path) = fieldPath.split(HX_(".",2e,00,00,00));
HXLINE(  76)				HX_VARI( ::String,field) = ( (::String)(path->pop()) );
HXLINE(  77)				{
HXLINE(  77)					int _g1 = 0;
HXDLIN(  77)					while((_g1 < path->length)){
HXLINE(  77)						HX_VARI( ::String,component) = path->__get(_g1);
HXDLIN(  77)						_g1 = (_g1 + 1);
...
HXLINE(  87)				HX_VARI(  ::Dynamic,value) = ::Reflect_obj::getProperty(target,field);
...
HXLINE(  91)				HX_VARI(  ::Dynamic,targetValue) = ::Reflect_obj::getProperty(this->_properties,fieldPath);
